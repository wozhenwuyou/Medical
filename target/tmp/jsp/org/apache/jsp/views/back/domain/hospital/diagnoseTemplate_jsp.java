...
public final class diagnoseTemplate_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t<!-- <td class=\"td_pad\"><span>科室：</span><input role=\"combobox\" id=\"sc_departmentId\" class=\"domain-input easyui-combobox width100\" /></td> -->\r\n");
      ...
      out.write("\t\t<div id='mainObjWin' class=\"easyui-window\" title=\"病历模板信息\"\r\n");
      ...
      out.write("\t\t\t\t\t\t<tr class=\"tr_ht\" align=\"right\">\r\n");
      out.write("\t\t\t\t\t\t\t<td class=\"td_pad\"><span>诊所：</span><input role=\"combobox\"\r\n");
      out.write("\t\t\t\t\t\t\t\tid=\"f_hospitalId\" class=\"domain-input easyui-combobox width140\"\r\n");
      out.write("\t\t\t\t\t\t\t\tdata-options=\"required:true\" /></td>\r\n");
      out.write("\t\t\t\t\t\t\t<!-- <td class=\"td_pad\"><span>科室：</span><input role=\"combobox\" id=\"f_departmentId\" class=\"domain-input easyui-combobox width100\" data-options=\"required:true\"/></td> -->\r\n");
      out.write("\t\t\t\t\t\t\t<td class=\"td_pad\"><span>就诊日期：</span><input\r\n");
      out.write("\t\t\t\t\t\t\t\trole=\"datetimebox\" id=\"f_diagnoseTime\"\r\n");
      out.write("\t\t\t\t\t\t\t\tclass=\"domain-input easyui-datetimebox width140\"\r\n");
      out.write("\t\t\t\t\t\t\t\tdata-options=\"required:true\" /></td>\r\n");
      out.write("\t\t\t\t\t\t\t<td class=\"td_pad\"><span>状态：</span><input role=\"combobox\"\r\n");
      out.write("\t\t\t\t\t\t\t\tid=\"f_mainStatus\" class=\"domain-input easyui-combobox width140\" /></td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t<!-- <tr class=\"tr_ht\" align=\"right\">\r\n");
      out.write("\t\t\t\t\t\t</tr> -->\r\n");
      out.write("\t\t\t\t\t\t<tr class=\"tr_ht\" align=\"right\">\r\n");
      out.write("\t\t\t\t\t\t\t<td class=\"td_pad\" colspan=\"3\"><span>过敏历史：</span><input\r\n");
      out.write("\t\t\t\t\t\t\t\trole=\"textbox\" id=\"f_allergyHistory\"\r\n");
      out.write("\t\t\t\t\t\t\t\tclass=\"domain-input easyui-textbox width100\"\r\n");
      out.write("\t\t\t\t\t\t\t\tdata-options=\"required:true,multiline:true,height:100,width:500\" /></td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t<tr class=\"tr_ht\" align=\"right\">\r\n");
      ...
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t<tr class=\"tr_ht\" align=\"right\">\r\n");
      out.write("\t\t\t\t\t\t\t<td class=\"td_pad\" colspan=\"3\"><span>诊断结果：</span><input\r\n");
      out.write("\t\t\t\t\t\t\t\trole=\"textbox\" id=\"f_diagnoseTags\"\r\n");
      out.write("\t\t\t\t\t\t\t\tclass=\"domain-input easyui-textbox width100\"\r\n");
      out.write("\t\t\t\t\t\t\t\tdata-options=\"required:true,multiline:true,height:100,width:500\" /></td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t</tbody>\r\n");
      ...
      out.write("\t\ttitle=\"v\"></script>\r\n");
      out.write("\t<script type=\"text/javascript\"\r\n");
      out.write("\t\tsrc=\"/js/back/domain/hospital/diagnoseTemplate.js\" title=\"v\"></script>\r\n");
      out.write("</body>\r\n");
      out.write("</html>");
    } catch (Throwable t) {
