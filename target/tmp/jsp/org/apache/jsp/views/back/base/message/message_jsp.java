package org.apache.jsp.views.back.base.message;
...
public final class message_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t<td class=\"td_pad\"><span>发送人：</span><input role=\"combobox\"\r\n");
      out.write("\t\t\t\t\tid=\"sc_senderId\" class=\"domain-input easyui-combobox width140\" /></td>\r\n");
      out.write("\t\t\t\t<td class=\"td_pad\"><span>接收人：</span><input role=\"combobox\"\r\n");
      out.write("\t\t\t\t\tid=\"sc_receiverId\" class=\"domain-input easyui-combobox width140\" /></td>\r\n");
      ...
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t\t<tr class=\"tr_ht\" align=\"right\">\r\n");
      out.write("\t\t\t\t<td class=\"td_pad\"><span>发送开始时间：</span><input role=\"datebox\"\r\n");
      out.write("\t\t\t\t\tid=\"sc_sendTimeFrom\" class=\"domain-input easyui-datebox width140\" /></td>\r\n");
      out.write("\t\t\t\t<td class=\"td_pad\"><span>发送结束时间：</span><input role=\"datebox\"\r\n");
      out.write("\t\t\t\t\tid=\"sc_sendTimeTo\" class=\"domain-input easyui-datebox width140\" /></td>\r\n");
      ...
      out.write("\t\t<div id='mainObjWin' class=\"easyui-window\" title=\"留言\"\r\n");
      out.write("\t\t\tstyle=\"width: 540px;\"\r\n");
      ...
      out.write("\t\t\t\t\t\t<tr class=\"tr_ht\" align=\"right\">\r\n");
      out.write("\t\t\t\t\t\t\t<td class=\"td_pad\"><span>发送人：</span><input role=\"combobox\"\r\n");
      out.write("\t\t\t\t\t\t\t\tid=\"f_senderId\" class=\"domain-input easyui-combobox width100\"\r\n");
      out.write("\t\t\t\t\t\t\t\tdata-options=\"required:true\" /></td>\r\n");
      out.write("\t\t\t\t\t\t\t<td class=\"td_pad\"><span>接收人：</span><input role=\"combobox\"\r\n");
      out.write("\t\t\t\t\t\t\t\tid=\"f_receiverId\" class=\"domain-input easyui-combobox width100\"\r\n");
      out.write("\t\t\t\t\t\t\t\tdata-options=\"required:true\" /></td>\r\n");
      out.write("\t\t\t\t\t\t\t<td class=\"td_pad\"><span>状态：</span><input role=\"combobox\"\r\n");
      out.write("\t\t\t\t\t\t\t\tid=\"f_mainStatus\" class=\"domain-input easyui-combobox width100\"\r\n");
      out.write("\t\t\t\t\t\t\t\tdata-options=\"required:true\" /></td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t<td class=\"td_pad\" colspan=\"3\"><span>内容：</span><input\r\n");
      out.write("\t\t\t\t\t\t\t\trole=\"textbox\" id=\"f_content\"\r\n");
      out.write("\t\t\t\t\t\t\t\tclass=\"domain-input easyui-textbox\"\r\n");
      out.write("\t\t\t\t\t\t\t\tdata-options=\"required:true,multiline:true,height:100,prompt:'请输入内容',width:450\" /></td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t<td class=\"td_pad\" colspan=\"3\"><span>回复：</span><input\r\n");
      out.write("\t\t\t\t\t\t\t\trole=\"textbox\" id=\"f_replyContent\"\r\n");
      out.write("\t\t\t\t\t\t\t\tclass=\"domain-input easyui-textbox\"\r\n");
      out.write("\t\t\t\t\t\t\t\tdata-options=\"required:true,multiline:true,height:100,prompt:'',width:450\" /></td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t</tbody>\r\n");
      out.write("\t\t\t\t</table>\r\n");
      out.write("\t\t\t</form>\r\n");
      ...
      out.write("\t\ttitle=\"v\"></script>\r\n");
      out.write("\t<script type=\"text/javascript\" src=\"/js/back/base/message/message.js\"\r\n");
      out.write("\t\ttitle=\"v\"></script>\r\n");
      out.write("</body>\r\n");
      out.write("</html>");
    } catch (Throwable t) {
