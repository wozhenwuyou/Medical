...
public final class consult_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t<td class=\"td_pad\"><span>咨询人：</span><input role=\"combobox\"\r\n");
      out.write("\t\t\t\t\tid=\"sc_userId\" class=\"domain-input easyui-comboboxbox width100\" /></td>\r\n");
      out.write("\t\t\t\t<td class=\"td_pad\"><span>咨询医生：</span><input role=\"combobox\"\r\n");
      ...
      out.write("\t\t\t\t\tid=\"sc_title\" class=\"domain-input easyui-textbox width100\" /></td>\r\n");
      out.write("\t\t\t\t<!-- <td class=\"td_pad\"><span>操作时间：</span><input role=\"datebox\" id=\"sc_operationTime\" class=\"domain-input easyui-datebox width140\" /></td> -->\r\n");
      ...
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t\t<tr class=\"tr_ht\" align=\"right\">\r\n");
      out.write("\t\t\t\t<td class=\"td_pad\"><span>咨询内容：</span><input role=\"textbox\"\r\n");
      out.write("\t\t\t\t\tid=\"sc_mainContent\" class=\"domain-input easyui-textbox width100\" /></td>\r\n");
      out.write("\t\t\t\t<td class=\"td_pad\"><span>请求帮助内容：</span><input role=\"textbox\"\r\n");
      out.write("\t\t\t\t\tid=\"sc_helpContent\" class=\"domain-input easyui-textbox width100\" /></td>\r\n");
      out.write("\t\t\t\t<td class=\"td_pad\"><span>标签：</span><input role=\"textbox\"\r\n");
      out.write("\t\t\t\t\tid=\"sc_tags\" class=\"domain-input easyui-textbox width100\" /></td>\r\n");
      ...
      out.write("\t\t<div id='mainObjWin' class=\"easyui-window\" title=\"咨询信息\"\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\tstyle=\"color: red; font-weight: bolder;\">*</span>咨询人：</span><input\r\n");
      out.write("\t\t\t\t\t\t\t\trole=\"combobox\" id=\"f_userId\"\r\n");
      out.write("\t\t\t\t\t\t\t\tclass=\"domain-input easyui-combobox width140\"\r\n");
      out.write("\t\t\t\t\t\t\t\tdata-options=\"required:true\" /></td>\r\n");
      out.write("\t\t\t\t\t\t\t<td class=\"td_pad\"><span><span\r\n");
      out.write("\t\t\t\t\t\t\t\t\tstyle=\"color: red; font-weight: bolder;\">*</span>咨询医生：</span><input\r\n");
      ...
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t<tr class=\"tr_ht\" align=\"right\">\r\n");
      out.write("\t\t\t\t\t\t\t<!-- <td class=\"td_pad\"><span>操作时间：</span><input role=\"datebox\" id=\"f_operationTime\" class=\"domain-input easyui-datebox width140\" /></td> -->\r\n");
      out.write("\t\t\t\t\t\t\t<td class=\"td_pad\"><span><span\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\tdata-options=\"required:true\" /></td>\r\n");
      out.write("\t\t\t\t\t\t\t<td class=\"td_pad\"><span>标签：</span><input role=\"textbox\"\r\n");
      out.write("\t\t\t\t\t\t\t\tid=\"f_tags\" class=\"domain-input easyui-textbox width140\"\r\n");
      out.write("\t\t\t\t\t\t\t\tdata-options=\"required:false\" /></td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t<tr class=\"tr_ht\" align=\"right\">\r\n");
      out.write("\t\t\t\t\t\t\t<td class=\"td_pad\" colspan=\"3\"><span>咨询内容：</span><input\r\n");
      out.write("\t\t\t\t\t\t\t\trole=\"textbox\" id=\"f_mainContent\"\r\n");
      out.write("\t\t\t\t\t\t\t\tclass=\"domain-input easyui-textbox width100\"\r\n");
      out.write("\t\t\t\t\t\t\t\tdata-options=\"required:false,multiline:true,height:100,width:540\" /></td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t<tr class=\"tr_ht\" align=\"right\">\r\n");
      out.write("\t\t\t\t\t\t\t<td class=\"td_pad\" colspan=\"3\"><span>请求帮助内容：</span><input\r\n");
      out.write("\t\t\t\t\t\t\t\trole=\"textbox\" id=\"f_helpContent\"\r\n");
      out.write("\t\t\t\t\t\t\t\tclass=\"domain-input easyui-textbox width100\"\r\n");
      out.write("\t\t\t\t\t\t\t\tdata-options=\"required:false,multiline:true,height:100,width:540\" /></td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t</tbody>\r\n");
      ...
      out.write("\t\ttitle=\"v\"></script>\r\n");
      out.write("\t<script type=\"text/javascript\"\r\n");
      out.write("\t\tsrc=\"/js/back/domain/hospital/consult.js\" title=\"v\"></script>\r\n");
      out.write("</body>\r\n");
      out.write("</html>");
    } catch (Throwable t) {
