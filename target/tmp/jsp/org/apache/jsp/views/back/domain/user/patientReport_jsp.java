...
public final class patientReport_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\tid=\"sc_patientName\" class=\"domain-input easyui-textbox width140\" /></td>\r\n");
      ...
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t\t<tr class=\"tr_ht\" align=\"right\">\r\n");
      out.write("\t\t\t\t<td class=\"td_pad\"><span>艾迪康编号：</span><input role=\"textbox\"\r\n");
      out.write("\t\t\t\t\tid=\"sc_adiconBarcodeLike\"\r\n");
      out.write("\t\t\t\t\tclass=\"domain-input easyui-textbox width140\" /></td>\r\n");
      ...
      out.write("\t\t\t<button role=\"opt_1\" id=\"btn_batchDelete\" onclick=\"lh.commonBatchDelete()\"  class=\"button button-primary button-rounded button-small\">批量删除</button>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t</div>  -->\r\n");
      out.write("\t<div id=\"opt_outer_div\">\r\n");
      out.write("\t\t<div class=\"fl_opt_div\">\r\n");
      ...
      out.write("\t\t\t<button onclick=\"exportpatientReport()\"\r\n");
      out.write("\t\t\t\tclass=\"button button-primary button-rounded button-small\">导出\r\n");
      out.write("\t\t\t\t血液检测信息</button>\r\n");
      ...
      out.write("\t\t<div id='mainObjWin' class=\"easyui-window\" title=\"血液检测\"\r\n");
      out.write("\t\t\tstyle=\"width: 700px;\"\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\tstyle=\"color: red; font-weight: bolder;\">*</span>条形码：</span><input\r\n");
      out.write("\t\t\t\t\t\t\t\trole=\"textbox\" id=\"f_adiconBarcode\"\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\trole=\"combobox\" id=\"f_patientId\"\r\n");
      out.write("\t\t\t\t\t\t\t\tclass=\"domain-input easyui-combobox width140\"\r\n");
      out.write("\t\t\t\t\t\t\t\tdata-options=\"required:true\" /></td>\r\n");
      out.write("\t\t\t\t\t\t\t<td class=\"td_pad\"><span><span\r\n");
      out.write("\t\t\t\t\t\t\t\t\tstyle=\"color: red; font-weight: bolder;\">*</span>关联医生：</span><input\r\n");
      ...
      out.write("\t\t\t\t\t\t\t<td class=\"td_pad\"><span><span\r\n");
      out.write("\t\t\t\t\t\t\t\t\tstyle=\"color: red; font-weight: bolder;\">*</span>患者姓名：</span><input\r\n");
      out.write("\t\t\t\t\t\t\t\trole=\"textbox\" id=\"f_patientName\"\r\n");
      out.write("\t\t\t\t\t\t\t\tclass=\"domain-input easyui-textbox width140\"\r\n");
      out.write("\t\t\t\t\t\t\t\tdata-options=\"required:false\" /></td>\r\n");
      out.write("\t\t\t\t\t\t\t<td class=\"td_pad\"><span><span\r\n");
      out.write("\t\t\t\t\t\t\t\t\tstyle=\"color: red; font-weight: bolder;\">*</span>电话号码：</span><input\r\n");
      out.write("\t\t\t\t\t\t\t\trole=\"textbox\" id=\"f_phone\"\r\n");
      out.write("\t\t\t\t\t\t\t\tclass=\"domain-input easyui-textbox width140\"\r\n");
      out.write("\t\t\t\t\t\t\t\tdata-options=\"required:false\" /></td>\r\n");
      out.write("\t\t\t\t\t\t\t<!-- <td class=\"td_pad\"><span>用户年龄：</span><input role=\"textbox\" id=\"f_patientAge\" class=\"domain-input easyui-textbox width140\" data-options=\"required:false\"/></td> -->\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t<tr class=\"tr_ht\" align=\"right\">\r\n");
      out.write("\t\t\t\t\t\t\t<td class=\"td_pad\"><span><span\r\n");
      out.write("\t\t\t\t\t\t\t\t\tstyle=\"color: red; font-weight: bolder;\">*</span>年龄：</span><input\r\n");
      out.write("\t\t\t\t\t\t\t\trole=\"numberbox\" id=\"f_age\"\r\n");
      out.write("\t\t\t\t\t\t\t\tclass=\"domain-input easyui-numberbox width140\"\r\n");
      out.write("\t\t\t\t\t\t\t\tdata-options=\"required:false\" /></td>\r\n");
      out.write("\t\t\t\t\t\t\t<td class=\"td_pad\"><span><span\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\tdata-options=\"required:false\" /></td>\r\n");
      out.write("\t\t\t\t\t\t\t<td class=\"td_pad\"><span><span\r\n");
      out.write("\t\t\t\t\t\t\t\t\tstyle=\"color: red; font-weight: bolder;\">*</span>用户职业：</span><input\r\n");
      out.write("\t\t\t\t\t\t\t\trole=\"combobox\" id=\"f_attrInt\"\r\n");
      out.write("\t\t\t\t\t\t\t\tclass=\"domain-input easyui-combobox width140\"\r\n");
      out.write("\t\t\t\t\t\t\t\tdata-options=\"required:false\" /></td>\r\n");
      out.write("\t\t\t\t\t\t\t<!-- <td class=\"td_pad\"><span style=\"color:gray;\">出生日期：</span><input role=\"datebox\" id=\"f_birthday\" class=\"domain-input easyui-datebox width140\" data-options=\"required:false\"/></td> -->\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t<tr class=\"tr_ht\" align=\"right\">\r\n");
      out.write("\t\t\t\t\t\t\t<!-- ,height:40,multiline:true,width:580 -->\r\n");
      out.write("\t\t\t\t\t\t\t<td class=\"td_pad\"><span><span\r\n");
      out.write("\t\t\t\t\t\t\t\t\tstyle=\"color: red; font-weight: bolder;\">*</span>采血日期：</span><input\r\n");
      out.write("\t\t\t\t\t\t\t\trole=\"datebox\" id=\"f_attrDate\"\r\n");
      out.write("\t\t\t\t\t\t\t\tclass=\"domain-input easyui-datebox width140\"\r\n");
      out.write("\t\t\t\t\t\t\t\tdata-options=\"required:true\" /></td>\r\n");
      out.write("\t\t\t\t\t\t\t<td class=\"td_pad\" colspan=\"1\"><span><span\r\n");
      out.write("\t\t\t\t\t\t\t\t\tstyle=\"color: red; font-weight: bolder;\">*</span>检测项：</span><input\r\n");
      out.write("\t\t\t\t\t\t\t\trole=\"combobox\" id=\"f_itemCodes\"\r\n");
      out.write("\t\t\t\t\t\t\t\tclass=\"domain-input easyui-combobox width140\"\r\n");
      out.write("\t\t\t\t\t\t\t\tdata-options=\"multiple:false,required:true\" /></td>\r\n");
      out.write("\t\t\t\t\t\t\t<td class=\"td_pad\"><span><span\r\n");
      ...
      out.write("\t\ttitle=\"v\"></script>\r\n");
      out.write("\t<script type=\"text/javascript\"\r\n");
      out.write("\t\tsrc=\"/js/back/domain/user/patientReport.js\" title=\"v\"></script>\r\n");
      out.write("</body>\r\n");
      out.write("</html>");
    } catch (Throwable t) {
