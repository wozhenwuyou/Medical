...
public final class doctor_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\tid=\"sc_username\" class=\"domain-input easyui-textbox width140\" /></td>\r\n");
      out.write("\t\t\t\t<td class=\"td_pad\"><span>地址：</span><input role=\"textbox\"\r\n");
      out.write("\t\t\t\t\tid=\"sc_address\" class=\"domain-input easyui-textbox width140\" /></td>\r\n");
      out.write("\t\t\t\t<td class=\"td_pad\"><span>手机号码：</span><input role=\"textbox\"\r\n");
      out.write("\t\t\t\t\tid=\"sc_phone\" class=\"domain-input easyui-textbox width140\" /></td>\r\n");
      out.write("\t\t\t\t<td class=\"td_pad\"><span>邮箱：</span><input role=\"textbox\"\r\n");
      out.write("\t\t\t\t\tid=\"sc_email\" class=\"domain-input easyui-textbox width140\" /></td>\r\n");
      out.write("\r\n");
      ...
      out.write("\t\t\t\t\tid=\"sc_qq\" class=\"domain-input easyui-textbox width140\" /></td>\r\n");
      out.write("\t\t\t\t<td class=\"td_pad\"><span>微信：</span><input role=\"textbox\"\r\n");
      out.write("\t\t\t\t\tid=\"sc_weixin\" class=\"domain-input easyui-textbox width140\" /></td>\r\n");
      out.write("\t\t\t\t<td class=\"td_pad\"><span>微博：</span><input role=\"textbox\"\r\n");
      out.write("\t\t\t\t\tid=\"sc_weibo\" class=\"domain-input easyui-textbox width140\" /></td>\r\n");
      ...
      out.write("\t\t\t\t\tid=\"sc_sex\" class=\"domain-input easyui-combobox width140\" /></td>\r\n");
      out.write("\t\t\t\t<td class=\"td_pad\"><span>所属诊所：</span><input role=\"combobox\"\r\n");
      out.write("\t\t\t\t\tid=\"sc_hospitalId\" class=\"domain-input easyui-combobox width140\" /></td>\r\n");
      out.write("\t\t\t\t<td class=\"td_pad\"><span>所属科室：</span><input role=\"combobox\"\r\n");
      out.write("\t\t\t\t\tid=\"sc_departmentId\" class=\"domain-input easyui-combobox width140\" /></td>\r\n");
      ...
      out.write("\t\t\t<button onclick=\"exportDoctor()\"\r\n");
      out.write("\t\t\t\tclass=\"button button-primary button-rounded button-small\">导出医生信息</button>\r\n");
      ...
      out.write("\t</div>\r\n");
      out.write("\t<!-- 表格  开始 -->\r\n");
      out.write("\t<div id='datagrid_div' style=\"margin-bottom: 20px;\">\r\n");
      out.write("\t\t<table id=\"datagrid\"></table>\r\n");
      out.write("\t</div>\r\n");
      out.write("\t<!-- 表格  结束 -->\r\n");
      out.write("\r\n");
      out.write("\t<div id=\"mainObjWindiv\" style=\"display: none;\">\r\n");
      out.write("\t\t<div id='mainObjWin' class=\"easyui-window\" title=\"医生信息\"\r\n");
      out.write("\t\t\tstyle=\"width: 800px;\"\r\n");
      out.write("\t\t\tdata-options=\"top:80,left:190,modal:true,closed:true,maximizable:false,collapsible:false,minimizable:false\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\tstyle=\"color: red; font-weight: bolder;\">*</span>所属诊所：</span><input\r\n");
      out.write("\t\t\t\t\t\t\t\trole=\"textbox\" id=\"f_hospitalId\"\r\n");
      out.write("\t\t\t\t\t\t\t\tclass=\"domain-input easyui-textbox width100\"\r\n");
      out.write("\t\t\t\t\t\t\t\tdata-options=\"required:true\" /></td>\r\n");
      out.write("\t\t\t\t\t\t\t<td class=\"td_pad\"><span><span\r\n");
      out.write("\t\t\t\t\t\t\t\t\tstyle=\"color: red; font-weight: bolder;\">*</span>所属科室：</span><input\r\n");
      out.write("\t\t\t\t\t\t\t\trole=\"textbox\" id=\"f_departmentId\"\r\n");
      out.write("\t\t\t\t\t\t\t\tclass=\"domain-input easyui-textbox width100\"\r\n");
      out.write("\t\t\t\t\t\t\t\tdata-options=\"required:true\" /></td>\r\n");
      out.write("\t\t\t\t\t\t\t<td class=\"td_pad\"><span><span\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\trole=\"textbox\" id=\"f_idCard\"\r\n");
      out.write("\t\t\t\t\t\t\t\tclass=\"domain-input easyui-textbox width100\"\r\n");
      out.write("\t\t\t\t\t\t\t\tdata-options=\"required:true\" /></td>\r\n");
      out.write("\t\t\t\t\t\t\t<td class=\"td_pad\"><span><span\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\tdata-options=\"required:true\" /></td>\r\n");
      out.write("\t\t\t\t\t\t\t<td class=\"td_pad\"><span>地址：</span><input role=\"textbox\"\r\n");
      out.write("\t\t\t\t\t\t\t\tid=\"f_address\" class=\"domain-input easyui-textbox width100\"\r\n");
      out.write("\t\t\t\t\t\t\t\tdata-options=\"required:false\" /></td>\r\n");
      out.write("\t\t\t\t\t\t\t<td class=\"td_pad\"><span>职称：</span><input role=\"combobox\"\r\n");
      out.write("\t\t\t\t\t\t\t\tid=\"f_titleIds\" class=\"domain-input easyui-combobox width100\" /></td>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\tclass=\"domain-input easyui-combobox width100\" /></td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t<tr class=\"tr_ht\" align=\"right\">\r\n");
      out.write("\t\t\t\t\t\t\t<td class=\"td_pad\"><span>邮箱：</span><input role=\"textbox\"\r\n");
      out.write("\t\t\t\t\t\t\t\tid=\"f_email\" class=\"domain-input easyui-textbox width100\"\r\n");
      out.write("\t\t\t\t\t\t\t\tdata-options=\"required:false\" /></td>\r\n");
      out.write("\t\t\t\t\t\t\t<td class=\"td_pad\"><span>微信：</span><input role=\"textbox\"\r\n");
      out.write("\t\t\t\t\t\t\t\tid=\"f_weixin\" class=\"domain-input easyui-textbox width100\"\r\n");
      out.write("\t\t\t\t\t\t\t\tdata-options=\"required:false\" /></td>\r\n");
      out.write("\t\t\t\t\t\t\t<td class=\"td_pad\"><span>微博：</span><input role=\"textbox\"\r\n");
      out.write("\t\t\t\t\t\t\t\tid=\"f_weibo\" class=\"domain-input easyui-textbox width100\"\r\n");
      out.write("\t\t\t\t\t\t\t\tdata-options=\"required:false\" /></td>\r\n");
      out.write("\t\t\t\t\t\t\t<td class=\"td_pad\"><span>QQ：</span><input role=\"textbox\"\r\n");
      out.write("\t\t\t\t\t\t\t\tid=\"f_qq\" class=\"domain-input easyui-textbox width100\"\r\n");
      out.write("\t\t\t\t\t\t\t\tdata-options=\"required:false\" /></td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t<td class=\"td_pad\" colspan=\"4\" align=\"right\"><span>擅&nbsp;&nbsp;长：</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t<input role=\"textbox\" id=\"f_goodAt\"\r\n");
      out.write("\t\t\t\t\t\t\t\tclass=\"domain-input easyui-textbox\"\r\n");
      out.write("\t\t\t\t\t\t\t\tdata-options=\"required:false,multiline:true,height:80,prompt:'请输入内容',width:680\" />\r\n");
      out.write("\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t<td class=\"td_pad\" colspan=\"4\"><span>执业经历：</span> <input\r\n");
      out.write("\t\t\t\t\t\t\t\trole=\"textbox\" id=\"f_introduction\"\r\n");
      out.write("\t\t\t\t\t\t\t\tclass=\"domain-input easyui-textbox\"\r\n");
      out.write("\t\t\t\t\t\t\t\tdata-options=\"required:false,multiline:true,height:80,prompt:'请输入内容',width:680\" />\r\n");
      out.write("\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t<td class=\"td_pad\" colspan=\"4\"><span>咨询范围：</span> <input\r\n");
      out.write("\t\t\t\t\t\t\t\trole=\"textbox\" id=\"f_consultScope\"\r\n");
      out.write("\t\t\t\t\t\t\t\tclass=\"domain-input easyui-textbox\"\r\n");
      out.write("\t\t\t\t\t\t\t\tdata-options=\"required:false,multiline:true,height:80,prompt:'请输入内容',width:680\" />\r\n");
      out.write("\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      ...
      out.write("\t\t\t\t<!-- 上传文件进度展示 -->\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t\t<div class=\"inline-center mgV10\">\r\n");
      out.write("\t\t\t\t<button id=\"mainObjSave\" onclick=\"saveMainObj()\"\r\n");
      out.write("\t\t\t\t\tclass=\"button button-primary button-rounded button-small\">保存333</button>\r\n");
      ...
      out.write("\t\t\t\t<br />\r\n");
      out.write("\t\t\t\t<table id=\"resetPasswordTable\" class=\"padL5\" style=\"width: 280px;\">\r\n");
      out.write("\t\t\t\t\t<tbody>\r\n");
      out.write("\t\t\t\t\t\t<tr class=\"tr_ht\" align=\"center\">\r\n");
      ...
      out.write("\t<script type=\"text/javascript\" src=\"/js/back/domain/hospital/doctor.js\"\r\n");
      out.write("\t\ttitle=\"v\"></script>\r\n");
      out.write("</body>\r\n");
      out.write("</html>");
    } catch (Throwable t) {
