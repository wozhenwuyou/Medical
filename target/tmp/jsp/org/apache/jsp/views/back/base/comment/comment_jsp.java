package org.apache.jsp.views.back.base.comment;
...
public final class comment_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t<td class=\"td_pad\"><span>评论人：</span><input role=\"combobox\"\r\n");
      ...
      out.write("\t\t\t\t<!-- <td class=\"td_pad\"><span>评论类型：</span><input role=\"combobox\" id=\"sc_commentTypeId\" class=\"domain-input easyui-combobox width140\" /></td> -->\r\n");
      ...
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t\t<tr class=\"tr_ht\" align=\"right\">\r\n");
      out.write("\t\t\t\t<td class=\"td_pad\"><span>文章标题：</span><input role=\"textbox\"\r\n");
      out.write("\t\t\t\t\tid=\"sc_articlTitle\" class=\"domain-input easyui-textbox width140\" /></td>\r\n");
      ...
      out.write("\t\t<div id='mainObjWin' class=\"easyui-window\" title=\"评论\"\r\n");
      ...
      out.write("\t\t\t\t\t\t<tr class=\"tr_ht\" align=\"right\">\r\n");
      out.write("\t\t\t\t\t\t\t<td class=\"td_pad\"><span>评论人：</span><input role=\"combobox\"\r\n");
      out.write("\t\t\t\t\t\t\t\tid=\"f_userId\" class=\"domain-input easyui-combobox width160\"\r\n");
      out.write("\t\t\t\t\t\t\t\tdata-options=\"required:true\" /></td>\r\n");
      out.write("\t\t\t\t\t\t\t<td class=\"td_pad\"><span>状态：</span><input role=\"combobox\"\r\n");
      out.write("\t\t\t\t\t\t\t\tid=\"f_mainStatus\" class=\"domain-input easyui-combobox width160\"\r\n");
      out.write("\t\t\t\t\t\t\t\tdata-options=\"required:true\" /></td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t<tr class=\"tr_ht\" align=\"right\">\r\n");
      out.write("\t\t\t\t\t\t\t<td class=\"td_pad\"><span>文章栏目：</span><input role=\"combobox\"\r\n");
      out.write("\t\t\t\t\t\t\t\tid=\"articleTypeId\" class=\"domain-input easyui-combobox width160\"\r\n");
      out.write("\t\t\t\t\t\t\t\tdata-options=\"required:true\" /></td>\r\n");
      out.write("\t\t\t\t\t\t\t<td class=\"td_pad\"><span>文章列表：</span><input role=\"combobox\"\r\n");
      out.write("\t\t\t\t\t\t\t\tid=\"f_objectId\" class=\"domain-input easyui-combobox width160\"\r\n");
      out.write("\t\t\t\t\t\t\t\tdata-options=\"required:true\" /></td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t<td class=\"td_pad\"><span>内容：</span></td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t<td class=\"td_pad\" colspan=\"2\"><input role=\"textbox\"\r\n");
      out.write("\t\t\t\t\t\t\t\tid=\"f_content\" class=\"domain-input easyui-textbox\"\r\n");
      out.write("\t\t\t\t\t\t\t\tdata-options=\"required:true,multiline:true,height:100,prompt:'请输入内容',width:460\" /></td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t</tbody>\r\n");
      out.write("\t\t\t\t</table>\r\n");
      out.write("\t\t\t</form>\r\n");
      ...
      out.write("\t\ttitle=\"v\"></script>\r\n");
      out.write("\t<script type=\"text/javascript\" src=\"/js/back/base/comment/comment.js\"\r\n");
      out.write("\t\ttitle=\"v\"></script>\r\n");
      out.write("</body>\r\n");
      out.write("</html>");
    } catch (Throwable t) {
