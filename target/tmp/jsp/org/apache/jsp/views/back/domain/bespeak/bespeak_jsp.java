package org.apache.jsp.views.back.domain.bespeak;

import javax.servlet.*;
import javax.servlet.http.*;
import javax.servlet.jsp.*;

public final class bespeak_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\ttitle=\"v\" />\r\n");
      out.write("</head>\r\n");
      out.write("<body style=\"min-width: 1200px;\">\r\n");
      out.write("\t<!-- 查询条件  开始 -->\r\n");
      out.write("\t<table id=\"mainQueryTable\">\r\n");
      out.write("\t\t<tbody>\r\n");
      out.write("\t\t\t<tr class=\"tr_ht\" align=\"right\">\r\n");
      out.write("\t\t\t\t<td class=\"td_pad\"><span>预约时间：</span><input role=\"datebox\"\r\n");
      out.write("\t\t\t\t\tid=\"sc_bespeakTime\" class=\"domain-input easyui-datebox width140\" /></td>\r\n");
      out.write("\t\t\t\t<td class=\"td_pad\"><span>类型：</span><input role=\"combobox\"\r\n");
      out.write("\t\t\t\t\tid=\"sc_typeId\" class=\"domain-input easyui-combobox width140\" /></td>\r\n");
      out.write("\t\t\t\t<td class=\"td_pad\"><span>服务项目：</span><input role=\"combobox\"\r\n");
      out.write("\t\t\t\t\tid=\"sc_isRegisterAgent\"\r\n");
      out.write("\t\t\t\t\tclass=\"domain-input easyui-combobox width140\" /></td>\r\n");
      out.write("\t\t\t\t<td class=\"td_pad\"><span>检测类型：</span><input role=\"combobox\"\r\n");
      out.write("\t\t\t\t\tid=\"sc_cancerTypes\" class=\"domain-input easyui-combobox width140\" /></td>\r\n");
      ...
      out.write("\t\t\t\t\tid=\"sc_doctorId\" class=\"domain-input easyui-combobox width140\" /></td>\r\n");
      out.write("\t\t\t\t<td class=\"td_pad\"><span>基本病情：</span><input role=\"textbox\"\r\n");
      out.write("\t\t\t\t\tid=\"sc_baseCondition\" class=\"domain-input easyui-textbox width140\" /></td>\r\n");
      ...
      out.write("\t\t<div id='mainObjWin' class=\"easyui-window\" title=\"预约\"\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\tstyle=\"color: red; font-weight: bolder;\">*</span>预约时间：</span><input\r\n");
      out.write("\t\t\t\t\t\t\t\trole=\"datetimebox\" id=\"f_bespeakTime\"\r\n");
      out.write("\t\t\t\t\t\t\t\tclass=\"domain-input easyui-datetimebox width140\"\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\tdata-options=\"required:true\" /></td>\r\n");
      out.write("\t\t\t\t\t\t\t<td class=\"td_pad\"><span>医生：</span><input role=\"combobox\"\r\n");
      out.write("\t\t\t\t\t\t\t\tid=\"f_doctorId\" class=\"domain-input easyui-combobox width140\"\r\n");
      out.write("\t\t\t\t\t\t\t\tdata-options=\"required:false\" /></td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t<tr class=\"tr_ht\" align=\"right\">\r\n");
      out.write("\t\t\t\t\t\t\t<td class=\"td_pad\"><span>服务项目：</span><input role=\"combobox\"\r\n");
      out.write("\t\t\t\t\t\t\t\tid=\"f_isRegisterAgent\"\r\n");
      out.write("\t\t\t\t\t\t\t\tclass=\"domain-input easyui-combobox width140\" /></td>\r\n");
      out.write("\t\t\t\t\t\t\t<td class=\"td_pad\"><span>检测类型：</span><input role=\"combobox\"\r\n");
      out.write("\t\t\t\t\t\t\t\tid=\"f_cancerTypes\" class=\"domain-input easyui-combobox width140\" /></td>\r\n");
      out.write("\t\t\t\t\t\t\t<td class=\"td_pad\"><span>处理情况：</span><input role=\"combobox\"\r\n");
      out.write("\t\t\t\t\t\t\t\tid=\"f_logicStatus\" class=\"domain-input easyui-combobox width140\" /></td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t<tr class=\"tr_ht\" align=\"right\">\r\n");
      out.write("\t\t\t\t\t\t\t<td class=\"td_pad\"><span>状态：</span><input role=\"combobox\"\r\n");
      out.write("\t\t\t\t\t\t\t\tid=\"f_mainStatus\" class=\"domain-input easyui-combobox width140\"\r\n");
      out.write("\t\t\t\t\t\t\t\tdata-options=\"required:false\" /></td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t<tr class=\"tr_ht\" align=\"right\">\r\n");
      out.write("\t\t\t\t\t\t\t<td class=\"td_pad\" colspan=\"3\"><span>基本病情：</span><input\r\n");
      out.write("\t\t\t\t\t\t\t\trole=\"textbox\" id=\"f_baseCondition\"\r\n");
      out.write("\t\t\t\t\t\t\t\tclass=\"domain-input easyui-textbox width140\"\r\n");
      out.write("\t\t\t\t\t\t\t\tdata-options=\"required:false,multiline:true,height:100,width:580\" /></td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t</tbody>\r\n");
      out.write("\t\t\t\t</table>\r\n");
      out.write("\t\t\t</form>\r\n");
      ...
      out.write("\t\ttitle=\"v\"></script>\r\n");
      out.write("\t<script type=\"text/javascript\" src=\"/js/back/domain/bespeak/bespeak.js\"\r\n");
      out.write("\t\ttitle=\"v\"></script>\r\n");
      out.write("</body>\r\n");
      out.write("</html>");
    } catch (Throwable t) {
