...
public final class message_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t<div class=\"t_851_2\">留言</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t<tbody id=\"messageList\">\r\n");
      out.write("\t\t\t\t\t\t</tbody>\r\n");
      out.write("\t\t\t\t\t</table>\r\n");
      ...
      out.write("\t\t{{#rows}}\r\n");
      out.write("\t\t\t<tr height=\"53\" align=\"center\" style=\"font-size:14px; color:#63a13f\">\r\n");
      out.write("            <td width=\"70\">{{title}}</td>\r\n");
      out.write("\t\t\t<td width=\"15\">&nbsp;</td>\r\n");
      ...
      out.write("\t\t\t\t\t{{^replyContent}}\r\n");
      out.write("\t\t\t\t\t\t<button type=\"button\" onclick=\"messageDetail({{id}});\" class=\"btn btn-success\">查看并回复</button>\r\n");
      out.write("\t\t\t\t\t{{/replyContent}}\r\n");
      out.write("\t\t\t\t\t{{#replyContent}}\r\n");
      out.write("\t\t\t\t\t\t<!--<button type=\"button\" class=\"btn btn-success\">已回复</button>-->\r\n");
      out.write("\t\t\t\t\t\t<button type=\"button\" onclick=\"messageDetail({{id}});\" class=\"btn btn-success\">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;查看&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</button>\r\n");
      out.write("\t\t\t\t\t{{/replyContent}}\r\n");
      out.write("\t\t        </td>\r\n");
      out.write("        </tr>\r\n");
      out.write("\t\t{{/rows}}\r\n");
