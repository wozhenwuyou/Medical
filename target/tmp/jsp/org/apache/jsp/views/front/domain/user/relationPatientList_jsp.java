...
public final class relationPatientList_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t\t\tonclick=\"location.href='/relationPatient'\">添加关联用户</button>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t<tbody id=\"relationPatientList\"></tbody>\r\n");
      ...
      out.write("\t<script type=\"text/javascript\"\r\n");
      out.write("\t\tsrc=\"/js/front/domain/user/relationPatientList.js\" title=\"v\"></script>\r\n");
      out.write("\t<script id=\"template\" type=\"x-tmpl-mustache\">\r\n");
      out.write("\t\t<tr height=\"53\" align=\"center\" style=\"font-size:14px; color:#63a13f\">\r\n");
      out.write("            <td width=\"155\">姓名</td>\r\n");
      out.write("            <td width=\"155\">联系电话</td>\r\n");
      out.write("            <td width=\"155\">与用户关系</td>\r\n");
      out.write("\t\t\t<td width=\"230\">操作</td>\r\n");
      out.write("        </tr>\r\n");
      out.write("\t\t{{#rows}}\r\n");
      out.write("\t\t\t<tr height=\"53\" align=\"center\" style=\"color:#666666\">\r\n");
      out.write("\t\t        <td width=\"155\">{{username}}</td>\r\n");
      out.write("\t\t        <td width=\"155\">{{phone}}</td>\r\n");
      out.write("\t\t        <td width=\"155\">{{userRelation}}</td>\r\n");
      out.write("\t\t\t\t<td width=\"230\">\r\n");
      out.write("\t\t\t\t\t<button class=\"btn btn-danger\" onclick=\"lh.confirm({content: '是否确定删除该关联用户？', clickYes:deleteRelationPatient, clickYesParam:{{id}}});\">删除</button>\r\n");
      out.write("\t\t\t\t\t<button class=\"btn btn-success\" onclick=\"readRelationPatient({{id}});\">详情</button>\r\n");
      out.write("\t\t\t\t</td>\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t{{/rows}}\r\n");
      out.write("\t</script>\r\n");
