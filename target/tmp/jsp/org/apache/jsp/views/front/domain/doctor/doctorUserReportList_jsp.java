...
public final class doctorUserReportList_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t<div class=\"t_851_2\">检测档案</div>\r\n");
      out.write("\t\t\t\t\t<div class=\"t_851_3\">\r\n");
      out.write("\t\t\t\t\t\t<table cellpadding=\"0\" cellspacing=\"0\" border=\"0\">\r\n");
      out.write("\t\t\t\t\t\t\t<tr height=\"44\" valign=\"middle\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<td width=\"100\">被检人名：</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td width=\"180\"><input type=\"text\" class=\"text_input2\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\tstyle=\"width: 160px;\" id=\"username\" /></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td width=\"75\">排序：</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td width=\"199\"><select id=\"searchType\" class=\"text_input2\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<option value=\"\">请选择</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<option value=\"1\">项目名称</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<option value=\"2\">检测时间</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<option value=\"3\">检测结果</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t</select></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td width=\"199\"><select id=\"ascOrdesc\" class=\"text_input2\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<option value=\"\">请选择</option>\r\n");
      ...
      out.write("\t<script type=\"text/javascript\"\r\n");
      out.write("\t\tsrc=\"/js/front/domain/doctor/doctorUserReportList.js\" title=\"v\"></script>\r\n");
      out.write("\r\n");
      out.write("\t<script id=\"template\" type=\"x-tmpl-mustache\">\r\n");
      out.write("\t\t<tr height=\"53\" align=\"center\" style=\"font-size:14px; color:#63a13f\">\r\n");
      out.write("            <td width=\"80\" align=\"center\">姓名</td>\r\n");
      out.write("            <td width=\"50\">性别</td>\r\n");
      out.write("            <td width=\"50\">年龄</td>\r\n");
      out.write("            <td width=\"80\">联系电话</td>\r\n");
      out.write("            <td width=\"80\">项目名称</td>\r\n");
      out.write("            <td width=\"80\">采血日期</td>\r\n");
      out.write("            <td width=\"80\">检测结果</td>\r\n");
      out.write(" \t\t\t<td width=\"70\">修改人</td>\r\n");
      out.write(" \t\t\t<td width=\"80\">修改时间</td>\r\n");
      out.write("            <td width=\"140\">操作</td>\r\n");
      out.write("        </tr>\r\n");
      out.write("\t\t{{#rows}}\r\n");
      out.write("\t\t\t<tr height=\"53\" align=\"center\" style=\"color:#666666\">\r\n");
      out.write("\t\t        <td width=\"80\" align=\"center\">{{patientName}}</td>\r\n");
      out.write("\t\t        <td width=\"50\">{{sexName}}</td>\r\n");
      out.write("\t\t        <td width=\"50\">{{age}}{{ageType}}</td>\r\n");
      out.write("\t\t        <td width=\"80\">{{patientPhone}}</td>\r\n");
      out.write("\t\t        <td width=\"80\">{{itemName}}</td>\r\n");
      out.write("\t\t        <td width=\"80\">{{&getAttrDate}}</td>\r\n");
      out.write("\t\t        <td width=\"80\">{{&resultHintName}}</td>\r\n");
      out.write(" \t\t\t\t<td width=\"70\">{{updatedBy}}</td>\r\n");
      out.write("  \t\t\t\t<td width=\"80\">{{updateDate}}</td>\r\n");
      out.write("\t\t        <td width=\"140\">\r\n");
      out.write("\t\t\t\t\t<!--<button type=\"button\" onclick=\"lh.confirm({content: '是否确定删除该病历？', clickYes:deletePatientReport, clickYesParam:{{id}}});\" class=\"btn btn-danger\">删除</button>-->\r\n");
      out.write("\t\t\t\t\t<button class=\"btn btn-info\" onclick=\"window.open('/doctor/prdPrint/{{id}}');\">打印</button>\r\n");
      out.write("\t\t\t\t\t<button class=\"btn btn-success\" onclick=\"readPatientReport({{id}});\">详情</button>\r\n");
      out.write("\t\t\t\t</td>\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t{{/rows}}\r\n");
      out.write("\t</script>\r\n");
