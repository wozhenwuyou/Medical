...
public final class regularRemindList_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${flag}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write("\">\r\n");
      out.write("\t\t\t\t\t<div>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"t_851_4\">\r\n");
      out.write("\t\t\t\t\t\t\t定期提醒\r\n");
      out.write("\t\t\t\t\t\t\t<button class=\"fr btn btn-success\"\r\n");
      out.write("\t\t\t\t\t\t\t\tonclick=\"location.href='/addOrUpdateRegularRemind'\">添加定期提醒</button>\r\n");
      out.write("\t\t\t\t\t\t\t<button class=\"fr btn btn-success\" onclick=\"allRemind()\"\r\n");
      out.write("\t\t\t\t\t\t\t\tstyle=\"margin: 0px 3px;\">所有提醒</button>\r\n");
      out.write("\t\t\t\t\t\t\t<button class=\"fr btn btn-success\" onclick=\"toDayRemind()\">今日提醒</button>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t<tbody id=\"regularRemindList\"></tbody>\r\n");
      ...
      out.write("\t<script type=\"text/javascript\"\r\n");
      out.write("\t\tsrc=\"/js/front/domain/user/regularRemindList.js\" title=\"v\"></script>\r\n");
      out.write("\t<script id=\"template\" type=\"x-tmpl-mustache\">\r\n");
      out.write("\t\t<tr height=\"53\" align=\"center\" style=\"font-size:14px; color:#63a13f\">\r\n");
      out.write("            <td width=\"155\">标题</td>\r\n");
      out.write("            <td width=\"155\">提醒时间</td>\r\n");
      out.write("            <td width=\"155\">状态</td>\r\n");
      out.write("            <td width=\"230\">操作</td>\r\n");
      out.write("        </tr>\r\n");
      out.write("\t\t{{#rows}}\r\n");
      out.write("\t\t\t<tr height=\"53\" align=\"center\" style=\"color:#666666\">\r\n");
      out.write("\t\t        <td width=\"155\" class=\"pointer\" onclick=\"lh.alert('{{content}}')\">{{title}}</td>\r\n");
      out.write("\t\t        <td width=\"155\">{{&remindDate}}</td>\r\n");
      out.write("\t\t        <td width=\"155\">{{&mainStatusName}}</td>\r\n");
      out.write("\t\t\t\t<td width=\"230\">\r\n");
      out.write("\t\t\t\t\t<button class=\"btn btn-danger\" onclick=\"lh.confirm({content: '是否确定删除该定期提醒？', clickYes:deleteRegularRemind, clickYesParam:{{id}}});\">删除</button>\r\n");
      out.write("\t\t\t\t\t<button class=\"btn btn-success\" onclick=\"addOrUpdateRegularRemind({{id}});\">修改</button>\r\n");
      out.write("\t\t\t\t\t<button class=\"btn btn-success\" onclick=\"notRemind({{id}});\">取消</button>\r\n");
      out.write("\t\t\t\t\t<button class=\"btn btn-success\" onclick=\"remind({{id}});\">不取消</button>\r\n");
      out.write("\t\t\t\t</td>\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t{{/rows}}\r\n");
      out.write("\t</script>\r\n");
