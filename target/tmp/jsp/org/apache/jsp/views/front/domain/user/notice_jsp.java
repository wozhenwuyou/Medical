...
public final class notice_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t<div class=\"t_851_4\">我的消息</div>\r\n");
      out.write("\t\t\t\t\t<input type=\"hidden\" id=\"userId\" value=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${user.id}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write("\">\r\n");
      ...
      out.write("\t<script type=\"text/javascript\" src=\"/js/front/domain/user/notice.js\"\r\n");
      out.write("\t\ttitle=\"v\"></script>\r\n");
      out.write("\t<script id=\"template\" type=\"x-tmpl-mustache\">\r\n");
      out.write("\t\t<tr height=\"53\" align=\"center\" style=\"font-size:14px; color:#63a13f\">\r\n");
      out.write("\t\t\t<td width=\"300\">留言内容</td>\r\n");
      out.write("\t\t\t<td width=\"300\">回复内容</td>\r\n");
      out.write("\t\t\t<td width=\"120\">回复人</td>\r\n");
      out.write("            <td width=\"140\">创建时间</td>\r\n");
      out.write("            <td width=\"60\">状态</td>\r\n");
      out.write("            <td width=\"100\">操作</td>\r\n");
      out.write("        </tr>\r\n");
      out.write("\t\t{{#rows}}\r\n");
      out.write("\t\t\t<tr height=\"53\" align=\"center\" style=\"color:#666666\">\r\n");
      out.write("\t\t        <td width=\"200\" id=\"content_{{id}}\" class=\"pointer\" onclick=\"lh.alert($('#content_{{id}}').text())\">{{title}}{{^title}}{{content}}{{/title}}</td>\r\n");
      out.write("\t\t\t\t<td width=\"200\" id=\"reply_{{id}}\" class=\"pointer\" onclick=\"lh.alert($('#reply_{{id}}').text())\">{{replyContent}}</td>\r\n");
      out.write("\t\t\t\t<td width=\"120\">{{receiverUserName}}</td>\r\n");
      out.write("\t\t        <td width=\"155\">{{&createDate}}</td>\r\n");
      out.write("\t\t        <td width=\"60\" id=\"statusName_{{id}}\">{{&mainStatusName}}</td>\r\n");
      out.write("\t\t\t\t<td width=\"100\">\r\n");
      out.write("\t\t\t\t\t<button class=\"btn btn-success\" onclick=\"lh.alert($('#reply_{{id}}').text());readMessage({{id}});\">查看内容</button>\r\n");
