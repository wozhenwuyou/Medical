...
public final class announcement_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t<div class=\"t_851_2\">公告列表</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t<td width=\"410\" align=\"right\"><a\r\n");
      out.write("\t\t\t\t\t\t\t\thref=\"/hospital/announcementAddOrUpdate\" class=\"l_109\">添加公告\r\n");
      out.write("\t\t\t\t\t\t\t\t\t+</a></td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t</table>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      ...
      out.write("\t<script type=\"text/javascript\"\r\n");
      out.write("\t\tsrc=\"/js/front/domain/hospital/announcement.js\" title=\"v\"></script>\r\n");
      ...
      out.write("\t\t        \t<button type=\"button\" onclick=\"lh.confirm({content: '是否确定删除该公告？', clickYes:deleData, clickYesParam:{{id}}});\" class=\"btn btn-danger\">删除</button>\r\n");
      out.write("\t\t\t\t\t<button type=\"button\" onclick=\"editData({{id}});\" class=\"btn btn-success\">编辑</button>\r\n");
      out.write("\t\t        </td>\r\n");
      out.write("\t\t    </tr>\r\n");
      out.write("\t\t{{/rows}}\r\n");
      out.write("\t</script>\r\n");
