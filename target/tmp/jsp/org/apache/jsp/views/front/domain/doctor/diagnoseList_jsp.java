...
public final class diagnoseList_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t\tonclick=\"javascript:location.href='/treatment'\">开始就诊</button>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t<div class=\"t_851_3\">\r\n");
      out.write("\t\t\t\t\t\t<table cellpadding=\"0\" cellspacing=\"0\" border=\"0\">\r\n");
      out.write("\t\t\t\t\t\t\t<tr height=\"44\" valign=\"middle\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<td width=\"75\">姓名：</td>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t<option value=\"2\">基本病情</option>\r\n");
      ...
      out.write("\t<script type=\"text/javascript\"\r\n");
      out.write("\t\tsrc=\"/js/front/domain/doctor/diagnoseList.js\" title=\"v\"></script>\r\n");
      out.write("\r\n");
      ...
      out.write("            <td width=\"155\">基本病情</td>\r\n");
      out.write("            <td width=\"155\">就诊时间</td>\r\n");
      out.write("            <td width=\"15\">&nbsp;</td>\r\n");
      out.write("            <td width=\"180\">操作</td>\r\n");
      out.write("        </tr>\r\n");
      out.write("\t\t{{#rows}}\r\n");
      ...
      out.write("\t        <td width=\"155\" class=\"pointer\" onclick=\"lh.alert('{{baseCondition}}')\">{{baseCondition}}</td>\r\n");
      out.write("\t        <td width=\"155\">{{createDate}}</td>\r\n");
      out.write("\t        <td width=\"15\">&nbsp;</td>\r\n");
      out.write("\t        <td width=\"180\">\r\n");
      out.write("\t\t\t\t<button type=\"button\" onclick=\"window.open('/diagnosePrint/{{id}}');\"\" class=\"btn btn-info\">打印</button>\r\n");
      out.write("\t\t\t\t{{#isOwner}}\r\n");
