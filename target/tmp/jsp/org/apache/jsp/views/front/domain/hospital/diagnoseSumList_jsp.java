...
public final class diagnoseSumList_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t<div class=\"t_851_2\">医生诊疗汇总</div>\r\n");
      out.write("\t\t\t\t<div class=\"c_851\">\r\n");
      out.write("\t\t\t\t\t<div class=\"t_851_3\">\r\n");
      out.write("\t\t\t\t\t\t<table cellpadding=\"0\" cellspacing=\"0\" border=\"0\">\r\n");
      out.write("\t\t\t\t\t\t\t<tr height=\"44\" valign=\"middle\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<td width=\"60\">医生：</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td width=\"80\"><input type=\"text\" class=\"text_input2\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\tstyle=\"width: 80px;\" id=\"realname\" /></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td width=\"60\">日期：</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td width=\"100\"><input type=\"text\" class=\"text_input2\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\tstyle=\"width: 100px;\" id=\"dateFrom\" /></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td width=\"60\">至：</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td width=\"100\"><input type=\"text\" class=\"text_input2\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\tstyle=\"width: 100px;\" id=\"dateTo\" /></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td width=\"60\">排序：</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td width=\"90\"><select id=\"searchType\" class=\"text_input2\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\tstyle=\"width: 90px;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<option value=\"\">请选择</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<option value=\"1\">病历数</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<option value=\"2\">总收入</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t</select></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td width=\"90\"><select id=\"ascOrdesc\" class=\"text_input2\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\tstyle=\"width: 90px;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<option value=\"\">请选择</option>\r\n");
      ...
      out.write("\t        <td width=\"155\">{{diagnoseCount}}</td>\r\n");
      out.write("\t\t\t<td width=\"155\">{{diagnoseTotalPrice}}{{^diagnoseTotalPrice}}0{{/diagnoseTotalPrice}}</td>\r\n");
      out.write("\t    </tr>\r\n");
      out.write("\t\t{{/rows}}\t\t \t\t \r\n");
      out.write("\t</script>\r\n");
      out.write("</body>\r\n");
