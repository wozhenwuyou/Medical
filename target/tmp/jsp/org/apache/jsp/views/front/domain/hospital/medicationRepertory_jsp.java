...
public final class medicationRepertory_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t药品库管理\r\n");
      out.write("\t\t\t\t\t<button class=\"fr btn btn-success\"\r\n");
      out.write("\t\t\t\t\t\tonclick=\"location.href='/hospital/addOrUpdateMedication'\">添加药品\r\n");
      out.write("\t\t\t\t\t\t+</button>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t<div class=\"t_851_3\">\r\n");
      out.write("\t\t\t\t\t<table cellpadding=\"0\" cellspacing=\"0\" border=\"0\">\r\n");
      out.write("\t\t\t\t\t\t<tr height=\"44\" valign=\"middle\">\r\n");
      out.write("\t\t\t\t\t\t\t<td width=\"75\">药品类型：</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td width=\"199\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<!-- <input type=\"text\" class=\"text_input2\" id=\"\"/> --> <select\r\n");
      out.write("\t\t\t\t\t\t\t\tid=\"medicationTypeId\" class=\"text_input2\" style=\"\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\tonclick=\"$('#name').val(null);$('#medicationTypeId').val(null);\"\r\n");
      out.write("\t\t\t\t\t\t\t\tstyle=\"margin-left: 10px;\" /></td>\r\n");
      out.write("\t\t\t\t\t\t\t<!-- \t                        <td width=\"309\" align=\"right\"><a href=\"/hospital/addOrUpdateMedication\" class=\"l_109\">添加药品 +</a></td> -->\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t</table>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t<div class=\"d_851_1\">\r\n");
      out.write("\t\t\t\t\t<table cellpadding=\"0\" cellspacing=\"0\" border=\"0\" width=\"849\">\r\n");
      out.write("\t\t\t\t\t\t<tbody id=\"medicationList\"></tbody>\r\n");
      ...
      out.write("\t<script type=\"text/javascript\"\r\n");
      out.write("\t\tsrc=\"/js/front/domain/hospital/medicationRepertory.js\" title=\"v\"></script>\r\n");
      out.write("\t<script id=\"template\" type=\"x-tmpl-mustache\">\r\n");
      out.write("\t\t<tr height=\"53\" align=\"center\" style=\"font-size:14px; color:#63a13f\">\r\n");
      out.write("        \t<td width=\"95\">药品类型名称</td>\r\n");
      out.write("            <td width=\"70\">药品名称</td>\r\n");
      out.write("            <td width=\"70\">库存数量</td>\r\n");
      out.write("            <td width=\"70\">警告数量</td>\r\n");
      out.write("\t\t\t<td width=\"70\">药品价格（元）</td>\r\n");
      out.write("            <td width=\"15\">&nbsp;</td>\r\n");
      out.write("            <td width=\"100\">操作</td>\r\n");
      out.write("        </tr>\r\n");
      out.write("\t\t{{#rows}}\r\n");
      out.write("\t\t\t<tr height=\"58\" align=\"center\" style=\"color:#666666\">\r\n");
      out.write("\t\t    \t<td width=\"95\">{{medicationTypeName}}</td>\r\n");
      out.write("\t\t        <td width=\"70\">{{medicationName}}</td>\r\n");
      out.write("\t\t        <td width=\"70\">{{remainNum}}</td>\r\n");
      out.write("\t\t        <td width=\"70\">{{warningNum}}</td>\r\n");
      out.write(" \t\t\t\t<td width=\"70\">{{price}}</td>\r\n");
      out.write("\t\t        <td width=\"15\">&nbsp;</td>\r\n");
      out.write("\t\t        <td width=\"100\">\r\n");
      out.write("\t\t        \t<button type=\"button\" onclick=\"lh.confirm({content: '是否确定删除该药品？', clickYes:deleteMedication, clickYesParam:{{id}}});\" class=\"btn btn-danger\">删除</button>\r\n");
      out.write("\t\t\t\t\t<button type=\"button\" onclick=\"editMedication({{id}});\" class=\"btn btn-success\">编辑</button>\r\n");
      out.write("\t\t        </td>\r\n");
      out.write("\t\t    </tr>\r\n");
      out.write("\t\t{{/rows}}\r\n");
      out.write("\t</script>\r\n");
  ...
  private boolean _jspx_meth_c_forEach_1(PageContext _jspx_page_context)
    ...
    _jspx_th_c_forEach_1.setItems((java.lang.Object) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${medicationTypeList}", java.lang.Object.class, (PageContext)_jspx_page_context, null));
    ...
    try {
      ...
      if (_jspx_eval_c_forEach_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${mt.id}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write('"');
          out.write('>');
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${mt.name}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write("</option>\r\n");
          out.write("\t\t\t\t\t\t\t\t\t");
