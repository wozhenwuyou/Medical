...
public final class bespeakRecord_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t<div class=\"t_851_4\">我的预约</div>\r\n");
      out.write("\t\t\t\t<div class=\"t_851_3\">\r\n");
      out.write("\t\t\t\t\t<table cellpadding=\"0\" cellspacing=\"0\" border=\"0\">\r\n");
      out.write("\t\t\t\t\t\t<tr height=\"44\" valign=\"middle\">\r\n");
      out.write("\t\t\t\t\t\t\t<td width=\"46\">类型：</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td width=\"118\"><select class=\"text_input1\" id=\"typeId\"><option\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tvalue=\"\">请选择</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<option value=\"1\">远程诊疗</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<option value=\"2\">上门服务</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<option value=\"3\">血液检测</option>\r\n");
      out.write("\t\t\t\t\t\t\t</select></td>\r\n");
      out.write("\t\t\t\t\t\t\t<!-- <td width=\"75\">基本病情：</td>\r\n");
      out.write("\t\t                        <td width=\"199\"><input type=\"text\" class=\"text_input2\" id=\"baseCondition\" /></td> -->\r\n");
      ...
      out.write("\t\t\t\t\t\t<tbody id=\"bespeakRecordList\">\r\n");
      out.write("\t\t\t\t\t\t\t<tr height=\"53\" align=\"center\"\r\n");
      out.write("\t\t\t\t\t\t\t\tstyle=\"font-size: 14px; color: #63a13f\" id=\"noData\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<td width=\"95\">暂无数据</td>\r\n");
      out.write("\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t</tbody>\r\n");
      out.write("\t\t\t\t\t</table>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      ...
      out.write("\t<script type=\"text/javascript\"\r\n");
      out.write("\t\tsrc=\"/js/front/domain/user/bespeakRecord.js\" title=\"v\"></script>\r\n");
      out.write("\t<script id=\"template\" type=\"x-tmpl-mustache\">\r\n");
      out.write("\t\t<tr height=\"53\" align=\"center\" style=\"font-size:14px; color:#63a13f\">\r\n");
      out.write("\t\t\t<td width=\"160\">预约诊所</td>\r\n");
      out.write("\t\t\t<td width=\"90\">预约医生</td>\r\n");
      out.write("        \t<td width=\"90\">患者名称</td>\r\n");
      out.write("            <td width=\"80\">预约时间</td>\r\n");
      out.write("            <td width=\"90\">预约类型</td>\r\n");
      out.write(" \t\t\t<td width=\"100\">项目</td>\r\n");
      out.write("\t\t\t<td width=\"100\">检测类型</td>\r\n");
      out.write("            <td width=\"100\">状态</td>\r\n");
      out.write("            <td width=\"5\">&nbsp;</td>\r\n");
      out.write("            <td width=\"100\">操作</td>\r\n");
      out.write("        </tr>\r\n");
      out.write("\t\t{{#rows}}\r\n");
      out.write("\t\t\t<tr height=\"58\" align=\"center\" style=\"color:#666666\">\r\n");
      out.write("\t\t\t\t<td width=\"160\">{{hospitalName}}</td>\r\n");
      out.write(" \t\t\t\t<td width=\"90\">{{doctorName}}</td>\r\n");
      out.write("\t\t        <td width=\"90\">{{patientName}}</td>\r\n");
      out.write("\t\t        <td width=\"80\">{{&bespeakDate}}</td>\r\n");
      out.write("\t\t        <td width=\"90\">{{&typeName}}</td>\r\n");
      out.write(" \t\t\t\t<td width=\"100\">{{&isRegisterAgent}}</td>\r\n");
      out.write("\t\t\t\t<td width=\"100\">{{&cancerTypesName}}</td>\r\n");
      out.write("\t\t        <td width=\"100\">{{&logicStatusName}}</td>\r\n");
      out.write("\t\t        <td width=\"5\">&nbsp;</td>\r\n");
      out.write("\t\t        <td width=\"100\">\r\n");
      out.write("\t\t        \t<!--<button type=\"button\" onclick=\"lh.confirm({content: '是否确定删除该预约？', clickYes:deleteBespeak, clickYesParam:{{id}}});\" class=\"btn btn-danger\">删除</button>-->\r\n");
      out.write("\t\t\t\t\t<button type=\"button\" onclick=\"bespeakRecordDetail({{id}});\" class=\"btn btn-success\">详情</button>\r\n");
      out.write("\t\t        </td>\r\n");
      out.write("\t\t    </tr>\r\n");
      out.write("\t\t{{/rows}}\r\n");
      out.write("\t</script>\r\n");
