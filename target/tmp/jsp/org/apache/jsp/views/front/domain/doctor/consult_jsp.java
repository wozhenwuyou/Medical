...
public final class consult_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t<div class=\"t_851_2\">咨询</div>\r\n");
      ...
      out.write("\t\t\t\t\t</table>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t<div class=\"c_824\" style=\"background-color: #FFFFFF; padding: 0px;\">\r\n");
      out.write("\t\t\t\t\t<div class=\"d_851_1\">\r\n");
      out.write("\t\t\t\t\t\t<table cellpadding=\"0\" cellspacing=\"0\" border=\"0\" width=\"849\">\r\n");
      out.write("\t\t\t\t\t\t\t<tbody id=\"consultList\">\r\n");
      out.write("\t\t\t\t\t\t\t</tbody>\r\n");
      out.write("\t\t\t\t\t\t</table>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t<script type=\"text/javascript\" src=\"/js/front/domain/doctor/consult.js\"\r\n");
      out.write("\t\ttitle=\"v\"></script>\r\n");
      out.write("\t<script id=\"template\" type=\"x-tmpl-mustache\">\r\n");
      out.write("\t\t<tr height=\"53\" align=\"center\" style=\"font-size:14px; color:#63a13f\">\r\n");
      out.write("        \t<td width=\"120\">咨询人</td>\r\n");
      out.write("            <td width=\"220\">咨询标题</td>\r\n");
      out.write("            <td width=\"120\">创建时间</td>\r\n");
      ...
      out.write("\t\t{{#rows}}\r\n");
      out.write("\t\t\t<tr height=\"53\" align=\"center\" style=\"font-size:14px; color:#63a13f\">\r\n");
      out.write("        \t<td width=\"120\">{{consultUsername}}</td>\r\n");
      out.write("            <td width=\"200\">{{title}}</td>\r\n");
      out.write("            <td width=\"120\">{{&createDate}}</td>\r\n");
      out.write("\t\t\t<td width=\"15\">&nbsp;</td>\r\n");
      out.write("\t\t\t<td width=\"50\">\r\n");
      out.write("\t\t\t{{#replyContent}}已回复{{/replyContent}}\r\n");
      out.write("\t\t\t{{^replyContent}}<span style=\"color:orange;\">未回复</span>{{/replyContent}}\r\n");
      out.write("\t\t\t</td>\r\n");
      out.write("\t\t        <td width=\"184\">\r\n");
      out.write("\t\t\t\t\t{{^replyContent}}\r\n");
      out.write("\t\t\t\t\t\t<button type=\"button\" onclick=\"consultDetail({{id}});\" class=\"btn btn-success\">查看并回复</button>\r\n");
      out.write("\t\t\t\t\t{{/replyContent}}\r\n");
      out.write("\t\t\t\t\t{{#replyContent}}\r\n");
      out.write("\t\t\t\t\t\t<!--<button type=\"button\" class=\"btn btn-success\">已回复</button>-->\r\n");
      out.write("\t\t\t\t\t\t<button type=\"button\" onclick=\"consultDetail({{id}});\" class=\"btn btn-success\">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;查看&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</button>\r\n");
      out.write("\t\t\t\t\t{{/replyContent}}\r\n");
      out.write("\t\t        </td>\r\n");
      out.write("        </tr>\r\n");
      out.write("\t\t{{/rows}}\r\n");
