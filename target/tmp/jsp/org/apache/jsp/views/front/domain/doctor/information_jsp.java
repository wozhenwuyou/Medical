...
public final class information_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\">\r\n");
      out.write("\t\t\t\t<div class=\"c_824\" style=\"background-color: #FFFFFF;\">\r\n");
      out.write("\t\t\t\t\t<div class=\"t_851_2\">\r\n");
      out.write("\t\t\t\t\t\t文章\r\n");
      out.write("\t\t\t\t\t\t<button class=\"fr btn btn-success\"\r\n");
      out.write("\t\t\t\t\t\t\tonclick=\"location.href='/addOrUpdateArticlePage'\">添加文章 +</button>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t<div class=\"t_851_3\">\r\n");
      out.write("\t\t\t\t\t\t<table cellpadding=\"0\" cellspacing=\"0\" border=\"0\">\r\n");
      out.write("\t\t\t\t\t\t\t<tr height=\"44\" valign=\"middle\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<td width=\"46\">栏目：</td>\r\n");
      ...
      out.write("\t<script type=\"text/javascript\"\r\n");
      out.write("\t\tsrc=\"/js/front/domain/doctor/information.js\" title=\"v\"></script>\r\n");
      out.write("\t<script id=\"template\" type=\"x-tmpl-mustache\">\r\n");
      out.write("\t\t<tr height=\"53\" align=\"center\" style=\"font-size:14px; color:#63a13f\">\r\n");
      out.write("\t\t\t<td width=\"95\">栏目</td>\r\n");
      out.write("        \t<td width=\"200\">标题</td>\r\n");
      out.write("\t\t\t<td width=\"95\">创建时间</td>\r\n");
      out.write("\t\t\t<td width=\"120\">操作</td>\r\n");
      out.write("        </tr>\r\n");
      out.write("\t\t{{#rows}}\r\n");
      out.write("\t\t\t<tr height=\"58\" align=\"center\" style=\"color:#666666\">\r\n");
      out.write("\t\t\t\t<td width=\"95\" class=\"pointer\">{{typeName}}</td>\r\n");
      out.write("\t    \t\t<td width=\"200\" class=\"pointer\">\r\n");
      out.write("\t\t\t\t\t<a href=\"/doctorArticleDetails/{{id}}\" target=\"_blank\">{{title}}</a>\r\n");
      out.write("\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t<td width=\"95\">{{&createDate}}</td>\r\n");
      out.write("\t\t\t\t<td width=\"120\">\r\n");
      out.write("\t\t\t\t\t{{#isOwner}}{{/isOwner}}\r\n");
      out.write("\t\t\t\t\t<button type=\"button\" onclick=\"lh.confirm({content: '是否确定删除该文章？', clickYes:deleteArticle, clickYesParam:{{id}}});\" class=\"btn btn-danger\">删除</button>\r\n");
      out.write("\t\t\t\t\t<button class=\"btn btn-info\" onclick=\"lh.jumpToUrl('/addOrUpdateArticlePage?articleId={{id}}');\">修改</button>\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t<button class=\"btn btn-success\" onclick=\"lh.open('/doctorArticleDetails/{{id}}');\">查看</button>\r\n");
      out.write("\t\t\t\t</td>\r\n");
      out.write("\t    \t</tr>\r\n");
      out.write("\t\t{{/rows}}\r\n");
      out.write("\t</script>\r\n");
  ...
  private boolean _jspx_meth_c_forEach_2(PageContext _jspx_page_context)
    ...
    _jspx_th_c_forEach_2.setVar("article");
    _jspx_th_c_forEach_2.setItems((java.lang.Object) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${articleType}", java.lang.Object.class, (PageContext)_jspx_page_context, null));
    ...
    try {
      ...
      if (_jspx_eval_c_forEach_2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          out.write('"');
          out.write('>');
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${article.codeName}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write("</option>\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t");
