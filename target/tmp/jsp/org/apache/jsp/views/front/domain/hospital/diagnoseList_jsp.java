...
public final class diagnoseList_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t\t<tbody id=\"dataListContainerList\">\r\n");
      out.write("\t\t\t\t\t\t\t</tbody>\r\n");
      out.write("\t\t\t\t\t\t</table>\r\n");
      ...
      out.write("\t<script type=\"text/javascript\"\r\n");
      out.write("\t\tsrc=\"/js/front/domain/hospital/diagnoseList.js\" title=\"v\"></script>\r\n");
      out.write("\r\n");
      out.write("\t<script id=\"template\" type=\"x-tmpl-mustache\"><!-- -->\r\n");
      out.write("\t\t<tr height=\"53\" align=\"center\" style=\"font-size:14px; color:#63a13f\">\r\n");
      out.write("        \t<td width=\"95\">所属医生</td>\r\n");
      out.write("        \t<td width=\"95\">姓名</td>\r\n");
      out.write("            <td width=\"70\">性别</td>\r\n");
      out.write("            <td width=\"155\">联系电话</td>\r\n");
      out.write("            <td width=\"155\">就诊时间</td>\r\n");
      out.write("\t\t\t<td width=\"155\">药品总价</td>\r\n");
      out.write("            <td width=\"15\">&nbsp;</td>\r\n");
      out.write("            <td width=\"140\">操作</td>\r\n");
      out.write("        </tr>\r\n");
      out.write("\t\t{{#rows}}\r\n");
      out.write("\t\t<tr height=\"58\" align=\"center\" style=\"color:#666666\">\r\n");
      out.write("\t    \t<td width=\"95\">{{doctorName}}</td>\r\n");
      out.write("\t    \t<td width=\"95\">{{patientName}}</td>\r\n");
      out.write("\t        <td width=\"70\">{{patientSexName}}</td>\r\n");
      out.write("\t        <td width=\"155\">{{patientPhone}}</td>\r\n");
      out.write("\t        <td width=\"155\">{{createDate}}</td>\r\n");
      out.write("\t\t\t<td width=\"155\">{{medicalTotalPrice}}</td>\r\n");
      out.write("\t        <td width=\"15\">&nbsp;</td>\r\n");
      out.write("\t        <td width=\"140\">\r\n");
      out.write("\t\t\t\t<button type=\"button\" onclick=\"window.open('/hospital/diagnosePrint/{{id}}');\"\" class=\"btn btn-info\">打印</button>\r\n");
      out.write("\t\t\t\t{{#isOwner}}\r\n");
      out.write("\t\t\t\t<button type=\"button\" onclick=\"lh.confirm({content: '是否确定删除该病历？', clickYes:deleteDiagnose, clickYesParam:{{id}}});\" class=\"btn btn-danger\">删除</button>\r\n");
      out.write("\t\t\t\t<button type=\"button\" onclick=\"readDiagnose({{id}});\" class=\"btn btn-success\">查看</button>\r\n");
      out.write("\t\t\t\t{{/isOwner}}\r\n");
      out.write("\t\t\t\t{{^isOwner}}\r\n");
      out.write("\t\t\t\t<button type=\"button\" onclick=\"readDiagnose({{id}});\" class=\"btn btn-primary\">查看</button>\r\n");
      out.write("\t\t\t\t{{/isOwner}}\r\n");
      out.write("\r\n");
      out.write("\r\n");
      out.write("\t        </td>\r\n");
