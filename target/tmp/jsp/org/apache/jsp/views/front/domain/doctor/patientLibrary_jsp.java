...
public final class patientLibrary_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\tonclick=\"location.href='/patientAddOrUpdate'\">添加患者 +</button>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t<div class=\"t_851_3\">\r\n");
      out.write("\t\t\t\t\t<table cellpadding=\"0\" cellspacing=\"0\" border=\"0\">\r\n");
      out.write("\t\t\t\t\t\t<tr height=\"44\" valign=\"middle\">\r\n");
      out.write("\t\t\t\t\t\t\t<td width=\"60\">区域：</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td width=\"118\"><select class=\"text_input1\" id=\"province\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t<td width=\"60\">排序：</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td width=\"199\"><select id=\"searchType\" class=\"text_input1\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<option value=\"\">请选择</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<option value=\"1\">地区</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<option value=\"2\">注册时间</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<option value=\"3\">患者姓名</option>\r\n");
      out.write("\t\t\t\t\t\t\t</select></td>\r\n");
      out.write("\t\t\t\t\t\t\t<td width=\"199\"><select id=\"ascOrdesc\" class=\"text_input1\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<option value=\"\">请选择</option>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\tonclick=\"restSearch()\" /></td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t</table>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      ...
      out.write("\t<script type=\"text/javascript\" src=\"/js/front/domain/doctor/patientLibrary.js\" title=\"v\"></script>\r\n");
      out.write("\t<script id=\"template\" type=\"x-tmpl-mustache\">\r\n");
      out.write("\t\t<tr height=\"53\" align=\"center\" style=\"font-size:14px; color:#63a13f\">\r\n");
      out.write("        \t<td width=\"95\">用户昵称</td>\r\n");
      out.write("\t\t\t<td width=\"95\">真实姓名</td>\r\n");
      out.write("            <td width=\"70\">性别</td>\r\n");
      out.write("            <td width=\"130\">地区</td>\r\n");
      out.write("            <td width=\"155\">联系电话</td>\r\n");
      out.write("            <td width=\"115\">注册时间</td>\r\n");
      out.write("            <td width=\"50\">档案</td>\r\n");
      out.write("            <td width=\"184\">操作</td>\r\n");
      out.write("        </tr>\r\n");
      out.write("\t\t{{#rows}}\r\n");
      out.write("\t\t\t<tr height=\"53\" align=\"center\">\r\n");
      out.write("        \t<td width=\"95\">{{username}}</span></td>\r\n");
      out.write("\t\t\t<td width=\"95\">{{realName}}</td>\r\n");
      out.write("            <td width=\"70\">{{sexName}}</td>\r\n");
      out.write("            <td width=\"130\">{{provinceName}}&nbsp;{{cityName}}</td>\r\n");
      out.write("            <td width=\"155\">{{phone}}</td>\r\n");
      out.write("            <td width=\"115\">{{&createDate}}</td>\r\n");
      out.write("\t\t\t<td width=\"50\">{{&fmtPhrBasicInfoId}}</td>\r\n");
      out.write("\t\t\t{{#canUpdate}}\r\n");
      out.write("\t\t        <td width=\"184\">\r\n");
      out.write("\t\t        \t<button type=\"button\" onclick=\"lh.confirm({content: '是否确定删除该患者？', clickYes:deletePatient, clickYesParam:{{id}}});\" class=\"btn btn-danger\">删除</button>\r\n");
      out.write("\t\t\t\t\t<button type=\"button\" onclick=\"editPatient({{id}});\" class=\"btn btn-success\">编辑</button>\r\n");
      out.write("\t\t        </td>\r\n");
      out.write("\t\t\t{{/canUpdate}}\r\n");
      out.write("\t\t\t{{^canUpdate}}\r\n");
      out.write("\t\t        <td width=\"184\">\r\n");
      out.write("\t\t\t\t\t<button type=\"button\" onclick=\"editPatient({{id}}, 'read');\" class=\"btn btn-info\">查看</button>\r\n");
      out.write("\t\t        </td>\r\n");
      out.write("\t\t\t{{/canUpdate}}\r\n");
      out.write("        </tr>\r\n");
      out.write("\t\t{{/rows}}\r\n");
  ...
  private boolean _jspx_meth_c_forEach_2(PageContext _jspx_page_context)
    ...
    _jspx_th_c_forEach_2.setVar("provinceCityArea");
