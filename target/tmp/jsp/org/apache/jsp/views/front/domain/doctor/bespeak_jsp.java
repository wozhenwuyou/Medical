...
public final class bespeak_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t<script type=\"text/javascript\" src=\"/js/front/domain/doctor/bespeak.js\"\r\n");
      out.write("\t\ttitle=\"v\"></script>\r\n");
      out.write("\t<script id=\"template\" type=\"x-tmpl-mustache\">\r\n");
      out.write("\t\t<tr height=\"53\" align=\"center\" style=\"font-size:14px; color:#63a13f\">\r\n");
      out.write("        \t<td width=\"110\">患者名称</td>\r\n");
      out.write("            <td width=\"120\">预约时间</td>\r\n");
      out.write("            <td width=\"110\">预约类型</td>\r\n");
      out.write(" \t\t\t<td width=\"110\">项目</td>\r\n");
      out.write("\t\t\t<td width=\"110\">检测类型</td>\r\n");
      out.write("            <td width=\"120\">状态</td>\r\n");
      out.write("            <td width=\"15\">&nbsp;</td>\r\n");
      out.write("            <td width=\"185\">操作</td>\r\n");
      out.write("        </tr>\r\n");
      out.write("\t\t{{#rows}}\r\n");
      out.write("\t\t\t<tr height=\"58\" align=\"center\" style=\"color:#666666\">\r\n");
      out.write("\t\t        <td width=\"110\">{{patientName}}</td>\r\n");
      out.write("\t\t        <td width=\"120\">{{&bespeakDate}}</td>\r\n");
      out.write("\t\t        <td width=\"110\">{{&typeName}}</td>\r\n");
      out.write(" \t\t\t\t<td width=\"110\">{{&isRegisterAgent}}</td>\r\n");
      out.write("\t\t\t\t<td width=\"110\">{{&cancerTypesName}}</td>\r\n");
      out.write("\t\t        <td width=\"120\">{{&logicStatusName}}</td>\r\n");
      out.write("\t\t        <td width=\"15\">&nbsp;</td>\r\n");
      out.write("\t\t        <td width=\"185\">\r\n");
      ...
      out.write("\t\t\t\t\t<button type=\"button\" onclick=\"updateBespeakRead({{id}});\" class=\"btn btn-success\">确认</button>\r\n");
      out.write("\t\t\t\t\t<button type=\"button\" onclick=\"updateBespeaNotRead({{id}});\" class=\"btn btn-danger\">驳回</button>\r\n");
      out.write("\t\t\t\t\t<button type=\"button\" onclick=\"bespeakDeatil({{id}});\" class=\"btn btn-success\">详情</button>\r\n");
      out.write("\t\t        </td>\r\n");
      out.write("\t\t    </tr>\r\n");
      out.write("\t\t{{/rows}}\r\n");
      out.write("\t</script>\r\n");
