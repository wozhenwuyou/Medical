...
public final class phrList_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t\t\t<td width=\"64\">姓名：</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td width=\"100\"><input type=\"text\" class=\"text_input1\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\tid=\"name\" /></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td width=\"64\">&nbsp;&nbsp;编号：</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td width=\"100\"><input type=\"text\" class=\"text_input1\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\tid=\"userNo\" /></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td width=\"75\">&nbsp;&nbsp;身份证：</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td width=\"220\"><input type=\"text\" class=\"text_input2\" id=\"idCardNo\" /></td>\r\n");
      ...
      out.write("\t<script type=\"text/javascript\" src=\"/js/front/domain/doctor/phrList.js\" title=\"v\"></script>\r\n");
      out.write("\r\n");
      out.write("<!-- <button type=\"button\" onclick=\"location.href='/phr/doctor/phrDetail/{{id}}'\" class=\"btn btn-success\">查看</button> -->\r\n");
      out.write("<!-- <button type=\"button\" onclick=\"location.href='/phr/doctor/phrEdit/{{id}}'\" class=\"btn btn-warning\">编辑</button> -->\r\n");
      out.write("\t<script id=\"template\" type=\"x-tmpl-mustache\"><!-- -->\r\n");
      out.write("\t\t<tr height=\"53\" align=\"center\" style=\"font-size:14px; color:#63a13f\">\r\n");
      out.write("        \t<td width=\"85\">姓名</td>\r\n");
      out.write("\t\t\t<td width=\"50\">性别</td>\r\n");
      out.write("\t\t\t<td width=\"85\">编号</td>\r\n");
      out.write("            <td width=\"155\">身份证号</td>\r\n");
      out.write("\t\t\t<td width=\"100\">电话</td>\r\n");
      out.write("            <td width=\"180\" align=\"left\">操作</td>\r\n");
      out.write("        </tr>\r\n");
      out.write("\t\t{{#rows}}\r\n");
      out.write("\t\t<tr height=\"58\" align=\"center\" style=\"color:#666666\">\r\n");
      out.write("\t    \t<td width=\"85\">{{name}}</td>\r\n");
      out.write("\t        <td width=\"50\">{{sex}}</td>\r\n");
      out.write("\t        <td width=\"85\">{{userNo}}</td>\r\n");
      out.write("\t        <td width=\"155\">{{idCardNo}}</td>\r\n");
      out.write("\t        <td width=\"100\">{{tel}}</td>\r\n");
      out.write("\t        <td width=\"210\" align=\"left\">\r\n");
      out.write("\t\t\t\t<button type=\"button\" onclick=\"fnView('{{id}}', '{{name}}')\" class=\"btn btn-success\">查看</button>\r\n");
      out.write("\t\t\t\t{{#mine}}\r\n");
      out.write("\t\t\t\t\t<button type=\"button\" onclick=\"fnEdit('{{id}}', '{{name}}')\" class=\"btn btn-warning\">编辑</button>\r\n");
      out.write("\t\t\t\t\t<button type=\"button\" onclick=\"lh.confirm({content: '是否确定删除？', clickYes:deletePhrBasicInfo, clickYesParam:{{id}}});\" class=\"btn btn-danger\">删除</button>\r\n");
      ...
      out.write("\t<li><a href=\"javascript:void(0);\" onclick=\"fnAddCoverTable(this, '添加', '', {{id}}, {{hasCover}});\">封面</a></li>\r\n");
      out.write("\t<li role=\"separator\" class=\"divider\"></li>\r\n");
      out.write("    <li><a href=\"javascript:void(0);\" onclick=\"fnAddHealthCheckTable(this, '添加', '', {{id}});\">体检表</a></li>\r\n");
      out.write("    <li role=\"separator\" class=\"divider\"></li>\r\n");
      out.write("    <li><a href=\"#\">高血压表</a></li>\r\n");
      out.write("  </ul>\r\n");
      out.write("</div>\r\n");
      out.write("\t\t\t\t{{/mine}}\r\n");
      out.write("\t        </td>\r\n");
