...
public final class phrList_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t\t\t<td width=\"80\"><input type=\"text\" class=\"text_input1\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\tid=\"name\" onkeyup=\"loadGridData();\" /></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td width=\"60\">&nbsp;编号：</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td width=\"80\"><input type=\"text\" class=\"text_input1\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\tid=\"userNo\" onkeyup=\"loadGridData();\" /></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td width=\"90\">&nbsp;身份证：</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td width=\"80\"><input type=\"text\" class=\"text_input1\" id=\"idCardNo\" onkeyup=\"loadGridData();\" /></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td width=\"60\">&nbsp;范围：</td>\r\n");
      ...
      out.write("\t\t\t<td width=\"100\">{{fmtCreateTime}}</td>\r\n");
      out.write("\t\t\t<td width=\"100\">{{jdr}}</td>\r\n");
