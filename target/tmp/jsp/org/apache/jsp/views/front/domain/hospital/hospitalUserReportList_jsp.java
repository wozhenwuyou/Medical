...
public final class hospitalUserReportList_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t\t\t<td width=\"140\"><input type=\"text\" class=\"text_input2\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\tstyle=\"width: 130px;\" id=\"doctorName\" /></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td width=\"80\">被检人：</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td width=\"140\"><input type=\"text\" class=\"text_input2\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\tstyle=\"width: 130px;\" id=\"patientName\" /></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td width=\"60\">排序：</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td width=\"100\"><select id=\"searchType\" class=\"text_input2\"\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t</select></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td width=\"100\"><select id=\"ascOrdesc\" class=\"text_input2\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\tstyle=\"width: 80px;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<option value=\"\">请选择</option>\r\n");
      ...
      out.write("\t\t\t\t<td width=\"120\" align=\"center\">{{doctorName}}</td>\r\n");
      out.write("\t\t        <td width=\"120\" align=\"center\">{{patientName}}</td>\r\n");
      out.write("\t\t        <td width=\"60\">{{sexName}}</td>\r\n");
      out.write("\t\t        <td width=\"60\">{{age}}{{ageType}}</td>\r\n");
      out.write("\t\t        <td width=\"80\">{{patientPhone}}</td>\r\n");
      out.write("\t\t        <td width=\"120\">{{itemName}}</td>\r\n");
      out.write("\t\t        <td width=\"80\">{{&getAttrDate}}</td>\r\n");
      out.write("\t\t        <td width=\"80\">{{&resultHintName}}</td>\r\n");
      out.write("\t\t        <td width=\"140\">\r\n");
      out.write("\t\t\t\t\t<button class=\"btn btn-info\" onclick=\"window.open('/hospital/prdPrint/{{id}}');\">打印</button>\r\n");
