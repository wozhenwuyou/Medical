...
public final class userDiagnoseList_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t\t<tbody id=\"userDiagnoseList\"></tbody>\r\n");
      ...
      out.write("\t<script type=\"text/javascript\"\r\n");
      out.write("\t\tsrc=\"/js/front/domain/user/userDiagnoseList.js\" title=\"v\"></script>\r\n");
      out.write("\t<script id=\"template\" type=\"x-tmpl-mustache\">\r\n");
      out.write("\t\t<tr height=\"53\" align=\"center\" style=\"font-size:14px; color:#63a13f\">\r\n");
      out.write("        \t<td width=\"95\">诊所</td>\r\n");
      out.write("            <td width=\"70\">科室</td>\r\n");
      out.write("            <td width=\"130\">医生</td>\r\n");
      out.write("            <td width=\"155\">用户姓名</td>\r\n");
      out.write("            <td width=\"155\">用户性别</td>\r\n");
      out.write("            <td width=\"155\">用户年龄</td>\r\n");
      out.write("            <td width=\"155\">就诊日期</td>\r\n");
      out.write("\t\t\t<td width=\"230\">操作</td>\r\n");
      out.write("        </tr>\r\n");
      out.write("\t\t{{#rows}}\r\n");
      out.write("\t\t\t<tr height=\"53\" align=\"center\" style=\"color:#666666\">\r\n");
      out.write("\t\t    \t<td width=\"95\">{{hospitalName}}</td>\r\n");
      out.write("\t\t        <td width=\"70\">{{departmentName}}</td>\r\n");
      out.write("\t\t        <td width=\"130\">{{doctorName}}</td>\r\n");
      out.write("\t\t        <td width=\"155\">{{patientName}}</td>\r\n");
      out.write("\t\t        <td width=\"155\">{{patientSexName}}</td>\r\n");
      out.write("\t\t        <td width=\"155\">{{patientAge}}</td>\r\n");
      out.write("\t\t        <td width=\"155\">{{&diagnoseDate}}</td>\r\n");
      out.write("\t\t\t\t<td width=\"230\">\r\n");
      out.write("\t\t\t\t\t<!--<button class=\"btn btn-danger\" onclick=\"lh.confirm({content: '是否确定删除该病历？', clickYes:deleteDiagnose, clickYesParam:{{id}}});\">删除</button>-->\r\n");
      out.write("\t\t\t\t\t<button class=\"btn btn-success\" onclick=\"readDiagnose({{id}});\">详情</button>\r\n");
      out.write("\t\t\t\t</td>\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t{{/rows}}\r\n");
      out.write("\t</script>\r\n");
