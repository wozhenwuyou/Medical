...
public final class hospitalBloodTest_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t当前位置：<a href=\"/\">首页</a>-血液检测\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t\t<div id=\"ss-ul\" style=\"height: inherit;\">\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t<div class=\"hd\" style=\"margin: 10px;\">\r\n");
      ...
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t<!-- <div style=\"margin-left:260px;\">\r\n");
      out.write("\t\t               \t<button class=\"btn btn-success\" onclick=\"doSearch();\">查询</button>\r\n");
      out.write("\t    \t           \t<button class=\"btn btn-default\" onclick=\"resetSearch();\">重置</button>\r\n");
      out.write("\t               \t</div> -->\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\r\n");
      ...
      out.write("\t<script type=\"text/javascript\"\r\n");
      out.write("\t\tsrc=\"/js/front/domain/user/hospitalBloodTest.js\" title=\"v\"></script>\r\n");
      out.write("\t<script id=\"template\" type=\"x-tmpl-mustache\">\r\n");
      out.write("\t\t{{#rows}}\r\n");
      out.write("\t            <div class=\"yy-int\">\r\n");
      out.write("\t            \t<div onclick=\"location.href='/bloodTest/{{id}}?isBloodTest=1'\" class=\"yy-content\" style=\"width:500px;cursor:pointer;\">\r\n");
      out.write("\t                \t<img src=\"{{logo}}\" class=\"yy-int-img pointer\" style=\"width: 130px;height: 130px;  overflow: hidden;\" onerror=\"this.src='/images/front/er8.jpg'\"/>\r\n");
      out.write("\t                   \t\t<div class=\"yy-p\" style=\"overflow: hidden;text-overflow: ellipsis;padding: 10px;\">\r\n");
      out.write("\t                     \t<h2><a href=\"javascript:\">{{wholeName}}</a></h2>\r\n");
      out.write("\t                      \t<p>\r\n");
      out.write("\t                          <span>地址：</span>{{provinceName}}-{{cityName}}-{{address}}<br/>\r\n");
      out.write("\t                          <span>联系方式：{{phone}},{{tel}}<br/>\r\n");
      out.write("\t                       \t</p>\r\n");
      out.write("\t                </div>\r\n");
      out.write("\t              </div>\r\n");
      out.write("\t\t\t\t<button class=\"btn btn-success fr\" style=\"position: relative;bottom: 60px;right: 20px;\" onclick=\"javascript:window.open('/hospital/{{attrStr}}')\">诊所详情</button>\r\n");
      out.write("\t\t\t\t<button class=\"btn btn-success fr\" style=\"position: relative;bottom: 60px;right: 20px;margin-right:10px;\" onclick=\"javascript:location.href='/bloodTest/{{id}}?isBloodTest=1'\">血液检测</button>\r\n");
      out.write("\t         </div>\r\n");
      out.write("\t\t{{/rows}}\r\n");
      out.write("\t</script>\r\n");
      out.write("</body>\r\n");
