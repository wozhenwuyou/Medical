...
public class MedicationLogService extends CommonService<MedicationLog> {
	...
	public List<MedicationLog> selectOutSumList(Map<String, Object> map) {
		return medicationLogmapper.selectOutSumList(map);
	}
	
	public Integer selectOutSumCount(Map<String, Object> map) {
		return medicationLogmapper.selectOutSumCount(map);
	}
