...
import com.lhfeiyu.thirdparty.wx.message.resp.Article;
import com.lhfeiyu.thirdparty.wx.message.resp.Music;
import com.lhfeiyu.thirdparty.wx.pojo.SNSUserInfo;
import com.lhfeiyu.thirdparty.wx.pojo.WeixinGroup;
import com.lhfeiyu.thirdparty.wx.pojo.WeixinMedia;
import com.lhfeiyu.thirdparty.wx.pojo.WeixinOauth2Token;
import com.lhfeiyu.thirdparty.wx.pojo.WeixinQRCode;
import com.lhfeiyu.thirdparty.wx.pojo.WeixinUserInfo;
import com.lhfeiyu.thirdparty.wx.pojo.WeixinUserList;
...
public class AdvancedUtil {
	...
	public static WeixinUserList getUserList(String accessToken, String nextOpenId) {
		...
		if (null != jsonObject) {
			try {
				...
				weixinUserList.setOpenIdList(JSONArray.toJavaObject(dataObject.getJSONArray("openid"), ArrayList.class));
	...
	public static List<WeixinGroup> getGroups(String accessToken) {
		...
		if (null != jsonObject) {
			try {
				weixinGroupList = JSONArray.toJavaObject(jsonObject.getJSONArray("groups"), ArrayList.class);
			} catch (JSONException e) {
