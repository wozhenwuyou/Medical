...
public class PagePath {
	...
	public static final String loginPasswordReset = "/front/loginPasswordReset";//找回密码页面
	...
	public static final String doctorArticlePrivate = "/front/domain/doctor/articlePrivate";//随手记
	public static final String doctorArticlePrivateDetails = "/front/domain/doctor/articlePrivateDetails";//随手记文章详情
	...
	public static final String hospitalAnnouncement = "/front/domain/hospital/announcement";
	public static final String doctorAnnouncement = "/front/domain/doctor/announcement";
	...
	public static final String medicationRepertory = "/front/domain/hospital/medicationRepertory";//诊所药品
	public static final String addOrUpdateMedicationRepertory = "/front/domain/hospital/addOrUpdateMedicationRepertory";//诊所药品
	public static final String medicationSumList = "/front/domain/hospital/medicationSumList";//诊所药品记录
	...
	public static final String sysArticle = "/front/base/article/sysArticle";//系统文章新闻详情页
	public static final String sysArticleList = "/front/base/article/sysArticleList";//系统文章新闻详情页
	...
	public static final String addOrUpdateArticlePrivate = "/front/base/article/addOrUpdateArticlePrivate";//添加或修改文章
	...
	public static final String bespeakBloodTestDoctorChoose = "/front/domain/bespeak/bloodTestDoctorChoose";//预约-选择医院或医生-血液检测
	...
	public static final String backLink = "/back/base/sys/link";
	public static final String backAddOrUpdateLink = "/back/base/sys/addOrUpdateLink";
