...
public class Table {
	...
	public static final String diagnose_template = "diagnose_template";
	public static final String medication_log = "medication_log";
	...
	public static final String phrase_record = "phrase_record";
	public static final String regular_remind = "regular_remind";
	public static final String medication_repertory = "medication_repertory";
	...
	public static final String goods_offers = "goods_offers";
	...
	public static final String forum_article = "forum_article";
	public static final String forum_member = "forum_member";
	public static final String forum_article_collect = "forum_article_collect";
	public static final String goods = "goods";
	public static final String goods_category = "goods_category";
	public static final String goods_gallery = "goods_gallery";
	...
	public static final String sys_article = "sys_article";
	public static final String link = "link";
	
	public static final String data_hospital = "data_hospital";
	public static final String data_hospital_doctor = "data_hospital_doctor";
	public static final String data_hospital_nurse = "data_hospital_nurse";
	public static final String data_hospital_contract = "data_hospital_contract";
	public static final String data_hospital_visit = "data_hospital_visit";
