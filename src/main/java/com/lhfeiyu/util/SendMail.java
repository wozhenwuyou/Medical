...
public class SendMail {
	...
	/*public static void main(String[] args) {
		sendMailUser("smtp.hichina.com", "true", "ywwz@wonature.com", "y@123456", "ywwz@wonature.com", "airson_yu@163.com","沃诊无忧登陆账号密码重置", "您好，我们已经将您的登陆密码重置为123456<a href=\"http://www.wozhenwuyou.com/\">沃诊无忧</a>");
	}*/
	...
	public static void getMailContent(Part part) throws Exception {
		...
		if (part.isMimeType("text/plain") && !conname) {
			 ...
			 * else if (part.isMimeType("multipart/*")) { Multipart multipart =
			 * (Multipart) part.getContent(); int counts = multipart.getCount();
