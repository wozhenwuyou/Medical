...
public class PatientReport extends Parent {
	...
	private String pateintUsername;
	private String pateintRealName;
	...
	public void setDoctorResult(String doctorResult) {
		 this.doctorResult = doctorResult == null ? null : doctorResult.trim();
	}
	...
	public void setPateintUsername(String pateintUsername) {
		this.pateintUsername = pateintUsername;
	}

	public String getPateintRealName() {
		return pateintRealName;
	}

	public void setPateintRealName(String pateintRealName) {
		this.pateintRealName = pateintRealName;
	}
	...
	public Integer getPatientAge() {
		...
		if(null != patientBirthday){
			...
			birth.setTime(patientBirthday);
			patientAge = curdate.get(Calendar.YEAR) - birth.get(Calendar.YEAR);
			birth.add(Calendar.YEAR, patientAge);
	...
	public String getPateintUsername() {
		return pateintUsername;
	}
	...
	public String getPatientUserPhone() {
		return patientUserPhone;
	}

	public void setPatientUserPhone(String patientUserPhone) {
		this.patientUserPhone = patientUserPhone;
	}

	public String getAttrDateName() {
		return attrDateName;
	}

	public void setAttrDateName(String attrDateName) {
		this.attrDateName = attrDateName;
	}
