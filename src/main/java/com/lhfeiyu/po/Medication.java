...
public class Medication extends Parent {
	...
	private String producedateName;
	...
	public void setCoverWords(String coverWords) {
		 this.coverWords = coverWords == null ? null : coverWords.trim();
	}
	...
	public void setProducerTel(String producerTel) {
		 this.producerTel = producerTel == null ? null : producerTel.trim();
	}
	...
	public void setPackageWords(String packageWords) {
		 this.packageWords = packageWords == null ? null : packageWords.trim();
	}
	public String getUsageAndDosage() {
		return usageAndDosage;
	}
	public void setUsageAndDosage(String usageAndDosage) {
		 this.usageAndDosage = usageAndDosage == null ? null : usageAndDosage.trim();
	}
	...
	public String getProducedateName() {
		return producedateName;
	}

	public void setProducedateName(String producedateName) {
		this.producedateName = producedateName;
	}
