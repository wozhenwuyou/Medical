 ...
 */
public class MedicationLog extends Parent {
	...
	private Integer medicationSumCount;
	...
	public void setInOrOutTime(Date inOrOutTime) {
	...
	public Integer getMedicationSumCount() {
		return medicationSumCount;
	}

	public void setMedicationSumCount(Integer medicationSumCount) {
		this.medicationSumCount = medicationSumCount;
	}
