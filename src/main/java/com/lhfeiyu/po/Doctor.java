...
public class Doctor extends Parent {
	...
	private Integer haveFocused;
	private String hospitalAttrStr;
	...
	public void setConsultScope(String consultScope) {
		 this.consultScope = consultScope == null ? null : consultScope.trim();
	}
	...
	public void setHaveFocused(Integer haveFocused) {
		this.haveFocused = haveFocused;
	}

	public String getHospitalAttrStr() {
		return hospitalAttrStr;
	}

	public void setHospitalAttrStr(String hospitalAttrStr) {
		this.hospitalAttrStr = hospitalAttrStr;
	}
