 ...
 */
public class Prescription extends Parent {
	...
	public void setMedicationType(String medicationType) {
		 this.medicationType = medicationType == null ? null : medicationType.trim();
	}
	...
	public Integer getMedicationNum() {
		return medicationNum;
	}
	public void setMedicationNum(Integer medicationNum) {
