...
public class LoginAction {
	...
	public JSONObject checkLogin(HttpServletRequest request,HttpSession session,
		...
		try{
			...
			Result.catchError(e, logger, "LH_ERROR-Login-AJAX-/checkLogin-用户登陆出现异常"+loginType, json);
		}
	...
	public JSONObject doLogin(HttpServletRequest request,HttpSession session,
		...
		try{
			...
			//TODO FIXME 快捷登陆，方便测试 ======================================
			/*if("1".equals(verificationCode)){//1:方便测试，后期删除
				//登陆成功
