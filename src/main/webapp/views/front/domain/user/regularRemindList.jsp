...
<body>
					...
					<div>
						<div class="t_851_4">
							...
							<button class="fr btn btn-success"
								onclick="location.href='/addOrUpdateRegularRemind'">添加定期提醒</button>
							<button class="fr btn btn-success" onclick="allRemind()"
								style="margin: 0px 3px;">所有提醒</button>
	...
	<script type="text/javascript"
		src="/js/front/domain/user/regularRemindList.js" title="v"></script>
