				...
				<table cellpadding="0" cellspacing="0" border="0"
					...
					<tr height="40">
						...
						<td width="340"><input type="text" id="username"
							readonly="readonly" class="l_270" value="${bespeak.patientName}" /></td>
					</tr>
					<tr height="52">
						<td width="85">患者性别：</td>
					...
					<tr height="40">
						...
						<td width="340"><input type="text" id="phone"
							readonly="readonly" class="l_270" value="${bespeak.patientPhone}" /></td>
					</tr>
					<c:if test="${bespeak.typeId == 2}">
						...
						<tr height="52">
							...
							<td width="340"><input type="text" id="isRegisterAgent"
								readonly="readonly" class="l_270"
								value="${bespeak.isRegisterAgent}" /></td>
						</tr>
					</c:if>
					...
					<tr height="40">
						<td width="85">预约时间：</td>
						<td width="340"><input class="l_270" readonly="readonly"
					...
					<tr height="133" valign="bottom">
						...
						<td width="340"><textarea class="input18" readonly="readonly"
								id="baseCondition">${bespeak.baseCondition}</textarea></td>
					</tr>
