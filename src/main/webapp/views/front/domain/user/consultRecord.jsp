...
<body>
	...
	<script type="text/javascript"
		src="/js/front/domain/user/consultRecord.js" title="v"></script>
	<script id="template" type="x-tmpl-mustache">
		<tr height="53" align="center" style="font-size:14px; color:#63a13f">
			<td width="200">咨询诊所</td>
        	<td width="100">咨询医生</td>
            <td width="200">咨询标题</td>
		...
		{{#rows}}
			<tr height="53" align="center" style="font-size:14px; color:#63a13f">
			<td width="200">{{hospitalName}}</td>
        	<td width="100">{{doctorUsername}}</td>
            <td width="200">{{title}}</td>
            <td width="120">{{&createDate}}</td>
            <td width="80">
				{{#replyContent}}已回复{{/replyContent}}
				{{^replyContent}}未回复{{/replyContent}}
			</td>
			<td width="15">&nbsp;</td>
		        <td width="100">
