...
<body>
		...
		<div class="w_1000">
			...
			<div class="w_851" style="padding-top: 0;">
				...
				<div class="text_box1">
					...
					<div class="text_773">
						<font>姓名：</font>${user.username}<br /> <font>标题：</font>
						<c:if test="${!empty diagnose}">
	                		本人于${diagnose.diagnoseTime}在${diagnose.hospitalName}就诊<br />
						</c:if>
						<span id="hidden_div" style="display: none"> <font>病情描述：</font>${diagnose.baseCondition}
						</span>
					</div>
					<div class="cxq">
				...
				<div class="text_box1">
					...
					<div class="text_773">
						<font>诊断科室：</font>${diagnose.departmentName}<br /> <font>诊断日期：</font>${diagnose.diagnoseTime}<br />
						<font>过敏历史：</font>${diagnose.allergyHistory}<br /> <font>基本病情：</font>${diagnose.baseCondition}<br />
						<font>诊断结果：</font><span id="diagnoseTags"></span><br /> <font>诊断处方：</font><span
							id="prescription"></span>
					</div>
				</div>
			</div>
		</div>
	...
	<script type="text/javascript" src="/js/front/domain/user/user.js"
		title="v"></script>
</body>
</html>
