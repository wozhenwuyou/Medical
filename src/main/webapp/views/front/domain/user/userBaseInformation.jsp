...
<body>
	...
	<div class="pz_main">
		<div class="w_1000">
			<div class="c_1100_10">
				当前位置：<a href="/">首页</a> - <a href="/userBaseInformation">基本信息</a>
			</div>
			...
			<div class="w_824" style="padding-top: 0;">
				<div class="c_824"
					...
					<div class="t_851_4 pointer" id="remindNewMsg"
						style="display: none; color: red; background: url(/images/front/main28.jpg) no-repeat 0 center;">
						&nbsp; 您有<u id="remindCount">0</u>个新的定期提醒
					</div>
					<div class="t_851_4">
						用户基本信息
					...
					<input type="hidden" id="userId" value="${user.id}" /> <input
						type="hidden" id="cityId" value="${user.city}">
					<table cellpadding="0" cellspacing="0" border="0" width="773"
						...
						<tr height="40" valign="bottom">
							...
							<td width="67" style="line-height: 30px;"><span
								style="color: red;">*</span>身份证号码</td>
							<td width="329"><input type="text" class="input14"
								id="idcardNum" readonly="readonly" value="${user.idcardNum}" /></td>
						</tr>
							...
							<td width="329"><select class="input8" id="job"
								style="width: 268px;">
									<c:forEach var="job" items="${jobList}">
										<option value="${job.id}"
											<c:if test="${job.id == user.jobId}">selected="selected"</c:if>>${job.codeName}</option>
									</c:forEach>
							</select></td>
						...
						<tr height="40" valign="bottom">
							...
							<td width="67" style="line-height: 30px;"><span
								style="color: red;">*</span>出生日期</td>
							<td width="329"><input id="datetimepicker"
								onchange="freshAge();" class="input14" type="text"
								value="<fmt:formatDate value="${user.birthday}" pattern="yyyy-MM-dd"/>">
							<td width="67" style="line-height: 30px;">年龄</td>
							<td width="329"><input type="number" class="input14"
								id="age" value="${user.age}" readonly="readonly" /></td>
						</tr>
								...
								id="province" onChange="provinceChange()" style="width: 268px;">
									<c:forEach var="province" items="${provinceCityAreaList}">
										<option value="${province.id}"
											<c:if test="${province.id == user.province}">selected="selected"</c:if>>${province.areaName}</option>
									</c:forEach>
							</select></td>
							<td width="88" style="color: #333333; line-height: 33px;"><span
						...
						<tr height="40" valign="bottom">
							<td width="67" style="line-height: 30px;" valign="middle"><span
								style="color: red;">*</span>用户头像</td>
							<td style="top: 10px;" valign="middle">
								<div style="display: inline-block; float: left;">
									<img class="picurl" id="userAvatar" src="${user.avatar}"
										style="height: 60px; max-width: 100px; overflow: hidden; padding: 5px;" />
									<input type="hidden" name="filePaths" id="filePaths"
										value="${user.avatar}" /> <input type="hidden"
						...
						<tr height="92" valign="bottom">
							...
							<td colspan="3" width="706" style="text-align: center;">
								<button style="margin-right: 80px;" type="button"
									onclick="upDatePatientInformation();" class="btn btn-success">保存</button>
								<button style="margin-right: 80px;" type="button"
					...
					<table cellpadding="0" cellspacing="0" border="0" width="773"
						...
						<tr height="92" valign="bottom">
							...
							<td colspan="3" width="706" style="text-align: center;">
								<button style="margin-right: 80px;" type="button"
									onclick="upDateUserPassword();" class="btn btn-success">保存</button>
								<button style="margin-right: 80px;" type="button"
	...
	<script type="text/javascript"
		src="/js/front/domain/user/userBaseInformation.js" title="v"></script>
</body>
</html>
