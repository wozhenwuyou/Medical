...
<body>
	...
	<div class="pz_main">
		<div class="w_1000">
			...
			<div class="w_851" style="padding-top: 0;">
				...
				<input type="hidden" id="regularRemindId"
					value="${regularRemind.id}">
				<table cellpadding="0" cellspacing="0" border="0" width="773">
					<tr height="40" valign="bottom">
					</tr>
					<tr height="40" valign="bottom">
						<td width="67" style="line-height: 30px;">提醒标题</td>
						<td width="329"><input type="text" class="input14" id="title"
							value="${regularRemind.title}" /></td>
						<td width="67" style="line-height: 30px;">提醒时间</td>
						<td width="329"><input type="text" class="input14"
							id="remindTime"
							value='<fmt:formatDate value="${regularRemind.remindTime}" pattern="YYYY-MM-dd HH:mm:ss"/>' /></td>
					</tr>
					<tr height="40" valign="bottom">
					</tr>
					<tr height="40" valign="bottom">
						<td width="67" style="line-height: 50px;" valign="top">提醒内容</td>
						<td colspan="3" width="706"><textarea class="text_input"
								id="content">${regularRemind.content}</textarea></td>
					</tr>
					<tr height="92" valign="bottom">
						<td width="67">&nbsp;</td>
						<td colspan="3" width="706" style="text-align: center;">
							<button style="margin-right: 80px;" type="button"
								onclick="addOrUpdateRegularRemind();" class="btn btn-success">保存</button>
							<button style="margin-right: 80px;" type="button"
	...
	<script type="text/javascript"
		src="/js/front/domain/user/addOrUpdateRegularRemind.js" title="v"></script>
</body>
</html>
