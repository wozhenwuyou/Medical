...
<body>
				...
				<div class="c_851">
					...
					<div class="d_851_form">
						...
						<div class="text1">
							<div class="edit">
								<script id="editor" type="text/plain"
									style="width: 810px; height: 435px;"></script>
							</div>
							<div class="form">
						...
						<div class="Submit" style="padding-left: 220px;">
							<input type="submit" class="input9"
								onclick="addOrUpdateAnnouncement();" value="提交 " /> <input
								type="submit" value="取消" class="input9" style="margin-left: 5px"
								onclick="lh.back();" />
	...
	<script type="text/javascript"
		src="/js/front/domain/hospital/addOrUpdateAnnouncement.js" title="v"></script>
</body>
</html>
