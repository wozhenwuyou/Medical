...
<body>
								...
								<td colspan="3" width="706">
									<div class="play_down">
										<c:forEach items="${diagnoseTagList}" var="tag">
											<span>${tag.tagName}<!-- <a href="javascript:" class="pf_6"><img src="/images/front/er2.png" width="6" height="6"/> -->
												</a></span>
										</c:forEach>
									</div>
								</td>
	...
	<script type="text/javascript"
		src="/js/front/domain/hospital/diagnoseRead.js" title="v"></script>
</body>
</html>
