...
<body>
					...
					<div class="l_849">
						<table cellpadding="0" cellspacing="0" border="0" width="773">
							...
							<tr height="50" valign="bottom">
								...
								<td width="329" style="line-height: 30px;"><input
							...
							<tr height="40" valign="bottom">
								...
								<td colspan="3" width="706"><input type="text"
									class="input16" /></td>
							</tr>
							...
							<tr height="40" valign="bottom">
								...
								<td colspan="3" width="706"
									style="position: relative; z-index: 1111;"><input
									type="text" class="input14" /> <a class="sub_but"
									href="javascript:;" onclick="$('#box1').fadeIn(0)">添加诊断</a>
									<div class="pf_268">
										<ul>
											<li></li>
										</ul>
							...
							<tr id="box1" style="display: none;">
								...
								<td colspan="3" width="706">
									<div class="play_down">
										<span>无果 <a href="javascript:;" class="pf_6"><img
												src="/images/front/er2.png" width="6" height="6" /></a></span> <span>无解
											<a href="javascript:;" class="pf_6"><img
							...
							<tr height="40" valign="bottom" id="bo_b6">
								...
								<td colspan="3" width="706"><input type="text"
									class="input14" /> <a class="sub_but" href="javascript:;"
									onclick="$('#box2').fadeIn(0)">添加诊断</a></td>
							</tr>
								...
								<td colspan="3" width="706">
									<div class="prescription">
										...
										<div class="t_706">
											...
											<input type="text" class="pre_text" />
											<div class="l_60">药物名称：</div>
											<input type="text" class="pre_text" /> <input type="submit"
												class="pre_sub" value="保存" /> <a href="javascript:;"
												onclick="$('#box2').fadeOut() ,$('#bo_b6').fadeIn(0)"
												class="cancel">取消</a>
										</div>
										<div class="add">
											<a href="javascript:;"><img src="/images/front/er4.jpg"
												width="15" height="15" /> &nbsp;增加一条</a>
										</div>
									</div>
								</td>
							</tr>
							<tr height="92" valign="bottom">
								...
								<td colspan="3" width="706"><input type="submit"
									...
									<input type="submit" class="sub_fil" value="导出" /> <a
									href="javascript:;" class="cancel"
									style="font-size: 14px; color: #333333; line-height: 41px;">取消</a>
								</td>
							</tr>
						</table>
					</div>
	...
	<script type="text/javascript"
		src="/js/front/domain/doctor/diagnose.js" title="v"></script>
</body>
</html>
