...
<body>
				...
				<div class="c_824" style="background-color: #FFFFFF;">
					<div class="t_851_2">
						...
						<button class="fr btn btn-success"
							onclick="location.href='/addOrUpdateArticlePage'">添加文章 +</button>
					</div>
					<div class="t_851_3">
						<table cellpadding="0" cellspacing="0" border="0">
							<tr height="44" valign="middle">
								<td width="46">栏目：</td>
								<td width="118"><select class="text_input1" id="typeId"><option
											value="0">请选择</option>
	...
	<script type="text/javascript"
		src="/js/front/domain/doctor/information.js" title="v"></script>
	<script id="template" type="x-tmpl-mustache">
		...
		{{#rows}}
			<tr height="58" align="center" style="color:#666666">
				<td width="95" class="pointer">{{typeName}}</td>
	    		<td width="200" class="pointer">
					<a href="/doctorArticleDetails/{{id}}" target="_blank">{{title}}</a>
				</td>
				...
				<td width="120">
					...
					<button class="btn btn-info" onclick="lh.jumpToUrl('/addOrUpdateArticlePage?articleId={{id}}');">修改</button>					
					<button class="btn btn-success" onclick="lh.open('/doctorArticleDetails/{{id}}');">查看</button>
				</td>
	    	</tr>
		{{/rows}}
	</script>
