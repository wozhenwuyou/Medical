...
<body>
						...
						<table cellpadding="0" cellspacing="0" border="0" width="773">
							<tr height="50" valign="bottom">
								<td width="67" style="line-height: 30px;"><span
									style="color: red; font-weight: bolder;">*</span>患者昵称</td>
							...
							<tr height="40" valign="bottom">
								...
								<td width="329"><input type="text" class="input14"
									id="idcardNum" value="${user.idcardNum}" /></td>
							</tr>
							<tr height="40" valign="bottom">
							...
							<tr height="92" valign="bottom">
								<td width="67">&nbsp;</td>
								<td colspan="3" width="706"><c:if test="${opt != 'read'}">
										<input type="submit" class="sub_fil hover" value="完成"
											style="margin-left: 165px;" onclick="addOrUpdatePatient()" />
										<input type="submit" class="sub_fil hover" value="返回"
											style="margin-left: 165px;" onclick="lh.back();" />
									</c:if> <c:if test="${opt == 'read'}">
	...
	<script type="text/javascript"
		src="/js/front/domain/doctor/addOrUpdatePatient.js" title="v"></script>
	<c:if test="${opt == 'read'}">
		<script>lh.disableDiv = true;</script>
	</c:if>
</body>
</html>
