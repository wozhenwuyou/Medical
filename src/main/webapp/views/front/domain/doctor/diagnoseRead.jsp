...
<body>
						...
						<table cellpadding="0" cellspacing="0" border="0" width="773">
							<tr height="54" valign="bottom">
								<td width="773" colspan="4"
									style="border-bottom: 1px solid #f2f2f2; line-height: 36px; font-size: 14px; color: #333333"><strong>患者信息</strong></td>
							</tr>
							<tr height="50" valign="bottom">
								<td width="67" style="line-height: 30px;">患者姓名</td>
								<td width="310"><input type="text" class="input14"
									readonly="readonly" value="${diagnose.patientName}" /></td>
								<td width="67" style="line-height: 30px;">性 别</td>
								<td width="310"><input type="text" class="input14"
									readonly="readonly" value="${diagnose.patientSexName}" /></td>
							</tr>
							<tr height="40" valign="bottom">
								<td width="67" style="line-height: 30px;">年 龄</td>
								<td width="310"><input type="text" class="input14"
									readonly="readonly" value="${diagnose.patientAge}" /></td>
								<td width="67" style="line-height: 30px;">出生日期</td>
								<td width="329"><input type="text" class="input14"
									readonly="readonly" value="${diagnose.patientBirthday}" /></td>
								<%--  <td width="67" style="line-height:30px;">出生日期</td>
	                            <td width="329"><input value="<fmt:formatDate value="${diagnose.attrDate}" pattern="yyyy-MM-dd"/>" type="text" class="input14" readonly="readonly"  /></td> --%>
							</tr>
							<tr height="40" valign="bottom">
								<td width="67" style="line-height: 30px;">身份证号</td>
								<td width="310"><input type="text" class="input14"
									readonly="readonly" value="${diagnose.patientIdcardNum}" /></td>
								<td width="67" style="line-height: 30px;">电话号码</td>
								<td width="329"><input type="text" class="input14"
									readonly="readonly" value="${diagnose.patientPhone}" /></td>
							</tr>
							<tr height="40" valign="bottom">
								<td width="67" style="line-height: 30px;">职 业</td>
								<td width="329"><input type="text" class="input14"
									readonly="readonly" value="${diagnose.patientJob}" /></td>
								<td width="67">&nbsp;</td>
								<td width="329">&nbsp;</td>
							</tr>
							<tr height="54" valign="bottom">
							...
							<tr height="50" valign="bottom">
								...
								<td width="310"><input type="text" class="input14"
									readonly="readonly" value="${diagnose.departmentName}" /></td>
								<td width="67" style="line-height: 30px;">就诊日期</td>
								<td width="329"><input type="text" class="input14"
									readonly="readonly" value="${diagnose.diagnoseTime}" /></td>
							</tr>
							<tr height="40" valign="bottom">
								<td width="67" style="line-height: 30px;">过敏历史</td>
								<td colspan="3" width="706"><input style="width: 662px;"
									type="text" class="input16" readonly="readonly"
									value="${diagnose.allergyHistory}" /></td>
							</tr>
							<tr height="93" valign="bottom">
								...
								<td colspan="3" width="706"><textarea style="width: 662px;"
										class="text_input" readonly="readonly">${diagnose.baseCondition}</textarea></td>
							</tr>
							<!-- <tr height="40" valign="bottom">
									...
									<div class="prescription">
										<div class="t_706" style="height: auto;">
											<c:forEach items="${prescriptionList}" var="pres">
												...
												<input type="text" class="pre_text" readonly="readonly"
													value="${pres.medicalType}" />
												<div class="l_60">药物名称：</div>
												<input type="text" class="pre_text" readonly="readonly"
													value="${pres.medicalName}" />
												<div class="l_60">药物数量：</div>
												<input type="text" class="pre_text" readonly="readonly"
													value="${pres.medicalNum}" />
												<br />
												<br />
											</c:forEach>
										</div>
							...
							<%-- <tr height="92" valign="bottom">
								<td colspan="4" width="706" style="text-align: center; padding-right: 60px;">
									<c:if test="${empty diagnose.medicalTotalPrice}">
										价格合计： 0 元
									</c:if>
									<c:if test="${!empty diagnose.medicalTotalPrice}">
										价格合计： ${diagnose.medicalTotalPrice} 元
									</c:if>
								</td>
							</tr> --%>

							<c:if test="${empty hideTotalPrice}">
								<tr height="92" valign="bottom">
									<td colspan="4" width="706"
										style="text-align: center; padding-right: 60px;"><span
										style="color: black;">价格合计： <input id="totalPrice"
											type="number" value="${diagnose.medicalTotalPrice}"
											readonly="readonly"
											style="border: none; width: 80px; text-align: center; line-height: 20px;">
									</span> 元</td>
								</tr>
							</c:if>
	...
	<script type="text/javascript"
		src="/js/front/domain/doctor/diagnoseRead.js" title="v"></script>
</body>
</html>
