...
<body>
	...
	<script type="text/javascript"
		src="/js/front/domain/doctor/diagnoseApply.js" title="v"></script>
	<script id="template" type="x-tmpl-mustache">
		...
		{{#rows}}
			<tr height="53" align="center" style="color:#666666">
		        ...
		        <td width="15">&nbsp;</td>
				<td width="15">
					<button type="button" onclick="lh.jumpToUrl('/diagnoseRead/{{diagnoseId}}');" class="btn btn-info">查看病历</button>
					<button type="button" onclick="disAgree({{id}});" class="btn btn-danger">拒绝</button>
