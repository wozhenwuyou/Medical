...
<body>
		...
		<div class="w_1000">
			...
			<div class="w_851">
				<div class="c_851">
					<div class="t_851_2">
						病历夹
						<button class="fr pointer btn btn-success"
							onclick="javascript:location.href='/treatment'">开始就诊</button>
					</div>
					<div class="t_851_3">
	...
	<script type="text/javascript"
		src="/js/front/domain/doctor/diagnoseList.js" title="v"></script>
	...
	<script id="template" type="x-tmpl-mustache"><!-- -->
		...
		<tr height="58" align="center" style="color:#666666">
	        ...
	        <td width="15">&nbsp;</td>
	        <td width="180">
				<button type="button" onclick="window.open('/diagnosePrint/{{id}}');"" class="btn btn-info">打印</button>
				{{#isOwner}}
