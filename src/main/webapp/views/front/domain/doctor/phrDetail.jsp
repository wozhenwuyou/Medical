...
<body>
						...
						<table cellpadding="0" cellspacing="0" border="0" width="773">
							...
							<tr height="40" valign="bottom">
								...
								<td width="67" style="line-height: 30px;">遗传病史</td>
									<td width="329">
										<input type="text" name="ycbs" class="input14" value="${phrBasicInfo.ycbs }" placeholder="多个用，号分割，默认为无" />
									</td>
							</tr>
							<tr height="40" valign="bottom">
							...
							<tr height="92" valign="bottom">
								...
								<td colspan="2" width="706">
									<button style="margin-left: 240px;"
										class="sub_fil" onclick="javascript:lh.back();">返回</button>
							</tr>
						</table>
					</div>
				</div>
	...
	<script type="text/javascript"
		src="/js/front/domain/doctor/phrDetail.js" title="v"></script>
</body>
</html>
