...
<body>
			...
			<div class="w_851">
				<div class="t_851_2">
					...
					<button class="fr btn btn-success"
						onclick="location.href='/patientAddOrUpdate'">添加患者 +</button>
				</div>
				<div class="t_851_3">
					<table cellpadding="0" cellspacing="0" border="0">
						<tr height="44" valign="middle">
							...
							<td width="118"><select class="text_input1" id="province">
									...
									<c:forEach items="${provinceCityAreaList}"
	...
	<script id="template" type="x-tmpl-mustache">
		...
		{{#rows}}
			...
			{{^canUpdate}}
		        <td width="184">
					<button type="button" onclick="editPatient({{id}}, 'read');" class="btn btn-info">查看</button>
		        </td>
			{{/canUpdate}}
        </tr>
		{{/rows}}
