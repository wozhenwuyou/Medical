...
<body>
					...
					<div class="l_849">
						<table cellpadding="0" cellspacing="0" border="0" width="773">
							<tr height="40" valign="bottom">
								...
								<td colspan="3" width="706"><c:if test="${empty dt}">
										<input style="width: 695px; border: none;" type="text"
											class="input16" readonly="readonly"
											value="${doctor.realname}" />
									</c:if> <c:if test="${!empty dt}">
										<input style="width: 695px; border: none;" type="text"
											class="input16" readonly="readonly" value="${dt.createdBy}" />
									</c:if></td>
							</tr>
							<tr height="40" valign="bottom">
							...
							<tr height="93" valign="bottom">
								...
								<td colspan="3" width="706"><textarea style="width: 695px;"
										class="text_input" id="baseCondition">${dt.baseCondition}</textarea></td>
							</tr>
							<tr height="40" valign="bottom">
							...
							<tr height="92" valign="bottom">
								...
								<td colspan="3" width="706" style="text-align: center;">
									<button style="margin-right: 80px;" type="button"
										onclick="saveDiagnoseTemplate(${dt.id});" class="btn btn-info">保存</button>
									<button style="margin-right: 80px;" type="button"
	...
	<script type="text/javascript"
		src="/js/front/domain/doctor/diagnoseTemplate.js" title="v"></script>
	<script type="text/javascript"
	...
	<script id="template" type="x-tmpl-mustache"><!---->
		<div id="presItem_{{serial}}" class="presItem" style="height:35px;">
			...
			<a class="sub_but" href="javascript:;" onclick="$('#box2').fadeIn(0);removePrescription('{{serial}}');">移除</a>
         </div>
	</script>
