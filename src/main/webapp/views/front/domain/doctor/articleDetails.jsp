							...
							<table width="784" border="0" cellspacing="0" cellpadding="0">
								...
								<tr>
									<td width="784"><input type="image"
										src="/images/front/new_img3.jpg" onclick="addComment()" /> <!-- <button class="btn btn-success fr" onclick="lh.back();"> 返 回 </button> -->
									</td>
								</tr>
							</table>
						</div>
								...
								<ul>
									<c:forEach items="${commengList}" var="comment">
										<li>
											...
											<div class="r_616">
												<div class="titnewn">
													<a href="javascript:;">${comment.createdBy}</a><span><fmt:formatDate
