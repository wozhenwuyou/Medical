...
<body>
						...
						<table cellpadding="0" cellspacing="0" border="0" width="773">
							<tr height="54" valign="bottom">
								<td width="773" colspan="4"
									...
									<strong>患者信息</strong> <span id="searchNoneTip"
									style="margin-left: 10px; color: orange; display: none;">该身份证号和电话号码没有对应的患者，请补全患者信息</span>
									<span id="searchSuccessTip"
									style="margin-left: 10px; color: green; display: none;">已经自动填充患者信息</span>
								</td>
							</tr>
							<tr height="40" valign="bottom">
								<td width="67" style="line-height: 30px;"><span
									style="color: red;">*</span>条形码</td>
								<!-- H14037000558,H14037000559,H14037000560,H14037000651,H14037000652,H14037000676,H14037000677,H14037000678,H14037000679 -->
								<td width="310"><input type="text" class="input14"
									id="adiconBarcode" /></td>
								<td width="67" style="line-height: 30px;"><span
									style="color: red;">*</span>身份证号</td>
								<td width="310"><input type="text" class="input14"
									id="idcardNum" onblur="searchPatient();" /></td>
							</tr>
							<tr height="50" valign="bottom">
								<td width="67" style="line-height: 30px;"><span
									style="color: red;">*</span>患者姓名</td>
								<td width="310"><input type="text" class="input14"
									id="username" /></td>
							...
							<tr height="54" valign="bottom">
								<td width="773" colspan="4"
									style="border-bottom: 1px solid #f2f2f2; line-height: 36px; font-size: 14px; color: #333333"><strong><span
										style="color: red;">*</span>血液检测项</strong></td>
							</tr>
							<tr height="54" valign="bottom">
								<td id="cancerListTd" width="773" colspan="4"
									style="border-bottom: 1px solid #f2f2f2; line-height: 36px; font-size: 14px; color: #333333">
									<c:forEach var="cancer" items="${cancerList}" begin="0">
										<div
											style="margin: 0 5px; display: inline-block;; width: 170px;">
											<input type="checkbox" name="cancer" id="cancer_${cancer.id}"
												onclick="selected(${cancer.id})" value="${cancer.code}" />${cancer.name}
										</div>
									</c:forEach>
								</td>
							</tr>
							<tr height="92" valign="bottom">
								...
								<td colspan="3" width="706">
									...
									<button onclick="savePatientReport();" type="button"
	...
	<script type="text/javascript"
		src="/js/front/domain/doctor/doctorBloodTest.js" title="v"></script>
</body>
</html>
