...
<body>
	...
	<div class="pz_main">
		<div class="w_1000">
			<div class="c_1100_10">
				当前位置：<a href="/">首页</a> - <a href="">我的中心</a>
			</div>
			...
			<div class="w_851" style="padding-top: 0;">
				...
				<div class="text_box1">
					...
					<div class="text_773">
						<font>姓名：</font>${user.username}<br /> <font>标题：</font>本人于3月20日在某某医院就诊<br />
						<font>疾病：</font>肺结核<br /> <span id="hidden_div"
							style="display: none"> <font>病情描述：</font>本人于3月20日在某某医院就诊，医生给我的结论是某某疾病，患病时间大概是20天左右，每天都有眩晕的感觉，头痛
							希望从医生那得到的帮助：希望医生能给我一些建议，长期的头痛困扰着我，工作和生活都收到了影响
						</span>
					</div>
					<div class="cxq">
						<a href="javascript:;"><span id="_strSpan">展开详情＞</span></a>
					</div>
				</div>
				<div class="text_box1">
					<div class="tit_773_1" style="margin-top: 5px;">诊断情况</div>
					<div class="text_773">
						<font>诊断科室：</font>内科<br /> <font>诊断日期：</font>2016年3月18日<br /> <font>过敏历史：</font>三年前有过青霉素过敏的情况<br />
						...
						好？手术中大夫曾说"无法刮干净"。<br /> <font>诊断结果：</font>粘液腺癌<br /> <font>诊断处方：</font>如果可以选择静脉注射化疗药物+腹腔灌注化疗药物比较好。没有检查到癌细胞，不代表不存在。
					</div>
				</div>
			</div>
		</div>
	...
	<script type="text/javascript" src="/js/front/base/user/user.js"
		title="v"></script>
</body>
</html>
