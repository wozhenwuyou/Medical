...
<body>
									...
									<td>
										<div style="display: inline-block; float: left;">
											...
											<input type="hidden" name="filePaths" id="filePaths"
												value="${pic.picPath}" /> <input type="hidden"
						...
						<div class="text1">
							<div class="edit">
								<script id="editor" type="text/plain"
									style="width: 810px; height: 400px;"></script>
							</div>
							<div class="form">
	                            ...
	                            <tr height="43" valign="middle">
									...
									<tr height="48" valign="bottom">
										<td width="74" style="color: #333333; line-height: 33px;">栏目：</td>
										<td colspan="5" width="699"><select class="input8"
											id="typeId">
	...
	<script type="text/javascript"
		src="/js/front/base/article/addOrUpdateArticle.js" title="v"></script>
</body>
</html>
