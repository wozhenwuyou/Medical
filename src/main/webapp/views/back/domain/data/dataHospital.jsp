...
<body style="min-width: 1000px;">
		...
		<tbody>
			<tr class="tr_ht" align="right">
				<td class="td_pad"><span>诊所名称：</span><input role="textbox"
					id="sc_wholeName" class="domain-input easyui-textbox width100" /></td>
				<td class="td_pad"><span>联系电话：</span><input role="textbox"
					id="sc_phone" class="domain-input easyui-textbox width100" /></td>
				<td class="td_pad"><span>创建日期从：</span><input role="datebox"
					id="sc_createdAtFrom" class="domain-input easyui-datebox width100"
					data-options="editable:false" /></td>
				<td class="td_pad"><span>至：</span><input role="datebox"
					id="sc_createdAtTo" class="domain-input easyui-datebox width100"
					data-options="editable:false" /></td>
			...
			<tr class="tr_ht" align="right">
				<td class="td_pad"><span>走访日期从：</span><input role="datebox"
					id="sc_visitDateFrom" class="domain-input easyui-datebox width100"
					data-options="editable:false" /></td>
				<td class="td_pad"><span>至：</span><input role="datebox"
					id="sc_visitDateTo" class="domain-input easyui-datebox width100"
					data-options="editable:false" /></td>
				<c:if test="${empty notAdmin}">
					<td class="td_pad"><span>创建人：</span><input role="combobox"
						id="sc_adminId" class="domain-input easyui-combobox width100"
						data-options="editable:false" /></td>
				</c:if>
			</tr>
		</tbody>
	...
	<div id="opt_outer_div">
		<div class="fl_opt_div">
			...
			<button onclick="exportDataHospital()"
				class="button button-primary button-rounded button-small">导出诊所数据</button>
					...
					<tbody>
						<tr class="tr_ht" align="right">
							<td class="td_pad"><span><span
									style="color: red; font-weight: bolder;">*</span>名称：</span><input
								role="textbox" id="f_wholeName"
								class="domain-input easyui-textbox width180"
								data-options="required:true" /></td>
							<td class="td_pad"><span><span
									style="color: red; font-weight: bolder;">*</span>类型：</span><input
								role="combobox" id="f_typeId"
								class="domain-input easyui-combobox width180"
								data-options="required:true" /></td>
							<td class="td_pad"><span><span
						...
						<tr class="tr_ht" align="right">
							<td class="td_pad"><span><span
									style="color: red; font-weight: bolder;">*</span>电话：</span><input
							...
							<td class="td_pad"><span><span style="color: red">*</span>市(县)：</span><input
								...
								class="domain-input easyui-combobox width180"
								data-options="required:true" /></td>
							<!-- <td class="td_pad"><span>微信：</span><input role="textbox" id="f_weixin" class="domain-input easyui-textbox width180"/></td> -->
							<!-- <td class="td_pad"><span><span style="color:red;font-weight:bolder;">*</span>状态：</span><input role="combobox" id="f_mainStatus" class="domain-input easyui-combobox width180"/></td> -->
						</tr>
					</tbody>
				</table>
			</form>
	...
	<script type="text/javascript" src="/js/common/back_template.js"
		title="v"></script>
	<script type="text/javascript"
		src="/js/back/domain/data/dataHospital.js" title="v"></script>
</body>
</html>