...
<body style="min-width: 1000px;">
	...
	<table id="mainQueryTable" style="min-width: 1000px;">
		<tbody>
			<tr class="tr_ht" align="right">
				<td class="td_pad"><span>护士昵称：</span><input role="textbox"
	...
	<div id="opt_outer_div">
		<div class="fl_opt_div">
			...
			<button onclick="exportNurse()"
				class="button button-primary button-rounded button-small">导出护士信息</button>
	...
	<div id="mainObjWindiv" style="display: none;">
		<div id='mainObjWin' class="easyui-window" title="护士信息"
			style="width: 720px;"
				...
				<table id="mainObjTable" class="padL5">
					<tbody>
						<tr class="tr_ht" align="right">
							...
							<td class="td_pad"><span><span
									style="color: red; font-weight: bolder;">*</span>护士昵称：</span><input
	...
	<script type="text/javascript" src="/js/back/domain/hospital/nurse.js"
		title="v"></script>
</body>
</html>