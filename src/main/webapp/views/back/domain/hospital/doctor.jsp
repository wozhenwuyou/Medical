...
<body style="">
		...
		<tbody>
			<tr class="tr_ht" align="right">
				<td class="td_pad"><span>用户名：</span><input role="textbox"
					id="sc_username" class="domain-input easyui-textbox width140" /></td>
				<td class="td_pad"><span>地址：</span><input role="textbox"
					id="sc_address" class="domain-input easyui-textbox width140" /></td>
				<td class="td_pad"><span>手机号码：</span><input role="textbox"
					id="sc_phone" class="domain-input easyui-textbox width140" /></td>
				<td class="td_pad"><span>邮箱：</span><input role="textbox"
					id="sc_email" class="domain-input easyui-textbox width140" /></td>
			...
			<tr class="tr_ht" align="right">
				<td class="td_pad"><span>qq：</span><input role="textbox"
					id="sc_qq" class="domain-input easyui-textbox width140" /></td>
				<td class="td_pad"><span>微信：</span><input role="textbox"
					id="sc_weixin" class="domain-input easyui-textbox width140" /></td>
				<td class="td_pad"><span>微博：</span><input role="textbox"
					id="sc_weibo" class="domain-input easyui-textbox width140" /></td>
			...
			<tr class="tr_ht" align="right">
				...
				<td class="td_pad"><span>所属诊所：</span><input role="combobox"
					id="sc_hospitalId" class="domain-input easyui-combobox width140" /></td>
				<td class="td_pad"><span>所属科室：</span><input role="combobox"
					id="sc_departmentId" class="domain-input easyui-combobox width140" /></td>
	...
	<div id="opt_outer_div">
		<div class="fl_opt_div">
			...
			<button onclick="resetPassword()"
				class="button button-primary button-rounded button-small">重置密码</button>
			<button onclick="exportDoctor()"
				class="button button-primary button-rounded button-small">导出医生信息</button>
	...
	<!-- 表格  开始 -->
	<div id='datagrid_div' style="margin-bottom: 20px;">
		<table id="datagrid"></table>
	</div>
	<!-- 表格  结束 -->

	<div id="mainObjWindiv" style="display: none;">
		<div id='mainObjWin' class="easyui-window" title="医生信息"
			style="width: 800px;"
			data-options="top:80,left:190,modal:true,closed:true,maximizable:false,collapsible:false,minimizable:false">
					...
					<tbody>
						<tr class="tr_ht" align="right">
							<td class="td_pad"><span><span
									style="color: red; font-weight: bolder;">*</span>所属诊所：</span><input
								role="textbox" id="f_hospitalId"
								class="domain-input easyui-textbox width100"
								data-options="required:true" /></td>
							<td class="td_pad"><span><span
									style="color: red; font-weight: bolder;">*</span>所属科室：</span><input
								role="textbox" id="f_departmentId"
								class="domain-input easyui-textbox width100"
								data-options="required:true" /></td>
							<td class="td_pad"><span><span
									style="color: red; font-weight: bolder;">*</span>用户名：</span><input
								role="textbox" id="f_username"
								class="domain-input easyui-textbox width100"
								data-options="required:true" /></td>
							<td class="td_pad"><span><span
									style="color: red; font-weight: bolder;">*</span>真实姓名：</span><input
								role="textbox" id="f_realname"
								class="domain-input easyui-textbox width100"
								data-options="required:true" /></td>
						</tr>
						<tr class="tr_ht" align="right">
							<td class="td_pad"><span><span
								...
								role="textbox" id="f_idCard"
								class="domain-input easyui-textbox width100"
								data-options="required:true" /></td>
							<td class="td_pad"><span><span
									style="color: red; font-weight: bolder;">*</span>性别：</span><input
								role="combobox" id="f_sex"
								class="domain-input easyui-combobox width100"
								data-options="required:true" /></td>
							<td class="td_pad"><span><span
									style="color: red; font-weight: bolder;">*</span>省(直辖市)：</span><input
								role="combobox" id="f_province"
								class="domain-input easyui-combobox width100"
								data-options="required:true" /></td>
							<td class="td_pad"><span><span
									style="color: red; font-weight: bolder;">*</span>市(县)：</span><input
								role="combobox" id="f_city"
								class="domain-input easyui-combobox width100"
								data-options="required:true" /></td>
						</tr>
						<tr class="tr_ht" align="right">
							<td class="td_pad"><span><span
								...
								data-options="required:true" /></td>
							<td class="td_pad"><span>地址：</span><input role="textbox"
								id="f_address" class="domain-input easyui-textbox width100"
								data-options="required:false" /></td>
							<td class="td_pad"><span>职称：</span><input role="combobox"
								id="f_titleIds" class="domain-input easyui-combobox width100" /></td>
							<td class="td_pad"><span
								style="color: red; font-weight: bolder;">*</span><span>状态：</span><input
								role="combobox" id="f_mainStatus"
								class="domain-input easyui-combobox width100" /></td>
						</tr>
						<tr class="tr_ht" align="right">
							<td class="td_pad"><span>邮箱：</span><input role="textbox"
								id="f_email" class="domain-input easyui-textbox width100"
								data-options="required:false" /></td>
							<td class="td_pad"><span>微信：</span><input role="textbox"
								id="f_weixin" class="domain-input easyui-textbox width100"
								data-options="required:false" /></td>
							<td class="td_pad"><span>微博：</span><input role="textbox"
								id="f_weibo" class="domain-input easyui-textbox width100"
								data-options="required:false" /></td>
							<td class="td_pad"><span>QQ：</span><input role="textbox"
								id="f_qq" class="domain-input easyui-textbox width100"
								data-options="required:false" /></td>
						</tr>
						<tr>
							<td class="td_pad" colspan="4" align="right"><span>擅&nbsp;&nbsp;长：</span>
								<input role="textbox" id="f_goodAt"
								class="domain-input easyui-textbox"
								data-options="required:false,multiline:true,height:80,prompt:'请输入内容',width:680" />
							</td>
						</tr>
						<tr>
							<td class="td_pad" colspan="4"><span>执业经历：</span> <input
								role="textbox" id="f_introduction"
								class="domain-input easyui-textbox"
								data-options="required:false,multiline:true,height:80,prompt:'请输入内容',width:680" />
							</td>
						</tr>
						<tr>
							<td class="td_pad" colspan="4"><span>咨询范围：</span> <input
								role="textbox" id="f_consultScope"
								class="domain-input easyui-textbox"
								data-options="required:false,multiline:true,height:80,prompt:'请输入内容',width:680" />
							</td>
						</tr>
			...
			<div class="inline-center mgV10">
				<button id="mainObjSave" onclick="saveMainObj()"
					class="button button-primary button-rounded button-small">保存333</button>
	...
	<script type="text/javascript" src="/js/common/back_template.js"
		title="v"></script>
	<script type="text/javascript"
		src="/js/common/common_back_resetPassword.js" title="v"></script>
	<script type="text/javascript" src="/js/back/domain/hospital/doctor.js"
		title="v"></script>
</body>
</html>