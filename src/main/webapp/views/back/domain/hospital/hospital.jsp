...
<body style="min-width: 1000px;">
	...
	<table id="mainQueryTable" style="min-width: 1000px;">
		<tbody>
			<tr class="tr_ht" align="right">
				<td class="td_pad"><span>名称：</span><input role="textbox"
					id="sc_briefName" class="domain-input easyui-textbox width100" /></td>
				...
				<td class="td_pad"><span>邮箱：</span><input role="textbox"
					id="sc_email" class="domain-input easyui-textbox width100" /></td>
			...
			<tr class="tr_ht" align="right">
				...
				<td class="td_pad"><span>负责人：</span><input role="textbox"
					id="sc_weibo" class="domain-input easyui-textbox width100" /></td>
	...
	<div id="opt_outer_div">
		<div class="fl_opt_div">
			...
			<button onclick="exportHospital()"
				class="button button-primary button-rounded button-small">导出诊所信息</button>
	...
	<div id="mainObjWindiv" style="display: none;">
		<div id='mainObjWin' class="easyui-window" title="诊所信息"
			style="width: 645px;"
					...
					<tbody>
						<tr class="tr_ht" align="right">
							<td class="td_pad"><span><span
									style="color: red; font-weight: bolder;">*</span>简称：</span><input
								role="textbox" id="f_briefName"
								class="domain-input easyui-textbox width140"
								data-options="required:true" /></td>
							<td class="td_pad"><span><span
									style="color: red; font-weight: bolder;">*</span>全称：</span><input
								role="textbox" id="f_wholeName"
								class="domain-input easyui-textbox width140"
								data-options="required:true" /></td>
							<td class="td_pad"><span><span
									style="color: red; font-weight: bolder;">*</span>地址：</span><input
								role="textbox" id="f_address"
								class="domain-input easyui-textbox width140"
								data-options="required:true" /></td>
						</tr>
						<tr class="tr_ht" align="right">
							<td class="td_pad"><span><span
								...
								class="domain-input easyui-textbox width140"
								data-options="required:true" /></td>
							<td class="td_pad"><span><span style="color: red">*</span>省(市)：</span><input
								role="combobox" id="f_province"
								class="domain-input easyui-combobox width130"
								data-options="required:true" /></td>
							<td class="td_pad"><span><span style="color: red">*</span>市(县)：</span><input
						...
						<tr class="tr_ht" align="right">
							<td class="td_pad"><span><span
									style="color: red; font-weight: bolder;">*</span>血液检测：</span><input
								role="combobox" id="f_bloodTest"
							...
							<td class="td_pad"><span><span
								...
								class="domain-input easyui-combobox width140" /></td>
							<td class="td_pad"><span>座机：</span><input role="textbox"
								id="f_tel" class="domain-input easyui-textbox width140" /></td>
						</tr>
						<tr class="tr_ht" align="right">
							<td class="td_pad"><span>网址：</span><input role="textbox"
								id="f_website" class="domain-input easyui-textbox width140" /></td>
							<td class="td_pad"><span>邮箱：</span><input role="textbox"
								id="f_email" class="domain-input easyui-textbox width140" /></td>
							<td class="td_pad"><span>QQ：</span><input role="textbox"
								id="f_qq" class="domain-input easyui-textbox width140" /></td>
						</tr>
						<tr class="tr_ht" align="right">
							<td class="td_pad"><span>负责人：</span><input role="textbox"
								id="f_weibo" class="domain-input easyui-textbox width140" /></td>
							<td class="td_pad"><span>微信：</span><input role="textbox"
								id="f_weixin" class="domain-input easyui-textbox width140" /></td>
						</tr>
						<tr>
							<td class="td_pad" colspan="3"><span>简介：</span> <input
			...
			<div style="display: inline-block; float: left;">
				...
				<input type="hidden" name="filePaths" id="filePaths"
					value="${ap.picPath}" /> <input type="hidden" name="fileDBIds"
					id="fileDBIds" />
			</div>
	...
	<script type="text/javascript"
		src="/js/back/domain/hospital/hospital.js" title="v"></script>
</body>
</html>