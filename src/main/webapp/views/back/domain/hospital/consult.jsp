...
<body style="min-width: 1000px;">
	...
	<table id="mainQueryTable" style="min-width: 1000px;">
		<tbody>
			<tr class="tr_ht" align="right">
				<td class="td_pad"><span>咨询人：</span><input role="combobox"
					id="sc_userId" class="domain-input easyui-comboboxbox width100" /></td>
				<td class="td_pad"><span>咨询医生：</span><input role="combobox"
					id="sc_doctorId" class="domain-input easyui-combobox width100" /></td>
				<td class="td_pad"><span>标题：</span><input role="textbox"
					id="sc_title" class="domain-input easyui-textbox width100" /></td>
				<!-- <td class="td_pad"><span>操作时间：</span><input role="datebox" id="sc_operationTime" class="domain-input easyui-datebox width140" /></td> -->
			...
			<tr class="tr_ht" align="right">
				<td class="td_pad"><span>咨询内容：</span><input role="textbox"
					id="sc_mainContent" class="domain-input easyui-textbox width100" /></td>
				<td class="td_pad"><span>请求帮助内容：</span><input role="textbox"
					id="sc_helpContent" class="domain-input easyui-textbox width100" /></td>
				<td class="td_pad"><span>标签：</span><input role="textbox"
					id="sc_tags" class="domain-input easyui-textbox width100" /></td>
	...
	<div id="mainObjWindiv" style="display: none;">
		<div id='mainObjWin' class="easyui-window" title="咨询信息"
			style="width: 660px;"
					...
					<tbody>
						<tr class="tr_ht" align="right">
							<td class="td_pad"><span><span
									style="color: red; font-weight: bolder;">*</span>咨询人：</span><input
								role="combobox" id="f_userId"
								class="domain-input easyui-combobox width140"
								data-options="required:true" /></td>
							<td class="td_pad"><span><span
									style="color: red; font-weight: bolder;">*</span>咨询医生：</span><input
						...
						<tr class="tr_ht" align="right">
							<!-- <td class="td_pad"><span>操作时间：</span><input role="datebox" id="f_operationTime" class="domain-input easyui-datebox width140" /></td> -->
							<td class="td_pad"><span><span
									style="color: red; font-weight: bolder;">*</span>标题：</span><input
								role="textbox" id="f_title"
								class="domain-input easyui-textbox width140"
								data-options="required:true" /></td>
							<td class="td_pad"><span>标签：</span><input role="textbox"
								id="f_tags" class="domain-input easyui-textbox width140"
								data-options="required:false" /></td>
						</tr>
						<tr class="tr_ht" align="right">
							<td class="td_pad" colspan="3"><span>咨询内容：</span><input
								role="textbox" id="f_mainContent"
								class="domain-input easyui-textbox width100"
								data-options="required:false,multiline:true,height:100,width:540" /></td>
						</tr>
						<tr class="tr_ht" align="right">
							<td class="td_pad" colspan="3"><span>请求帮助内容：</span><input
								role="textbox" id="f_helpContent"
								class="domain-input easyui-textbox width100"
								data-options="required:false,multiline:true,height:100,width:540" /></td>
						</tr>
					</tbody>
	...
	<script type="text/javascript" src="/js/common/back_template.js"
		title="v"></script>
	<script type="text/javascript"
		src="/js/back/domain/hospital/consult.js" title="v"></script>
</body>
</html>