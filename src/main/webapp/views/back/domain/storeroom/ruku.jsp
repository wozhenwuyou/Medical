	...
	<table id="mainQueryTable" style="min-width: 1000px;">
		<tbody>
			<tr class="tr_ht" align="right">
				<td class="td_id">入库单号：<input role="textbox"
					id="sc_no" class="domain-input easyui-textbox width100" /></td>
				<td class="td_cuser.usernam"><span>订单号：</span><input role="datebox"
	...
	<div id="opt_outer_div">
		<div class="fl_opt_div">
			<button role="opt_1" onclick="fnAddPhrBasicInfo(null, '添加');"
				class="button button-primary button-rounded button-small" id="btn_add">订单入库</button>
