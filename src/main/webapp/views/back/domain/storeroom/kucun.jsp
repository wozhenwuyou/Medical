	...
	<table id="mainQueryTable" style="min-width: 1000px;">
		<tbody>
			<tr class="tr_ht" align="right">
				...
				<td class="td_pad"><span>入库单号：</span><input role="textbox"
					id="sc_userNo" class="domain-input easyui-textbox width100"  /></td>
				<td class="td_pad"><span>品名：</span><input role="textbox"
					id="sc_idCardNo" class="domain-input easyui-textbox width100"  /></td>
				<td class="td_pad"><span>种类：</span><input role="textbox"
			...
			<tr class="tr_ht" align="right">
				<td class="td_pad">批次：<input role="textbox"
					id="sc_instockman" class="domain-input easyui-textbox width100" /></td>
				<td class="td_pad">截止效期：<input role="datebox"
