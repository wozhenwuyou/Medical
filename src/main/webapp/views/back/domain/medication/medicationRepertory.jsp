...
<body style="min-width: 1000px;">
	...
	<table id="mainQueryTable">
		<tbody>
			<tr class="tr_ht" align="right">
				...
				<td class="td_pad"><span>药品类型：</span><input role="combobox"
					id="sc_medicationTypeId"
					class="domain-input easyui-combobox width140" /></td>
				<td class="td_pad"><span>药品：</span><input role="combobox"
					id="sc_medicationId" class="domain-input easyui-combobox width140" /></td>
			...
			<tr class="tr_ht" align="right">
				<td class="td_pad"><span>库存数量：</span><input role="textbox"
					id="sc_remainNum" class="domain-input easyui-textbox width140" /></td>
				<td class="td_pad"><span>告警数量：</span><input role="textbox"
					id="sc_warningNum" class="domain-input easyui-textbox width140" /></td>
	...
	<div id="opt_outer_div">
		<div class="fl_opt_div">
			...
			<button onclick="exportmedicationRepertory()"
				class="button button-primary button-rounded button-small">导出药品库信息</button>
	...
	<div id="mainObjWindiv" style="display: none;">
		<div id='mainObjWin' class="easyui-window" title="药品库"
			style="width: 700px;"
				...
				<table id="mainObjTable" class="padL5">
					<tbody>
						<tr class="tr_ht" align="right">
							...
							<td class="td_pad"><span><span
									style="color: red; font-weight: bolder;">*</span>药品类型：</span><input
								role="combobox" id="f_mtId"
								class="domain-input easyui-combobox width140"
								data-options="required:true" /></td>
							<td class="td_pad"><span><span
									style="color: red; font-weight: bolder;">*</span>药品：</span><input
								role="combobox" id="f_medicationId"
								class="domain-input easyui-combobox width140"
								data-options="required:true" /></td>
						</tr>
						<tr class="tr_ht" align="right">
							<td class="td_pad"><span><span
									style="color: red; font-weight: bolder;">*</span>药品单价：</span><input
								role="numberbox" id="f_price"
								class="domain-input easyui-numberbox width140"
								data-options="required:true,min:0,precision:2" /></td>
							<td class="td_pad"><span><span
									style="color: red; font-weight: bolder;">*</span>告警数量：</span><input
								role="numberbox" id="f_warningNum"
								class="domain-input easyui-numberbox width140"
								data-options="required:true" /></td>
							<td class="td_pad"><span><span
						...
						<tr class="tr_ht" align="right">
							<td id="td_remainNumFresh" style="display: none;" class="td_pad"><span>增加数量：</span>
								<input id="f_remainNumFresh" class="easyui-numberbox width140"
								data-options="required:false,onChange: freshRemainNum" /></td>
							<td class="td_pad"><span><span
									style="color: red; font-weight: bolder;">*</span>库存数量：</span><input
								role="numberbox" id="f_remainNum"
								class="domain-input easyui-numberbox width140"
								data-options="required:true" /></td>
						</tr>
						<tr class="tr_ht" align="right">
							<td colspan="3" align="right" class="td_pad"><span>备注：</span><input
								role="textbox" id="f_remark"
								class="domain-input easyui-textbox width140"
								data-options="required:false,multiple:true,height:80,width:568" /></td>
						</tr>
					</tbody>
				</table>
			</form>
	...
	<script type="text/javascript" src="/js/common/back_template.js"
		title="v"></script>
	<script type="text/javascript"
		src="/js/back/domain/medication/medicationRepertory.js" title="v"></script>
</body>
</html>