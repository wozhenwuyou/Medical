...
<body style="min-width: 1000px;">
	...
	<table id="mainQueryTable">
		<tbody>
			<tr class="tr_ht" align="right">
				<td class="td_pad"><span>药物名称：</span><input role="combobox"
					id="sc_medicationId" class="domain-input easyui-combobox width100" /></td>
				<td class="td_pad"><span>诊所名称：</span><input role="combobox"
					id="sc_hospitalId" class="domain-input easyui-combobox width100" /></td>
				<td class="td_pad"><span>入库或出库时间：</span><input role="datebox"
					id="sc_inOrOutTime" class="domain-input easyui-datebox width100" /></td>
			...
			<tr class="tr_ht" align="right">
				<td class="td_pad"><span>入库或出库：</span><input role="combobox"
					id="sc_inOrOut" class="domain-input easyui-combobox width100" /></td>
				<td class="td_pad"><span>数量：</span><input role="textbox"
					id="sc_num" class="domain-input easyui-textbox width100" /></td>
	...
	<div id="mainObjWindiv" style="display: none;">
		<div id='mainObjWin' class="easyui-window" title="药品出入情况"
			style="width: 700px;"
					...
					<tbody>
						<tr class="tr_ht" align="right">
							<td class="td_pad"><span><span
									style="color: red; font-weight: bolder;">*</span>诊所名称：</span><input
							...
							<td class="td_pad"><span><span
								...
								data-options="required:true" /></td>
							<td class="td_pad"><span><span
									style="color: red; font-weight: bolder;">*</span>入库出库：</span><input
								role="combobox" id="f_inOrOut"
								class="domain-input easyui-combobox width140"
								data-options="required:true" /></td>
						</tr>
						<tr class="tr_ht" align="right">
							<td class="td_pad"><span><span
									style="color: red; font-weight: bolder;">*</span>操作时间：</span><input
								role="datetimebox" id="f_inOrOutTime"
								class="domain-input easyui-datetimebox width140"
								data-options="required:true" /></td>
							<td class="td_pad"><span><span
									style="color: red; font-weight: bolder;">*</span>数量：</span><input
								role="textbox" id="f_num"
	...
	<script type="text/javascript" src="/js/common/back_template.js"
		title="v"></script>
	<script type="text/javascript"
		src="/js/back/domain/medication/medicationLog.js" title="v"></script>
</body>
</html>