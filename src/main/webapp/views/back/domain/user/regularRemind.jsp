...
<body style="min-width: 1000px;">
		...
		<tbody>
			<tr class="tr_ht" align="right">
				...
				<td class="td_pad"><span>内容：</span><input role="textbox"
					id="sc_content" class="domain-input easyui-textbox width100" /></td>
	...
	<div id="mainObjWindiv" style="display: none;">
		<div id='mainObjWin' class="easyui-window" title="定期提醒"
			style="width: 480px;"
			...
			<form id="mainObjForm">
				...
				<table id="mainObjTable" class="padL5">
					<tbody>
						...
						<tr class="tr_ht" align="right">
							<td class="td_pad"><span><span
									style="color: red; font-weight: bolder;">*</span>提醒时间：</span><input
								role="datetimebox" id="f_remindTime"
						...
						<tr class="tr_ht" align="right">
							<td class="td_pad" colspan="2"><span><span
									style="color: red; font-weight: bolder;">*</span>内容：</span><input
								role="textbox" id="f_content"
								class="domain-input easyui-textbox" style="width: 342px"
								data-options="multiline:true,height:100,required:true" /></td>
						</tr>
					</tbody>
				</table>
			</form>
	...
	<script type="text/javascript" src="/js/common/back_template.js"
		title="v"></script>
	<script type="text/javascript"
		src="/js/back/domain/user/regularRemind.js" title="v"></script>
</body>
</html>