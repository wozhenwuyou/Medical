...
<body style="min-width: 1000px;">
	...
	<div id="opt_outer_div">
		<div class="fl_opt_div">
			...
			<button onclick="exportPatient()"
				class="button button-primary button-rounded button-small">导出患者信息</button>
					...
					<tbody>
						<tr class="tr_ht" align="right">
							<td class="td_pad"><span><span
									style="color: red; font-weight: bolder;">*</span>用户用户名：</span><input
								role="textbox" id="f_username"
								class="domain-input easyui-textbox width100"
								data-options="required:true" /></td>
							<td class="td_pad"><span><span
									style="color: red; font-weight: bolder;">*</span>用户真实姓名：</span><input
						...
						<tr class="tr_ht" align="right">
							<td class="td_pad"><span>手机：</span><input role="textbox"
								id="f_phone" class="domain-input easyui-textbox width100"
	...
	<script type="text/javascript" src="/js/common/back_template.js"
		title="v"></script>
	<script type="text/javascript" src="/js/back/domain/user/patient.js"
		title="v"></script>
</body>
</html>