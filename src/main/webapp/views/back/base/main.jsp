...
<body id="main_layout" class="easyui-layout"
	...
	<div data-options="region:'north'" style="height: 60px;">
		<div class="header">
			<span style="float: left;"> <img
				src="/images/front/main23.png" alt="logo" height="55"
				style="margin-left: 60px; margin-top: 2px;" />
			</span>
			<div
				style="color: #D4D4D4; float: left; margin: 10px 8px 16px 8px; padding: 5px;">
				<span style="font-size: 24px;">沃诊无忧医疗信息管理平台</span>
			</div>
			<div class="head_icons">
				<div id="head_logout" onclick="logout()" class="head_icon">
					<img src="/images/back/bg14.png" title="安全退出" />
				</div>
				<div id="head_refresh" onclick="refresh()" class="head_icon">
					<img src="/images/back/bg13.png" title="更新缓存" />
				</div>
				<div id="head_password" onclick="openUpdatePassword()"
					class="head_icon">
					<img src="/images/back/bg12.png" title="修改密码" />
				</div>
				<c:if test="${!empty admin.roleId && admin.roleId != 3}">
					<div id="head_message" onclick="showMain('消息通知管理','/back/notice')"
						class="head_icon">
						<img src="/images/back/bg09.png" title="站内短信" />
					</div>
				</c:if>
				<div id="head_index" onclick="login()" class="head_icon">
					<img src="/images/back/bg08.png" title="网站首页" />
				</div>
				<div
					style="color: #D4D4D4; float: right; margin: 16px 8px; padding: 5px;">
					<span style="font-size: 14px;">欢迎您：</span><span
						style="color: white; font-size: 20px;">${admin.username}</span>
				</div>
			</div>
		</div>
	</div>
	...
	<div
		data-options="region:'west',split:true,collapsible:true,title:'菜单',width:200"
		style="width: 200px;">
	...
	<div data-options="region:'center'"
		style="padding: 0px; background: #eee; overflow: hidden; max-width: 100%">
		<!--  id="main" class="easyui-tabs" -->
		<div id="main" class="easyui-tabs" fit="true" border="false"
			plain="true" style="width: 100%; height: 100%;"></div>
	...
	<div style="display: none;" id="updatePasswordWin" title="修改密码">
		<div style="margin: 8px 8px 8px 35px;">
			...
			旧密码：<input type="text" id="oldPsd"></input><br />
			<br /> 新密码：<input type="text" id="newPsd1"></input><br />
			<br /> 新密码：<input type="text" id="newPsd2"></input><br />
			<br /> <a id="submitUptPsd" onclick="updatePassword()"
				class="easyui-linkbutton">确认</a>&nbsp; <a id="returnUptPsd"
				onclick="closeUpdatePwdWin()" class="easyui-linkbutton">返回</a>
		</div>
	</div>
