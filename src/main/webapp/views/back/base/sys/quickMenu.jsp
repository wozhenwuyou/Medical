...
<body style="min-width: 1000px;">
	...
	<table>
		<tbody>
			<tr class="tr_ht" align="right">
				<td class="td_pad"><span>用户名：</span><input id="username"
					class="easyui-textbox width120" /></td>
				<td class="td_pad"><span>用户编号：</span><input id="userSerial"
					class="easyui-textbox width120" /></td>
				<td class="td_pad"><span>菜单：</span><input id="menu"
	...
	<div class="fl_opt_div">
		...
		<button id="addQuickMenu" onclick="addQuickMenu();return false;"
		...
		<button id="userLink" onclick="jumpToUserInfo();return false;"
	...
	<div id="quickMenuDetailWindiv" style="display: none;">
		<div id='quickMenuDetailWin' class="easyui-window" title="数据字典信息"
			style="width: 700px; height: 350px"
			data-options="modal:true,closed:true,maximizable:false,collapsible:false,minimizable:false">
			<div id="quickMenuDetailTip" style="margin-left: 28px;"></div>
			<form id="quickMenuDetailForm">
				<br />
				<table id="quickMenuDetailTable" class="padL5">
					<tbody>
						...
						<tr class="tr_ht" align="right">
							<td class="td_pad"><span>菜单名称:</span><input id="f_menu"
								class="easyui-combobox width140" /></td>
							<td class="td_pad"><span>状态：</span><input id="f_mainStatus"
								class="easyui-combobox width140" /></td>
						</tr>
					</tbody>
				</table>
			...
			<div class="inline-center mgV40">
				<button id="quickMenuDetailSave" onclick="submitQuickMenuDetail()"
					class="button button-primary button-rounded button-small">保存</button>
				<button id="quickMenuDetailBack" onclick="closeQuickMenuDetailWin()"
	...
	<script type="text/javascript"
		src="/js/back/base/quickMenu/quickMenu.js" title="v"></script>
</body>
</html>