...
<body style="min-width: 1000px;">
	...
	<table id="mainQueryTable">
		<tbody>
			<tr class="tr_ht" align="right">
				...
				<td class="td_pad"><span>昵称：</span><input role="textbox"
					id="sc_nickname" class="domain-input easyui-textbox width140" /></td>
	...
	<div id="opt_outer_div">
		<div class="fl_opt_div">
			...
			<button role="opt_1" onclick="addMainObj()"
				class="button button-primary button-rounded button-small">添加管理员</button>
			...
			<form id="mainObjForm">
				...
				<table id="mainObjTable" class="padL5">
					<tbody>
						<tr class="tr_ht" align="right">
							<td class="td_pad"><span>用户名：</span><input role="textbox"
								id="f_username" class="domain-input easyui-textbox width140"
								data-options="required:true" /></td>
							<td class="td_pad"><span>昵称：</span><input role="textbox"
								id="f_nickname" class="domain-input easyui-textbox width140"
								data-options="required:true" /></td>
							<td class="td_pad"><span>手机号码：</span><input role="textbox"
								id="f_phone" class="domain-input easyui-textbox width140"
								data-options="required:true" /></td>
						</tr>
						<tr class="tr_ht" align="right">
							<td class="td_pad"><span>邮箱：</span><input role="textbox"
						...
						<tr class="tr_ht" align="right">
							...
							<td class="td_pad"><span>角色：</span><input role="combobox"
								id="f_roleId" class="domain-input easyui-combobox width140" /></td>
							<td class="td_pad"><span>状态：</span><input role="combobox"
								id="f_mainStatus" class="domain-input easyui-combobox width140" /></td>
							<td class="td_pad"><span>重置密码：</span><input role="textbox"
								id="f_passwordReset"
								class="domain-input easyui-textbox width140" /></td>
						</tr>
						<tr class="tr_ht" align="right">
							<td class="td_pad" colspan="3"><span class="colorGray">用户密码默认为admin6688</span></td>
						</tr>
					</tbody>
				</table>
			</form>
	...
	<script type="text/javascript" src="/js/common/back_template.js"
		title="v"></script>
	<script type="text/javascript" src="/js/back/base/admin/admin.js"
		title="v"></script>
</body>
</html>