...
<body style="min-width: 1000px;">
	...
	<table id="mainQueryTable">
		<tbody>
			<tr class="tr_ht" align="right">
				<td class="td_pad"><span>登录人用户名：</span><input role="textbox"
			...
			<tr class="tr_ht" align="right">
				<td class="td_pad"><span>登录开始时间：</span><input role="datebox"
					id="sc_loginTimeFrom" class="domain-input easyui-datebox width140" /></td>
				<td class="td_pad"><span>登录结束时间：</span><input role="datebox"
					id="sc_loginTimeTo" class="domain-input easyui-datebox width140" /></td>
	...
	<script type="text/javascript" src="/js/common/back_template.js"
		title="v"></script>
	<script type="text/javascript" src="/js/back/base/loginLog/loginLog.js"
		title="v"></script>
</body>
</html>