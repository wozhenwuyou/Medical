...
<body style="min-width: 1000px;">
	...
	<div id="opt_outer_div">
		<div class="fl_opt_div">
			...
			<button role="opt_1" onclick="lh.openNewTab('/back/baserole')"
				class="button button-royal button-rounded button-small">角色</button>
				...
				<table id="mainObjTable" class="padL5">
					<tbody>
						...
						<tr class="tr_ht" align="right">
							...
							<td class="td_pad"><span class="colorGray">用户密码默认为admin6688</span></td>
						</tr>
						<tr class="tr_ht" align="right">
						</tr>
					</tbody>
