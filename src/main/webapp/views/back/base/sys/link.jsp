...
<body style="min-width: 1000px;">
	...
	<table id="mainQueryTable">
		<tbody>
			<tr class="tr_ht" align="right">
				<td class="td_pad"><span>友情链接：</span><input role="combobox"
					id="sc_baseLink" class="domain-input easyui-combobox width140" /></td>
				<td class="td_pad"><span>名站导航：</span><input role="combobox"
					id="sc_linkFamous" class="domain-input easyui-combobox width140" /></td>
			...
			<tr class="tr_ht" align="right">
				<td class="td_pad"><span>名称：</span><input role="textbox"
					id="sc_dictNameLike" class="domain-input easyui-textbox width140" /></td>
	...
	<div id="mainObjWindiv" style="display: none;">
		<div id='mainObjWin' class="easyui-window" title="友情链接"
			style="width: 540px;"
			...
			<form id="mainObjForm">
				...
				<table id="mainObjTable" class="padL5">
					<tbody>
						<tr class="tr_ht" align="right">
							<td class="td_pad"><span>友情链接：</span><input role="combobox"
								id="f_baseLink" class="domain-input easyui-combobox width140" /></td>
							<td class="td_pad"><span>名站导航：</span><input role="combobox"
								id="f_linkFamous" class="domain-input easyui-combobox width140"
								data-options="required:false" /></td>
						</tr>
						<tr class="tr_ht" align="right">
							<td class="td_pad"><span>名称：</span><input role="textbox"
								id="f_dictName" class="domain-input easyui-textbox width140"
	...
	<script type="text/javascript" src="/js/common/back_template.js"
		title="v"></script>
	<script type="text/javascript" src="/js/back/base/link/link.js"
		title="v"></script>
</body>
</html>