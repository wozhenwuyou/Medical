...
<body style="min-width: 1000px;">
		...
		<tbody>
			<tr class="tr_ht" align="right">
				...
				<td class="td_pad"><span>真实姓名：</span><input id="sc_realName"
					class="easyui-textbox width120" /></td>
				<td class="td_pad"><span>实名认证：</span><input id="sc_isRealAuth"
	...
	<div id="userFundWindiv" style="display: none;">
		<div id='userFundWin' class="easyui-window" title="用户详细信息"
			...
			<div class="inline-center mgV40">
				<button id="userFundSave" onclick="submitUserFund()"
					class="button button-primary button-rounded button-small">保存</button>
				<button id="userFundBack" onclick="closeUserFundWin()"
	...
	<script type="text/javascript" src="/js/back/base/user/userFund.js"
		title="v"></script>
</body>
</html>