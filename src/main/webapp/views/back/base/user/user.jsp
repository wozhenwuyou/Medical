...
<body style="min-width: 1000px;">
	...
	<div id="mainObjWindiv" style="display: none;">
		<div id='mainObjWin' class="easyui-window" title="患者信息"
			style="width: 740px;"
			...
			<form id="mainObjForm">
				...
				<table id="mainObjTable" class="padL5">
					<tbody>
						...
						<tr class="tr_ht" align="right">
							<td class="td_pad"><span><span
									style="color: red; font-weight: bolder;">*</span>身份证号码：</span><input
								role="textbox" id="f_idcardNum"
								class="domain-input easyui-textbox width140"
								data-options="required:true" /></td>
							<td class="td_pad"><span><span
									style="color: red; font-weight: bolder;">*</span>出生日期：</span><input
								role="datebox" id="f_birthday"
						...
						<tr class="tr_ht" align="right">
							<td class="td_pad"><span>职业：</span><input role="combobox"
								id="f_jobId" class="domain-input easyui-combobox width140"
								data-options="required:false" /></td>
							<td class="td_pad"><span>上级用户：</span><input role="combobox"
								id="f_relationId" class="domain-input easyui-combobox width140"
								data-options="required:false" /></td>
							<td class="td_pad"><span>用户关系：</span><input role="textbox"
								id="f_userRelation" class="domain-input easyui-textbox width140"
								data-options="required:false" /></td>
						</tr>
						<tr class="tr_ht" align="right">
							<td class="td_pad"><span>邮箱：</span><input role="textbox"
								id="f_email" class="domain-input easyui-textbox width140"
								data-options="required:false" /></td>
							<td class="td_pad"><span>地址：</span><input role="textbox"
								id="f_address" class="domain-input easyui-textbox width140"
								data-options="required:false" /></td>
							<td class="td_pad"><span>重置密码：</span><input
								id="passwordReset" class="easyui-textbox width140" /></td>
						</tr>
						<!-- <tr class="tr_ht" align="right">
	...
	<script type="text/javascript" src="/js/back/base/user/user.js"
		title="v"></script>
</body>
</html>