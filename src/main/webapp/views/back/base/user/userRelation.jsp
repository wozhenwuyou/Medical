...
<body style="min-width: 1000px;">
	...
	<table>
		<tbody>
			...
			<tr class="tr_ht" align="right">
				<td class="td_pad"><span>论坛类型：</span><input id="sc_type"
	...
	<div class="fl_opt_div">
		...
		<button id="addUserRelation" onclick="addUserRelation();return false;"
		...
		<button id="antiqueCityLink"
			onclick="jumpToAntiqueCity();return false;"
			class="button button-royal button-rounded button-small">古玩城</button>
	...
	<div id="userRelationDetailWindiv" style="display: none;">
		<div id='userRelationDetailWin' class="easyui-window" title="古玩城用户"
			...
			<form id="userRelationDetailForm">
				<br />
				<table id="userRelationDetailTable" class="padL5">
					<tbody>
						...
						<tr class="tr_ht" align="right">
							<td class="td_pad"><span>古玩城名称：</span><input
								id="f_antiqueCity" class="easyui-combobox width140" /></td>
						</tr>
						<!-- <tr class="tr_ht" align="right">
			...
			<div class="inline-center mgV40">
				<button id="userRelationDetailSave"
					onclick="submitUserRelationDetail()"
					class="button button-primary button-rounded button-small">保存</button>
				<button id="userRelationDetailBack"
					onclick="closeUserRelationDetailWin()"
	...
	<script type="text/javascript" src="/js/back/base/user/userRelation.js"
		title="v"></script>
</body>
</html>