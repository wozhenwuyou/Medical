...
<body style="min-width: 1000px;">
	...
	<table id="mainQueryTable">
		...
		<tbody>
			<tr class="tr_ht" align="right">
				<td class="td_pad"><span>评论人：</span><input role="combobox"
					id="sc_userId" class="domain-input easyui-combobox width140" /></td>
				<td class="td_pad"><span>排序：</span><input role="combobox"
					id="sc_ascOrdesc" class="domain-input easyui-combobox width140" /></td>
				<!-- <td class="td_pad"><span>评论类型：</span><input role="combobox" id="sc_commentTypeId" class="domain-input easyui-combobox width140" /></td> -->
			...
			<tr class="tr_ht" align="right">
				<td class="td_pad"><span>文章标题：</span><input role="textbox"
					id="sc_articlTitle" class="domain-input easyui-textbox width140" /></td>
	...
	<div id="mainObjWindiv" style="display: none;">
		<div id='mainObjWin' class="easyui-window" title="评论"
			style="width: 500px;"
			...
			<form id="mainObjForm">
				...
				<table id="mainObjTable" class="padL5">
					<tbody>
						<tr class="tr_ht" align="right">
							<td class="td_pad"><span>评论人：</span><input role="combobox"
								id="f_userId" class="domain-input easyui-combobox width160"
								data-options="required:true" /></td>
							<td class="td_pad"><span>状态：</span><input role="combobox"
								id="f_mainStatus" class="domain-input easyui-combobox width160"
								data-options="required:true" /></td>
						</tr>
						<tr class="tr_ht" align="right">
							<td class="td_pad"><span>文章栏目：</span><input role="combobox"
								id="articleTypeId" class="domain-input easyui-combobox width160"
								data-options="required:true" /></td>
							<td class="td_pad"><span>文章列表：</span><input role="combobox"
								id="f_objectId" class="domain-input easyui-combobox width160"
								data-options="required:true" /></td>
						</tr>
						<tr>
							<td class="td_pad"><span>内容：</span></td>
						</tr>
						<tr>
							<td class="td_pad" colspan="2"><input role="textbox"
								id="f_content" class="domain-input easyui-textbox"
								data-options="required:true,multiline:true,height:100,prompt:'请输入内容',width:460" /></td>
						</tr>
					</tbody>
				</table>
			</form>
	...
	<script type="text/javascript" src="/js/common/back_template.js"
		title="v"></script>
	<script type="text/javascript" src="/js/back/base/comment/comment.js"
		title="v"></script>
</body>
</html>