...
<body style="min-width: 1000px;">
	...
	<table id="mainQueryTable">
		...
		<tbody>
			<tr class="tr_ht" align="right">
				<td class="td_pad"><span>发送人：</span><input role="combobox"
					id="sc_senderId" class="domain-input easyui-combobox width140" /></td>
				<td class="td_pad"><span>接收人：</span><input role="combobox"
					id="sc_receiverId" class="domain-input easyui-combobox width140" /></td>
	...
	<div id="mainObjWindiv" style="display: none;">
		<div id='mainObjWin' class="easyui-window" title="留言"
			style="width: 540px;"
			...
			<form id="mainObjForm">
				...
				<table id="mainObjTable" class="padL5">
					<tbody>
						<tr class="tr_ht" align="right">
							<td class="td_pad"><span>发送人：</span><input role="combobox"
								id="f_senderId" class="domain-input easyui-combobox width100"
								data-options="required:true" /></td>
							<td class="td_pad"><span>接收人：</span><input role="combobox"
								id="f_receiverId" class="domain-input easyui-combobox width100"
								data-options="required:true" /></td>
							<td class="td_pad"><span>状态：</span><input role="combobox"
								id="f_mainStatus" class="domain-input easyui-combobox width100"
								data-options="required:true" /></td>
						</tr>
						<tr>
							<td class="td_pad" colspan="3"><span>内容：</span><input
								...
								data-options="required:true,multiline:true,height:100,prompt:'请输入内容',width:450" /></td>
						</tr>
						<tr>
							<td class="td_pad" colspan="3"><span>回复：</span><input
								role="textbox" id="f_replyContent"
								class="domain-input easyui-textbox"
								data-options="required:true,multiline:true,height:100,prompt:'',width:450" /></td>
						</tr>
					</tbody>
				</table>
			</form>
	...
	<script type="text/javascript" src="/js/common/back_template.js"
		title="v"></script>
	<script type="text/javascript" src="/js/back/base/message/message.js"
		title="v"></script>
</body>
</html>