...
<body style="min-width: 1000px;">
	...
	<table id="mainQueryTable">
		<tbody>
			<tr class="tr_ht" align="right">
				<td class="td_pad"><span>图片名称：</span><input role="textbox"
					id="sc_title" class="domain-input easyui-textbox width140" /></td>
	...
	<div id="opt_outer_div">
		<div class="fl_opt_div">
			...
			<button role="opt_1"
				onclick="lh.jumpToUrl('/back/addOrUpdatePicturePage')"
				class="button button-primary button-rounded button-small">添加图片</button>
	...
	<div id="mainObjWindiv" style="display: none;">
		<div id='mainObjWin' class="easyui-window" title="图片信息"
					...
					<tbody>
						<tr class="tr_ht" align="right">
							<td class="td_pad"><span><span
									style="color: red; font-weight: bolder;">*</span>图片新访问地址：</span> <input
								role="textbox" id="f_picPathNew"
								class="domain-input easyui-textbox" style="width: 240px;"
			...
			<div style="height: 310px;">
				<img id="pic" class="picurl" src="${pic.picPaths}"
					style="max-height: 300px; max-width: 680px; overflow: hidden; padding: 5px;" />
	...
	<script type="text/javascript" src="/js/common/back_template.js"
		title="v"></script>
	<script type="text/javascript" src="/js/back/base/picture/picture.js"
		title="v"></script>
</body>
</html>