...
<body style="min-width: 1000px;">
	<form class="margin-5-5-10-15">
		...
		<table class="padL5">
			<tr class="tr_ht" align="right">
				<td class="td_pad"><span>广告标题：</span><input role="textbox"
					id="f_title" class="domain-input easyui-textbox width140"
					data-options="required:true" /></td>
				<td class="td_pad"><span>链接地址：</span><input role="textbox"
					id="f_linkUrl" class="domain-input easyui-textbox width140"
					data-options="required:true" /></td>
			</tr>
			<tr class="tr_ht" align="right">
				<td class="td_pad"><span>栏目位置：</span><input role="combobox"
					id="f_catId" class="domain-input easyui-combobox width140"
					data-options="required:true" /></td>
			...
			<tr class="tr_ht" align="right">
				...
				<td style="top: 10px;" valign="middle">
					<div style="display: inline-block; float: left;">
						<img id="advertisementPicPath" class="picurl"
							src="${advertisement.picPath}"
							style="height: 60px; max-width: 100px; overflow: hidden; padding: 5px;" />
						<input type="hidden" name="filePaths" id="filePaths"
							value="${advertisement.picPath}" /> <input type="hidden"
			...
			<tr>
				<td colspan="3">
					<div style="margin-top: 5px;">&nbsp;&nbsp;首页广告图片尺寸：746*331</div>
					<div style="margin-top: 5px;">&nbsp;&nbsp;首页广告2图片尺寸：344*268</div>
					<div style="margin-top: 5px;">医生主页广告图片尺寸：229*131</div>
					<div style="margin-top: 5px;">诊所主页广告图片尺寸：229*131</div>
				</td>
			</tr>
		</table>
	</form>
	<div class="fl-margin-5-0-1-20">
		<div class="inline-center fl mgV10">
			...
			<%-- </c:if> --%>
			<button id="mainObjBack"
				onclick="lh.jumpToUrl('/back/advertisement')"
				class="button button-primary button-rounded button-small mgV10">返回</button>
			<span>（链接地址需要加上http://）</span>
		</div>
	</div>
	...
	<script type="text/javascript"
		src="/js/back/base/advertisement/addOrUpdateAdvertisement.js"
		title="v"></script>
</body>
</html>