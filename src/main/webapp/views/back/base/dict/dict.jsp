...
<body style="min-width: 1000px;">
	...
	<table id="mainQueryTable">
		<tbody>
			<tr class="tr_ht" align="right">
				<td class="td_pad"><span>根类型：</span><input role="combobox"
					id="sc_parentCode" class="domain-input easyui-combobox width140" /></td>
				<td class="td_pad"><span>代码：</span><input role="textbox"
					id="sc_codeLike" class="domain-input easyui-textbox width140" /></td>
				<td class="td_pad"><span>名称：</span><input role="textbox"
					id="sc_codeNameLike" class="domain-input easyui-textbox width140" /></td>
			...
			<tr class="tr_ht" align="right">
				<td class="td_pad"><span>字典值：</span><input role="textbox"
					id="sc_dictValueLike" class="domain-input easyui-textbox width140" /></td>
				<td class="td_pad"><span>权限：</span><input role="combobox"
					id="sc_authority" class="domain-input easyui-combobox width140"
				...
				<td class="td_pad"><span>等级：</span><input role="combobox"
					id="sc_dictLevel" class="domain-input easyui-combobox width140"
	...
	<div id="mainObjWindiv" style="display: none;">
		<div id='mainObjWin' class="easyui-window" title="数据字典"
			style="width: 640px;"
			...
			<form id="mainObjForm">
				...
				<table id="mainObjTable" class="padL5">
					<tbody>
						<tr class="tr_ht" align="right">
							<td class="td_pad"><span>所属上级：</span><input role="combobox"
								id="f_parentCode" class="domain-input easyui-combobox width140"
								data-options="required:true" /></td>
							<td class="td_pad"><span>代码：</span><input role="textbox"
								id="f_code" class="domain-input easyui-textbox width140"
								data-options="required:false" /></td>
							<td class="td_pad"><span>名称：</span><input role="textbox"
								id="f_codeName" class="domain-input easyui-textbox width140"
								data-options="required:true" /></td>
						</tr>
						<tr class="tr_ht" align="right">
							<td class="td_pad"><span>字典值：</span><input role="textbox"
								id="f_dictValue" class="domain-input easyui-textbox width140"
								data-options="required:false" /></td>
							<td class="td_pad"><span>等级：</span><input role="combobox"
								id="f_dictLevel" class="domain-input easyui-combobox width140"
							...
							<td class="td_pad"><span>权限：</span><input role="combobox"
								id="f_authority" class="domain-input easyui-combobox width140"
	...
	<script type="text/javascript" src="/js/common/back_template.js"
		title="v"></script>
	<script type="text/javascript" src="/js/back/base/dict/dict.js"
		title="v"></script>
</body>
</html>