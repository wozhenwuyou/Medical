...
<body style="min-width: 1000px;">
	...
	<table>
		<tbody>
			<tr class="tr_ht" align="right">
				<td class="td_pad"><span>充值人编号：</span><input id="user"
					class="easyui-textbox width120" /></td>
				<td class="td_pad"><span>充值人姓名：</span><input id="userName"
					class="easyui-textbox width120" /></td>
				<td class="td_pad"><span>充值时间：</span><input id="createdAt"
	...
	<script type="text/javascript" src="/js/back/base/charge/charge.js"
		title="v"></script>
</body>
</html>