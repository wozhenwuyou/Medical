...
<body style="min-width: 1000px;">
	...
	<table>
		<tbody>
			<tr class="tr_ht" align="right">
				<td class="td_pad"><span>提现人姓名：</span><input id="userSerial"
					class="easyui-textbox width120" /></td>
				<td class="td_pad"><span>提现时间：</span><input id="applyDate"
					data-options="editable:false" class="easyui-datebox width120" /></td>
				<td class="td_pad"><span>处理时间：</span><input id="dealDate"
					data-options="editable:false" class="easyui-datebox width120" /></td>
				<td class="td_pad"><span>状态：</span><input id="dealStatus"
	...
	<div id="agreeDetailWindiv" style="display: none;">
		<div id='agreeDetailWin' class="easyui-window" title="处理意见"
			...
			<table id="agreeDetailTable" class="padL5">
				<tbody>
					<tr class="tr_ht">
						<td class="td_pad"><input id="Id" type="hidden" /></td>
						<td class="td_pad"><span class="colorGray">处理意见：</span><input
							id="attr2" data-options="multiline:true,height:60,width:260"
	...
	<script type="text/javascript" src="/js/back/base/withdraw/withdraw.js"
		title="v"></script>
</body>
</html>