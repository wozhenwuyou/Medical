...
<body style="min-width: 1000px;">
		...
		<table class="padL5">
			<tr class="tr_ht" align="right">
				<td class="td_pad"><span><span
						style="color: red; font-weight: bolder;">*</span>栏目：</span><input
			...
			<tr class="tr_ht" align="right">
				<td class="td_pad"><span>医生：</span><input role="combobox"
					id="f_userId" class="domain-input easyui-combobox width140"
					data-options="required:false" /></td>
				<td class="td_pad"><span>置顶：</span><input role="combobox"
					id="f_isTop" class="domain-input easyui-combobox width140"
					data-options="required:false" /></td>
			</tr>
			<tr>
	...
	<div class="fl-margin-5-0-1-20">
		<!-- <span>描述：</span>
    	<input role="textbox" id="f_description" class="domain-input easyui-textbox width140" data-options="required:false,multiline:true,height:50,width:900,prompt:'请输入描述'"/>
	     -->
		<br /> <span><span style="color: red; font-weight: bolder;">*</span>内容:</span>
		...
		<div class="inline-center fl mgV10">
			...
			<%-- </c:if> --%>
			<button id="mainObjBack" onclick="lh.jumpToUrl('/back/article')"
	...
	<script type="text/javascript"
		src="/js/back/base/article/addOrUpdateArticle.js" title="v"></script>
</body>
</html>