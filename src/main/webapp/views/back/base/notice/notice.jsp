...
<body style="min-width: 1000px;">
	...
	<div id="mainObjWindiv" style="display: none;">
		<div id='mainObjWin' class="easyui-window" title="用户消息"
			style="width: 540px;"
			...
			<form id="mainObjForm">
				...
				<table id="mainObjTable" class="padL5">
					<tbody>
						...
						<tr>
							<td class="td_pad" colspan="3"><input role="textbox"
								id="f_content" class="domain-input easyui-textbox"
								data-options="required:true,multiline:true,height:100,prompt:'请输入内容',width:468" /></td>
						</tr>
					</tbody>
				</table>
			</form>
	...
	<script type="text/javascript" src="/js/common/back_template.js"
		title="v"></script>
	<script type="text/javascript" src="/js/back/base/notice/notice.js"
		title="v"></script>
</body>
</html>