...
<body style="min-width: 1000px;">
	...
	<table id="mainQueryTable">
		<tbody>
			<tr class="tr_ht" align="right">
				<td class="td_pad"><span>接收对象：</span><input role="combobox"
					id="sc_groupId" class="domain-input easyui-combobox width140" /></td>
				<td class="td_pad"><span>接收人姓名：</span><input role="textbox"
					id="sc_receiverName" class="domain-input easyui-textbox width140" /></td>
				<td class="td_pad"><span>内容：</span><input role="textbox"
					id="sc_content" class="domain-input easyui-textbox width140" /></td>
			...
			<tr class="tr_ht" align="right">
				<td class="td_pad"><span>发送开始时间：</span><input role="datebox"
					id="sc_sendTimeFrom" class="domain-input easyui-datebox width140" /></td>
				<td class="td_pad"><span>发送结束时间：</span><input role="datebox"
					id="sc_sendTimeTo" class="domain-input easyui-datebox width140" /></td>
	...
	<div id="mainObjWindiv" style="display: none;">
		<div id='mainObjWin' class="easyui-window" title="站内信"
			style="width: 540px;"
			...
			<form id="mainObjForm">
				...
				<table id="mainObjTable" class="padL5">
					<tbody>
						<tr class="tr_ht" align="right">
							<!-- <td class="td_pad"><span>发送人：</span><input role="combobox" id="f_senderId" class="domain-input easyui-combobox width100" data-options="required:true"/></td> -->
							<td class="td_pad"><span>接收对象：</span><input role="combobox"
								id="f_groupId" class="domain-input easyui-combobox width140"
								data-options="required:true" /></td>
							<td class="td_pad"><span>接收人：</span><input role="combobox"
								id="f_receiverId" class="domain-input easyui-combobox width140"
								data-options="required:true" /></td>
						</tr>
						<tr class="tr_ht" align="right">
							<td class="td_pad"><span>是否全体：</span><input role="combobox"
								id="f_toAll" class="domain-input easyui-combobox width140"
								data-options="required:true" /></td>
						...
						<tr align="right">
							<td class="td_pad" colspan="3"><span>标题：</span><input
								...
								data-options="required:true,width:402" /></td>
						</tr>
						<tr align="right">
							<td class="td_pad" colspan="3"></td>
						</tr>
						<tr>
							<td class="td_pad" colspan="3"><span>内容：</span><input
								role="textbox" id="f_content"
								class="domain-input easyui-textbox"
								data-options="required:true,multiline:true,height:100,prompt:'请输入内容',width:402" /></td>
						</tr>
					</tbody>
				</table>
			</form>
	...
	<script type="text/javascript" src="/js/common/back_template.js"
		title="v"></script>
	<script type="text/javascript"
		src="/js/back/base/internalMessage/internalMessage.js" title="v"></script>
</body>
</html>