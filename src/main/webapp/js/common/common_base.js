...
var lh = {
	...
	grid : {},//表格相关数据
	cache : {},
	status : {savingFlag:false,trashShow:false,scrollLoading:false,optTimeRec:0,optTimeGap:1},
	plugins : {},
...
/** 获取浏览器窗口宽度，可以传递最小宽度，默认最小宽度为1000 */
lh.getClientSafeWidth = function(minWidth){
	if(!minWidth)minWidth = 1000;
	return document.documentElement.clientWidth < minWidth ? minWidth : document.documentElement.clientWidth;
}
