/** 基础数据和基础设置 */
lh.config = {
	mainObjLowerName : 'consult',
	mainObjUpperName : 'Consult'
}
...
function loadGrid(){
	lh.$grid.datagrid({
		...
		[
	        ...
	        {field:'username',title:'咨询人',width:120,align:'center'},
	        {field:'doctorName',title:'咨询医生',width:120,align:'center'},
	        {field:'title',title:'标题',width:180,align:'center'},
	        {field:'tags',title:'标签',width:180,align:'center'},
	        {field:'mainContent',title:'咨询内容',width:180,align:'center'},
	        {field:'helpContent',title:'请求帮助内容',width:180,align:'center'},
	        /*{field:'operationTime',title:'操作时间',width:120,align:'center',formatter: function(value,row,index){
