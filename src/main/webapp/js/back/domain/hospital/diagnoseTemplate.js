...
function loadGrid(){
	lh.$grid.datagrid({
		...
		[
	        ...
	        {field:'hospitalName',title:'诊所名称',width:220,align:'center',formatter: function(value,row,index){
	        	if(!value)value = row.doctorHospitalName;
	        	return value;
	        }},
	        {field:'doctorName',title:'医生名称',width:100,align:'center'},
	        {field:'allergyHistory',title:'过敏历史',width:180,align:'center'},
	        {field:'baseCondition',title:'基本病情',width:180,align:'center'},
	        {field:'diagnoseTags',title:'诊断结果',width:180,align:'center',formatter: function(value,row,index){
