/** 基础数据和基础设置 */
lh.config = {
	mainObjLowerName : 'sysArticle',
	mainObjUpperName : 'SysArticle',
}
...
function loadGrid(){
	lh.$grid.datagrid({
		...
		[
	        ...
	        {field:'typeName',title:'类型',width:220,align:'center'},
...
function openMainObj(index, operation){
	...
	if(index >= 0){
		...
		lh.jumpToUrl('/back/addOrUpdateSysArticlePage?sysArticleId='+data.id+"&operation="+operation);
	}
}
