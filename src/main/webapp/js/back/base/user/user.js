...
function loadGrid(){
	lh.$grid.datagrid({
		...
		[
	        ...
	        /*{field:'thirdId',title:'艾迪康ID',width:100,align:'center'},*/
	        ...
	        {field:'provinceName',title:'省(直辖市)',width:100,align:'center'},
	        {field:'cityName',title:'市(县)',width:100,align:'center'},
	        {field:'address',title:'地址',width:120,align:'center'},
	        {field:'userRelationName',title:'上级用户',width:80,align:'center'},
	        {field:'userRelation',title:'与用户关系',width:80,align:'center'},
...
function getResetPasswordUrl(){
	return '/back/updateUserPassword';
}
