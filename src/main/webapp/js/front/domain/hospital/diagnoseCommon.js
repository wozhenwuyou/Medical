...
function getBaseDiagnoseFromDom(){
	...
	for(var i=0; i<presItems.length; i++){
		...
		var preObj = {id:medicalId,medicationId:medicalId,medicalType:medicalType,medicalName:medicalName,medicalNum:medicalNum};
		preList.push(preObj);
	}
	var tagNameList = [];
