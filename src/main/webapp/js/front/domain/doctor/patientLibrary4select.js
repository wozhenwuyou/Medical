...
function loadGridData(page,size,count){
	...
	$.post('/getPatientList4select',{page:page,rows:size,province:province,username:username,ascOrdesc:ascOrdesc,searchType:searchType, queryScope : queryScope},function(rsp){
		if(rsp.success){
