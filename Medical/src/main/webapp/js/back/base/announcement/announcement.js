...
function loadGrid(){
	lh.$grid.datagrid({
		...
		[
		    ...
		    {field:'gradeId',title:'系统公告',width:220,align:'center',formatter: function(value,row,index){
...
function openMainObj(index, operation){
	...
	if(index >= 0){
		...
		lh.jumpToUrl('/back/addOrUpdateAnnouncementPage?announcementId='+data.id+"&operation="+operation);
	}
}
