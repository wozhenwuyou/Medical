...
<body>
	...
	<div class="pz_main">
		...
		<div class="w_1000">
			...
			<div class="w_851">
				<div class="t_851_2">护士库</div>
				<div class="t_851_3">
					<table cellpadding="0" cellspacing="0" border="0">
						<tr height="44" valign="middle">
							<td width="46">区域：</td>
							<td width="118"><select class="text_input1" id="province"><option
										value="">请选择</option>
									<c:forEach var="provinceCityArea"
										items="${provinceCityAreaList}">
							...
							<td width="269" align="right"><a
								href="/hospital/hospitalNurseDetail" class="l_109">添加护士 +</a></td>
						</tr>
					</table>
				</div>
				<div class="d_851_1">
	...
	<script type="text/javascript" src="/js/front/domain/hospital/nurse.js"
		title="v"></script>
	<script id="template" type="x-tmpl-mustache">
		...
		{{#rows}}
			<tr height="58" align="center" style="color:#666666">
		    	<td width="95"><img src="{{avatar}}"width="98" height="98" onerror="this.src='/images/common/default_doctor.jpg'"/></td>
		        ...
		        <td width="15">&nbsp;</td>
		        <td width="184">
		        	<button type="button" onclick="lh.confirm({content: '是否确定删除该护士？', clickYes:deleteDoctor, clickYesParam:{{id}}});" class="btn btn-danger">删除</button>
