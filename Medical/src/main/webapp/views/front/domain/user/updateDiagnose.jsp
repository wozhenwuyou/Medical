...
<body>
					...
					<table cellpadding="0" cellspacing="0" border="0" width="773">
						<tr height="54" valign="bottom">
							<td width="773" colspan="4"
								style="border-bottom: 1px solid #f2f2f2; line-height: 36px; font-size: 14px; color: #333333"><strong>用户信息</strong></td>
						</tr>
	...
	<script type="text/javascript"
		src="/js/front/domain/user/updateDiagnose.js" title="v"></script>
</body>
</html>
