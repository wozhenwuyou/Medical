...
<body style="min-width: 1000px;">
	...
	<div class="fl-margin-5-0-1-20">
		<span>描述：</span> <input role="textbox" id="f_description"
			class="domain-input easyui-textbox width140"
			data-options="required:false,multiline:true,height:50,width:900,prompt:'请输入描述'" />
		...
		<div class="inline-center fl mgV10">
			...
			<%-- </c:if> --%>
			<button id="mainObjBack" onclick="lh.jumpToUrl('/back/sysArticle')"
	...
	<script type="text/javascript"
		src="/js/back/base/article/addOrUpdateSysArticle.js" title="v"></script>
</body>
</html>