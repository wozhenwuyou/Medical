...
<body style="min-width: 1000px;">
	...
	<table id="mainQueryTable">
		<tbody>
			<tr class="tr_ht" align="right">
				<td class="td_pad"><span>栏目：</span><input role="combobox"
	...
	<div id="opt_outer_div">
		<div class="fl_opt_div">
			...
			<button role="opt_1"
				...
				class="button button-primary button-rounded button-small">添加公告</button>
	...
	<script type="text/javascript" src="/js/common/back_template.js"
		title="v"></script>
	<script type="text/javascript" src="/js/back/base/article/article.js"
		title="v"></script>
</body>
</html>