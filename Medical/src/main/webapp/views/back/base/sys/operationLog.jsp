...
<body onbeforeunload="javascript:console.log('a');">
	...
	<table>
		<tbody>
			...
			<tr class="tr_ht" align="right">
				...
				<td class="td_pad"><button id="exportData"
						onclick="exportData();return false;"
						class="button button-primary button-rounded button-small">导出数据</button></td>
			</tr>
		</tbody>
	</table>
	<!-- 查询条件 结束 -->
	...
	<script type="text/javascript"
		src="/js/back/base/operationLog/operationLog.js" title="v"></script>
</body>
</html>