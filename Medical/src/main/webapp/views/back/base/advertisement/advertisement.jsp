...
<body style="min-width: 1000px;">
		...
		<tbody>
			...
			<tr class="tr_ht" align="right">
				<td class="td_pad"><span>栏目：</span><input role="combobox"
					id="sc_catId" class="domain-input easyui-combobox width140" /></td>
	...
	<div id="opt_outer_div">
		<div class="fl_opt_div">
			...
			<button role="opt_1"
				onclick="lh.jumpToUrl('/back/addOrUpdateAdvertisementPage')"
	...
	<script type="text/javascript" src="/js/common/back_template.js"
		title="v"></script>
	<script type="text/javascript"
		src="/js/back/base/advertisement/advertisement.js" title="v"></script>
</body>
</html>