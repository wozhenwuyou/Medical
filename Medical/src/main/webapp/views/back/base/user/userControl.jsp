...
<body style="min-width: 1000px;">
	...
	<table>
		<tbody>
			...
			<tr class="tr_ht" align="right">
				<td class="td_pad"><span>控制类型：</span><input id="sc_controlType"
					data-options="editable:false" class="easyui-combobox width120" /></td>
				<td class="td_pad"><span>有效时间-从：</span><input
					id="sc_validDateFrom" data-options="editable:false"
	...
	<div id="userControlWindiv" style="display: none;">
		<div id='userControlWin' class="easyui-window" title="用户控制信息"
			...
			<form id="userControlForm">
				...
				<table id="userControlTable" class="padL5">
					<tbody>
						...
						<tr class="tr_ht" align="right">
							<td class="td_pad"><span>控制类型：</span><input
								id="f_controlType" data-options="editable:false"
								class="easyui-combobox width140" /></td>
							<td class="td_pad"><span>有效时间-从：</span><input
								id="f_startDate" data-options="editable:false"
								class="easyui-datetimebox width140" /></td>
							<td class="td_pad"><span>至：</span><input id="f_endDate"
			...
			<div class="inline-center mgV40">
				<button id="userControlSave" onclick="submitUserControl()"
					class="button button-primary button-rounded button-small">保存</button>
				<button id="userControlBack" onclick="closeUserControlWin()"
	...
	<script type="text/javascript" src="/js/back/base/user/userControl.js"
		title="v"></script>
</body>
</html>