...
<body style="min-width: 1000px;">
	...
	<table id="mainQueryTable">
		<tbody>
			<tr class="tr_ht" align="right">
				<td class="td_pad"><span>检测项目名称：</span><input role="textbox"
	...
	<div id="mainObjWindiv" style="display: none;">
		<div id='mainObjWin' class="easyui-window" title="血液检测项目"
			style="width: 500px;"
					...
					<tbody>
						<tr class="tr_ht" align="right">
							<td class="td_pad"><span><span
									style="color: red; font-weight: bolder;">*</span>检测项目名称：</span><input
								role="textbox" id="f_name"
								class="domain-input easyui-textbox width140"
								data-options="required:true" /></td>
							<!-- <td class="td_pad"><span><span style="color:red;font-weight:bolder;">*</span>检测项目代码：</span><input role="textbox" id="f_code" class="domain-input easyui-textbox width120" data-options="required:true"/></td> -->
							<td class="td_pad"><span>状态：</span><input role="combobox"
	...
	<script type="text/javascript" src="/js/common/back_template.js"
		title="v"></script>
	<script type="text/javascript" src="/js/back/domain/cancer/cancer.js"
		title="v"></script>
</body>
</html>