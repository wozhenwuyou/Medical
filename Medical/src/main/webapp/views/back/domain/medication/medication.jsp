...
<body style="min-width: 1000px;">
	...
	<table id="mainQueryTable">
		<tbody>
			<tr class="tr_ht" align="right">
				<td class="td_pad"><span>药物名称：</span><input role="textbox"
					id="sc_name" class="domain-input easyui-textbox width100" /></td>
				<td class="td_pad"><span>英语名称：</span><input role="textbox"
					id="sc_englishName" class="domain-input easyui-textbox width100" /></td>
				...
				<td class="td_pad"><span>生厂商：</span><input role="textbox"
					id="sc_producer" class="domain-input easyui-textbox width100" /></td>
				<td class="td_pad"><span>生产地址：</span><input role="textbox"
					id="sc_produceAddress" class="domain-input easyui-textbox width100" /></td>
			...
			<tr class="tr_ht" align="right">
				<td class="td_pad"><span>产品批号：</span><input role="textbox"
					id="sc_lotNumber" class="domain-input easyui-textbox width100" /></td>
				<td class="td_pad"><span>生产日期：</span><input role="datebox"
					id="sc_produceDate" class="domain-input easyui-datebox width100" /></td>
				<td class="td_pad"><span>生产商电话：</span><input role="textbox"
					id="sc_producerTel" class="domain-input easyui-textbox width100" /></td>
				<td class="td_pad"><span>生产商邮编：</span><input role="textbox"
					id="sc_producerCode" class="domain-input easyui-textbox width100" /></td>
			...
			<tr class="tr_ht" align="right">
				<td class="td_pad"><span>药物类型：</span><input role="combobox"
					id="sc_typeId" class="domain-input easyui-combobox width100" /></td>
	...
	<div id="opt_outer_div">
		<div class="fl_opt_div">
			...
			<button onclick="exportMedication()"
				class="button button-primary button-rounded button-small">导出药品信息</button>
	...
	<div id="mainObjWindiv" style="display: none;">
		<div id='mainObjWin' class="easyui-window" title="药品"
			style="width: 720px;"
					...
					<tbody>
						<tr class="tr_ht" align="right">
							<td class="td_pad"><span><span
									style="color: red; font-weight: bolder;">*</span>药物类型：</span><input
								role="combobox" id="f_typeId"
								class="domain-input easyui-combobox width140"
								data-options="required:true" /></td>
							<td class="td_pad"><span><span
									style="color: red; font-weight: bolder;">*</span>药物名称：</span><input
								role="textbox" id="f_name"
								class="domain-input easyui-textbox width140"
								data-options="required:true" /></td>
							<td class="td_pad"><span>英语名称：</span><input role="textbox"
								id="f_englishName" class="domain-input easyui-textbox width140"
						...
						<tr class="tr_ht" align="right">
							...
							<td class="td_pad"><span>单价：</span><input role="numberbox"
								id="f_price" class="domain-input easyui-numberbox width140"
								data-options="required:false,min:0,precision:2" /></td>
							<td class="td_pad"><span>生厂商：</span><input role="textbox"
								id="f_producer" class="domain-input easyui-textbox width140"
								data-options="required:false" /></td>
							<td class="td_pad"><span>生产地址：</span><input role="textbox"
								id="f_produceAddress"
								class="domain-input easyui-textbox width140"
						...
						<tr class="tr_ht" align="right">
							<td class="td_pad"><span>产品批号：</span><input role="textbox"
								id="f_lotNumber" class="domain-input easyui-textbox width140"
								data-options="required:false" /></td>
							<td class="td_pad"><span>生产日期：</span><input role="datebox"
								id="f_produceDate" class="domain-input easyui-datebox width140"
								data-options="required:false" /></td>
							<td class="td_pad"><span>单位：</span><input role="textbox"
								id="f_unit" class="domain-input easyui-textbox width140"
								data-options="required:false" /></td>
						...
						<tr class="tr_ht" align="right">
							<td class="td_pad"><span>生产商电话：</span><input role="textbox"
								id="f_producerTel" class="domain-input easyui-textbox width140"
								data-options="required:false" /></td>
							<td class="td_pad"><span>生产商邮编：</span><input role="textbox"
								id="f_producerCode" class="domain-input easyui-textbox width140"
								data-options="required:false" /></td>
							<td class="td_pad"><span>状态：</span><input role="combobox"
						...
						<tr>
							<td class="td_pad" colspan="3"><span>用法：</span> <input
								role="textbox" id="f_usageAndDosage"
								class="domain-input easyui-textbox"
								data-options="required:false,multiline:true,height:80,prompt:'请输入内容',width:620" />
							</td>
						</tr>
						<tr>
							<td class="td_pad" colspan="3"><span>禁忌：</span> <input
								role="textbox" id="f_attention"
								class="domain-input easyui-textbox"
								data-options="required:false,multiline:true,height:80,prompt:'请输入内容',width:620" />
							</td>
						</tr>
	...
	<script type="text/javascript" src="/js/common/back_template.js"
		title="v"></script>
	<script type="text/javascript"
		src="/js/back/domain/medication/medication.js" title="v"></script>
</body>
</html>