 ...
 */
public class DataHospitalVisit extends Parent {
	...
	public String getVisitAnalysis() {
		return visitAnalysis;
	}
	public void setVisitAnalysis(String visitAnalysis) {
		 this.visitAnalysis = visitAnalysis == null ? null : visitAnalysis.trim();
	}
